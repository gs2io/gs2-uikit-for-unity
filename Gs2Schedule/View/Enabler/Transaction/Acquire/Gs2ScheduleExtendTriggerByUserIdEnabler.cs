...
namespace Gs2.Unity.UiKit.Gs2Schedule
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Trigger/View/Enabler/Transaction/Gs2ScheduleExtendTriggerByUserIdEnabler")]
    public partial class Gs2ScheduleExtendTriggerByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.AcquireActions().Count(v => v.Action == "Gs2Schedule:ExtendTriggerByUserId") == 0) {
    ...
    public partial class Gs2ScheduleExtendTriggerByUserIdEnabler
    {
