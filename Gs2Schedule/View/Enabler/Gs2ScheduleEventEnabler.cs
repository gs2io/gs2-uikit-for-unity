...
namespace Gs2.Unity.UiKit.Gs2Schedule
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/Enabler/Gs2ScheduleEventEnabler")]
    public partial class Gs2ScheduleEventEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
    ...
    public partial class Gs2ScheduleEventEnabler
    {
