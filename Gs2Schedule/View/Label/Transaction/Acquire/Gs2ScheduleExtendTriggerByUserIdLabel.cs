...
namespace Gs2.Unity.UiKit.Gs2Schedule.Label
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Trigger/View/Label/Transaction/Gs2ScheduleExtendTriggerByUserIdLabel")]
    public partial class Gs2ScheduleExtendTriggerByUserIdLabel : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            this.onUpdate?.Invoke(
                this.format.Replace(
                    ...
                    "{extendSeconds}",
                    $"{this._fetcher.Request.ExtendSeconds}"
                ).Replace(
                    "{timeOffsetToken}",
    ...
    public partial class Gs2ScheduleExtendTriggerByUserIdLabel
    {
