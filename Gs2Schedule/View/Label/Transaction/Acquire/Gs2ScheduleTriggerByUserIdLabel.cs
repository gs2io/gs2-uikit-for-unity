...
namespace Gs2.Unity.UiKit.Gs2Schedule.Label
{
                    ...
                    _userDataFetcher != null && _userDataFetcher.Fetched && _userDataFetcher.Trigger != null) {
                {
                    onUpdate?.Invoke(
                        format.Replace(
                            ...
                            "{triggerStrategy}",
                            $"{_fetcher.Request.TriggerStrategy}"
                        ).Replace(
                            "{ttl}",
    ...
    public partial class Gs2ScheduleTriggerByUserIdLabel
    {
        ...
        public void Awake()
        {
            _fetcher = GetComponent<Gs2ScheduleTriggerByUserIdFetcher>() ?? GetComponentInParent<Gs2ScheduleTriggerByUserIdFetcher>();
        ...
        {
            _fetcher = GetComponent<Gs2ScheduleTriggerByUserIdFetcher>() ?? GetComponentInParent<Gs2ScheduleTriggerByUserIdFetcher>(true);
