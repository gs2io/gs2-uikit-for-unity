...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatEndDayOfWeekEnabler))]
    public class Gs2ScheduleEventRepeatEndDayOfWeekEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatEndDayOfWeekEnabler;
            ...
            if (original.expression == Gs2ScheduleEventRepeatEndDayOfWeekEnabler.Expression.In || original.expression == Gs2ScheduleEventRepeatEndDayOfWeekEnabler.Expression.NotIn) {
