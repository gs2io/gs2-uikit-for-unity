...
namespace Gs2.Unity.UiKit.Gs2Schedule.Editor
{
    ...
    public class Gs2ScheduleEventRelativeTriggerNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRelativeTriggerNameEnabler;
            ...
            if (original.expression == Gs2ScheduleEventRelativeTriggerNameEnabler.Expression.In || original.expression == Gs2ScheduleEventRelativeTriggerNameEnabler.Expression.NotIn) {
