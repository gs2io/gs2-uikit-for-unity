...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatBeginDayOfMonthEnabler))]
    public class Gs2ScheduleEventRepeatBeginDayOfMonthEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatBeginDayOfMonthEnabler;
            ...
            if (original.expression == Gs2ScheduleEventRepeatBeginDayOfMonthEnabler.Expression.In || original.expression == Gs2ScheduleEventRepeatBeginDayOfMonthEnabler.Expression.NotIn) {
