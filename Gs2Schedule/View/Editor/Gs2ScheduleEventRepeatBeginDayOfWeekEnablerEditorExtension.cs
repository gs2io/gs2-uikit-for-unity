...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatBeginDayOfWeekEnabler))]
    public class Gs2ScheduleEventRepeatBeginDayOfWeekEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatBeginDayOfWeekEnabler;
            ...
            if (original.expression == Gs2ScheduleEventRepeatBeginDayOfWeekEnabler.Expression.In || original.expression == Gs2ScheduleEventRepeatBeginDayOfWeekEnabler.Expression.NotIn) {
