...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Trigger/View/SpriteSwitcher/Properties/Name/Gs2ScheduleTriggerNameSpriteTableSwitcher")]
    public partial class Gs2ScheduleTriggerNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Trigger != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Trigger.Name) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Trigger.Name).sprite);
                }
                else {
    ...
    public partial class Gs2ScheduleTriggerNameSpriteTableSwitcher
    {
