...
namespace Gs2.Unity.UiKit.Gs2Schedule
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Trigger/View/SpriteSwitcher/Properties/ExpiresAt/Gs2ScheduleTriggerExpiresAtSpriteSwitcher")]
    public partial class Gs2ScheduleTriggerExpiresAtSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Trigger != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyExpiresAts.Contains(_fetcher.Trigger.ExpiresAt)) {
                    ...
                    case Expression.Less:
                        if (applyExpiresAt > _fetcher.Trigger.ExpiresAt) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
    ...
    public partial class Gs2ScheduleTriggerExpiresAtSpriteSwitcher
    {
