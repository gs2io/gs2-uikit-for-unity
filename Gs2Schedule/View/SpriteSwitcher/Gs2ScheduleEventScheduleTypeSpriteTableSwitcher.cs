...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/ScheduleType/Gs2ScheduleEventScheduleTypeSpriteTableSwitcher")]
    public partial class Gs2ScheduleEventScheduleTypeSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Event != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Event.ScheduleType) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Event.ScheduleType).sprite);
                }
                else {
    ...
    public partial class Gs2ScheduleEventScheduleTypeSpriteTableSwitcher
    {
