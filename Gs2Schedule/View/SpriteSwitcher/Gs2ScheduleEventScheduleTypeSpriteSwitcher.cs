...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/ScheduleType/Gs2ScheduleEventScheduleTypeSpriteSwitcher")]
    public partial class Gs2ScheduleEventScheduleTypeSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Event != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyScheduleTypes.Contains(_fetcher.Event.ScheduleType)) {
    ...
    public partial class Gs2ScheduleEventScheduleTypeSpriteSwitcher
    {
