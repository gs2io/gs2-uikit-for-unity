...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Trigger/View/SpriteSwitcher/Transaction/Properties/EventId/Gs2ScheduleTriggerByUserIdEventIdSpriteTableSwitcher")]
    public partial class Gs2ScheduleTriggerByUserIdEventIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == this._fetcher.Request.EventId) > 0) {
                this.onUpdate.Invoke(sprites.Find(v => v.value == this._fetcher.Request.EventId).sprite);
            }
            else {
    ...
    public partial class Gs2ScheduleTriggerByUserIdEventIdSpriteTableSwitcher
    {
