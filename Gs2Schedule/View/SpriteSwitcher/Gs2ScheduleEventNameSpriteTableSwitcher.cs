...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/Name/Gs2ScheduleEventNameSpriteTableSwitcher")]
    public partial class Gs2ScheduleEventNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Event != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Event.Name) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Event.Name).sprite);
                }
                else {
    ...
    public partial class Gs2ScheduleEventNameSpriteTableSwitcher
    {
