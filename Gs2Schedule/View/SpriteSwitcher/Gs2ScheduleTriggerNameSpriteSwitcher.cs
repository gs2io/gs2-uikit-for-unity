...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Trigger/View/SpriteSwitcher/Properties/Name/Gs2ScheduleTriggerNameSpriteSwitcher")]
    public partial class Gs2ScheduleTriggerNameSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Trigger != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyNames.Contains(_fetcher.Trigger.Name)) {
                    ...
                    case Expression.StartsWith:
                        if (applyName.StartsWith(_fetcher.Trigger.Name)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyName.EndsWith(_fetcher.Trigger.Name)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2ScheduleTriggerNameSpriteSwitcher
    {
