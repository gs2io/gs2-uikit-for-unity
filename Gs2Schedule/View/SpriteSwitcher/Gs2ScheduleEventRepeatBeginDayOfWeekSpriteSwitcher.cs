...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/RepeatBeginDayOfWeek/Gs2ScheduleEventRepeatBeginDayOfWeekSpriteSwitcher")]
    public partial class Gs2ScheduleEventRepeatBeginDayOfWeekSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Event != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyRepeatBeginDayOfWeeks.Contains(_fetcher.Event.RepeatBeginDayOfWeek)) {
    ...
    public partial class Gs2ScheduleEventRepeatBeginDayOfWeekSpriteSwitcher
    {
