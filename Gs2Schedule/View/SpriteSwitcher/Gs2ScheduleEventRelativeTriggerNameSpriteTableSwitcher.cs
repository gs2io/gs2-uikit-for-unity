...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/RelativeTriggerName/Gs2ScheduleEventRelativeTriggerNameSpriteTableSwitcher")]
    public partial class Gs2ScheduleEventRelativeTriggerNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Event != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Event.RelativeTriggerName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Event.RelativeTriggerName).sprite);
                }
                else {
    ...
    public partial class Gs2ScheduleEventRelativeTriggerNameSpriteTableSwitcher
    {
