...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/RepeatBeginDayOfWeek/Gs2ScheduleEventRepeatBeginDayOfWeekSpriteTableSwitcher")]
    public partial class Gs2ScheduleEventRepeatBeginDayOfWeekSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Event != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Event.RepeatBeginDayOfWeek) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Event.RepeatBeginDayOfWeek).sprite);
                }
                else {
    ...
    public partial class Gs2ScheduleEventRepeatBeginDayOfWeekSpriteTableSwitcher
    {
