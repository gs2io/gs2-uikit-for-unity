...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/RepeatEndDayOfWeek/Gs2ScheduleEventRepeatEndDayOfWeekSpriteSwitcher")]
    public partial class Gs2ScheduleEventRepeatEndDayOfWeekSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Event != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        if (applyRepeatEndDayOfWeek.StartsWith(_fetcher.Event.RepeatEndDayOfWeek)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyRepeatEndDayOfWeek.EndsWith(_fetcher.Event.RepeatEndDayOfWeek)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2ScheduleEventRepeatEndDayOfWeekSpriteSwitcher
    {
