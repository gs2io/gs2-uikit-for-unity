...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/RepeatType/Gs2ScheduleEventRepeatTypeSpriteTableSwitcher")]
    public partial class Gs2ScheduleEventRepeatTypeSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Event != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Event.RepeatType) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Event.RepeatType).sprite);
                }
                else {
    ...
    public partial class Gs2ScheduleEventRepeatTypeSpriteTableSwitcher
    {
