...
namespace Gs2.Unity.UiKit.Gs2Schedule.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Event/View/SpriteSwitcher/Properties/RepeatEndDayOfWeek/Gs2ScheduleEventRepeatEndDayOfWeekSpriteTableSwitcher")]
    public partial class Gs2ScheduleEventRepeatEndDayOfWeekSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Event != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Event.RepeatEndDayOfWeek) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Event.RepeatEndDayOfWeek).sprite);
                }
                else {
    ...
    public partial class Gs2ScheduleEventRepeatEndDayOfWeekSpriteTableSwitcher
    {
