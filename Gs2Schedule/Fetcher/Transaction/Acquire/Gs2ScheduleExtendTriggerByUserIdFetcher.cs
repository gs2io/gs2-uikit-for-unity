...
namespace Gs2.Unity.UiKit.Gs2Schedule.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Schedule/Trigger/Fetcher/Acquire/Gs2ScheduleExtendTriggerByUserIdFetcher")]
    public partial class Gs2ScheduleExtendTriggerByUserIdFetcher : Gs2ScheduleOwnTriggerContext
    {
        private void Fetch()
        {
            if (this._context != null) {
                if (this._context.AcquireAction.Action == "Gs2Schedule:ExtendTriggerByUserId") {
                    Request = ExtendTriggerByUserIdRequest.FromJson(JsonMapper.ToObject(this._context.AcquireAction.Request));
                    if (Trigger == null || (
                ...
                var action = this._fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Schedule:ExtendTriggerByUserId");
                if (action != null) {
                    Request = ExtendTriggerByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                    if (Trigger == null || (
                            Trigger.NamespaceName == Request.NamespaceName &&
                            Trigger.TriggerName == Request.TriggerName)
                    ) {
    ...
    public partial class Gs2ScheduleExtendTriggerByUserIdFetcher
    {
    ...
    public partial class Gs2ScheduleExtendTriggerByUserIdFetcher
    {
        public ExtendTriggerByUserIdRequest Request { get; protected set; }
