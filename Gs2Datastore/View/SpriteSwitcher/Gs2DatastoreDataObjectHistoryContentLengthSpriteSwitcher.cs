...
namespace Gs2.Unity.UiKit.Gs2Datastore
{
	...
	[AddComponentMenu("GS2 UIKit/Datastore/DataObjectHistory/View/SpriteSwitcher/Properties/ContentLength/Gs2DatastoreDataObjectHistoryContentLengthSpriteSwitcher")]
    public partial class Gs2DatastoreDataObjectHistoryContentLengthSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.DataObjectHistory != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyContentLengths.Contains(_fetcher.DataObjectHistory.ContentLength)) {
                    ...
                    case Expression.Less:
                        if (applyContentLength > _fetcher.DataObjectHistory.ContentLength) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
    ...
    public partial class Gs2DatastoreDataObjectHistoryContentLengthSpriteSwitcher
    {
