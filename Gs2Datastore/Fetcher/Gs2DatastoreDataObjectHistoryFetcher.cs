...
namespace Gs2.Unity.UiKit.Gs2Datastore.Fetcher
{
    ...
    public partial class Gs2DatastoreDataObjectHistoryFetcher
    {
        ...
        private Gs2DatastoreDataObjectHistoryContext _context;

        public void Awake()
        {
            _clientHolder = Gs2ClientHolder.Instance;
            _gameSessionHolder = Gs2GameSessionHolder.Instance;
            _context = GetComponentInParent<Gs2DatastoreDataObjectHistoryContext>();
        }
    }
    ...
    public partial class Gs2DatastoreDataObjectHistoryFetcher
    {
        public EzDataObjectHistory DataObjectHistory { get; private set; }
