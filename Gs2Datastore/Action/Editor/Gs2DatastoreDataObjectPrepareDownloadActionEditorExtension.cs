        ...
        public override void OnInspectorGUI() {
            ...
            if (context == null) {
                ...
                if (context.transform.parent.GetComponent<Gs2DatastoreOwnDataObjectList>() != null) {
                    ...
                    EditorGUILayout.ObjectField("OwnDataObject", context.DataObject, typeof(OwnDataObject), false);
                    EditorGUI.indentLevel++;
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("onPrepareDownloadComplete"), true);
