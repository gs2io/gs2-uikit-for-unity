...
namespace Gs2.Unity.UiKit.Gs2Limit
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/LimitModel/View/SpriteSwitcher/Properties/Days/Gs2LimitLimitModelDaysSpriteSwitcher")]
    public partial class Gs2LimitLimitModelDaysSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyDayses.Contains(this._fetcher.LimitModel.Days)) {
                ...
                case Expression.Less:
                    if (this.applyDays > this._fetcher.LimitModel.Days) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
    ...
    public partial class Gs2LimitLimitModelDaysSpriteSwitcher
    {
