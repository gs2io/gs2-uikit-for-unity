...
namespace Gs2.Unity.UiKit.Gs2Limit.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Limit/Counter/View/SpriteSwitcher/Properties/LimitName/Gs2LimitCounterLimitNameSpriteTableSwitcher")]
    public partial class Gs2LimitCounterLimitNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Counter != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Counter.LimitName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Counter.LimitName).sprite);
                }
                else {
    ...
    public partial class Gs2LimitCounterLimitNameSpriteTableSwitcher
    {
