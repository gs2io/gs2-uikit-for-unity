...
namespace Gs2.Unity.UiKit.Gs2StateMachine.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/StateMachine/Status/View/SpriteSwitcher/Properties/Name/Gs2StateMachineStatusNameSpriteSwitcher")]
    public partial class Gs2StateMachineStatusNameSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Status != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyNames.Contains(_fetcher.Status.Name)) {
    ...
    public partial class Gs2StateMachineStatusNameSpriteSwitcher
    {
