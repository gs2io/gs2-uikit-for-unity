...
namespace Gs2.Unity.UiKit.Gs2StateMachine
{
	...
	[AddComponentMenu("GS2 UIKit/StateMachine/Status/View/Enabler/Gs2StateMachineStatusEnabler")]
    public partial class Gs2StateMachineStatusEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
    ...
    public partial class Gs2StateMachineStatusEnabler
    {
