...
namespace Gs2.Unity.UiKit.Gs2SkillTree.Fetcher
{
    ...
    public partial class Gs2SkillTreeMarkReleaseByUserIdFetcher : Gs2SkillTreeNamespaceContext
    {
        private IEnumerator Fetch()
        {
            ...
            {
                if (_fetcher != null) {
                    var action = _fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2SkillTree:MarkReleaseByUserId");
                    if (action != null) {
