...
namespace Gs2.Unity.UiKit.Gs2SkillTree.Label
{
    ...
    public partial class Gs2SkillTreeMarkReleaseByUserIdLabel
    {
        ...
        public void Awake()
        {
            _fetcher = GetComponent<Gs2SkillTreeMarkReleaseByUserIdFetcher>() ?? GetComponentInParent<Gs2SkillTreeMarkReleaseByUserIdFetcher>();
        ...
        {
            _fetcher = GetComponent<Gs2SkillTreeMarkReleaseByUserIdFetcher>() ?? GetComponentInParent<Gs2SkillTreeMarkReleaseByUserIdFetcher>(true);
