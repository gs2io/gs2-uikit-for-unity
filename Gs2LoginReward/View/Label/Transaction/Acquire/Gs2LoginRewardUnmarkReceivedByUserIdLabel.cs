...
namespace Gs2.Unity.UiKit.Gs2LoginReward.Label
{
    ...
    public partial class Gs2LoginRewardUnmarkReceivedByUserIdLabel
    {
        ...
        public void Awake()
        {
            _fetcher = GetComponent<Gs2LoginRewardUnmarkReceivedByUserIdFetcher>() ?? GetComponentInParent<Gs2LoginRewardUnmarkReceivedByUserIdFetcher>();
        ...
        {
            _fetcher = GetComponent<Gs2LoginRewardUnmarkReceivedByUserIdFetcher>() ?? GetComponentInParent<Gs2LoginRewardUnmarkReceivedByUserIdFetcher>(true);
