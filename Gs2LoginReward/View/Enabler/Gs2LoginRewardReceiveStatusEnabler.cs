...
namespace Gs2.Unity.UiKit.Gs2LoginReward
{
	...
	[AddComponentMenu("GS2 UIKit/LoginReward/ReceiveStatus/View/Enabler/Gs2LoginRewardReceiveStatusEnabler")]
    public partial class Gs2LoginRewardReceiveStatusEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
    ...
    public partial class Gs2LoginRewardReceiveStatusEnabler
    {
