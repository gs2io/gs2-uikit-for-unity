...
namespace Gs2.Unity.UiKit.Gs2LoginReward.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/LoginReward/ReceiveStatus/View/SpriteSwitcher/Properties/BonusModelName/Gs2LoginRewardReceiveStatusBonusModelNameSpriteTableSwitcher")]
    public partial class Gs2LoginRewardReceiveStatusBonusModelNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.ReceiveStatus != null)
            {
                if (sprites.Count(v => v.value == _fetcher.ReceiveStatus.BonusModelName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.ReceiveStatus.BonusModelName).sprite);
                }
                else {
    ...
    public partial class Gs2LoginRewardReceiveStatusBonusModelNameSpriteTableSwitcher
    {
