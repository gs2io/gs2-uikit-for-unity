...
namespace Gs2.Unity.UiKit.Gs2Matchmaking
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/Rating/View/Enabler/Gs2MatchmakingRatingEnabler")]
    public partial class Gs2MatchmakingRatingEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
