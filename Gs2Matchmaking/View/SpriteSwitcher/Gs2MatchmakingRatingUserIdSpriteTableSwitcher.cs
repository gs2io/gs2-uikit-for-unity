...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/Rating/View/SpriteSwitcher/Properties/UserId/Gs2MatchmakingRatingUserIdSpriteTableSwitcher")]
    public partial class Gs2MatchmakingRatingUserIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Rating != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Rating.UserId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Rating.UserId).sprite);
                }
                else {
    ...
    public partial class Gs2MatchmakingRatingUserIdSpriteTableSwitcher
    {
