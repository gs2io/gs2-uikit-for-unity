...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/Rating/View/SpriteSwitcher/Properties/UserId/Gs2MatchmakingRatingUserIdSpriteSwitcher")]
    public partial class Gs2MatchmakingRatingUserIdSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Rating != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyUserIds.Contains(_fetcher.Rating.UserId)) {
                    ...
                    case Expression.StartsWith:
                        if (applyUserId.StartsWith(_fetcher.Rating.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyUserId.EndsWith(_fetcher.Rating.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2MatchmakingRatingUserIdSpriteSwitcher
    {
