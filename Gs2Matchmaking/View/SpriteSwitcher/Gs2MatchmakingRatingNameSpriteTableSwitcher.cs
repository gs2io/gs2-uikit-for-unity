...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Matchmaking/Rating/View/SpriteSwitcher/Properties/Name/Gs2MatchmakingRatingNameSpriteTableSwitcher")]
    public partial class Gs2MatchmakingRatingNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Rating != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Rating.Name) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Rating.Name).sprite);
                }
                else {
    ...
    public partial class Gs2MatchmakingRatingNameSpriteTableSwitcher
    {
