...
namespace Gs2.Unity.UiKit.Gs2Lottery.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Lottery/BoxItem/Fetcher/Gs2LotteryOwnBoxItemListFetcher")]
    public partial class Gs2LotteryOwnBoxItemListFetcher : MonoBehaviour
    {
            ...
            while (true)
            {
                    ...
                    Context != null)
                {
                    ...
                    if (future.Error != null) {
                        ...
                        retryWaitSecond = 1;
                        BoxItemes = future.Result.Items.ToList();
                        Fetched = true;
                    }
                }
                else {
    ...
    public partial class Gs2LotteryOwnBoxItemListFetcher
    {
    ...
    public partial class Gs2LotteryOwnBoxItemListFetcher
    {
        public List<Gs2.Unity.Gs2Lottery.Model.EzBoxItem> BoxItemes { get; private set; }
