...
{
    [CustomEditor(typeof(Gs2LotteryUserContext))]
    public class Gs2LotteryUserContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryUserContext;
