...
namespace Gs2.Unity.UiKit.Gs2Money
{
	...
	[AddComponentMenu("GS2 UIKit/Money/Wallet/View/SpriteSwitcher/Properties/Slot/Gs2MoneyWalletSlotSpriteSwitcher")]
    public partial class Gs2MoneyWalletSlotSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Wallet != null)
            {
                ...
                {
                    case Expression.In:
                        if (applySlots.Contains(_fetcher.Wallet.Slot)) {
                    ...
                    case Expression.Less:
                        if (applySlot > _fetcher.Wallet.Slot) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
    ...
    public partial class Gs2MoneyWalletSlotSpriteSwitcher
    {
