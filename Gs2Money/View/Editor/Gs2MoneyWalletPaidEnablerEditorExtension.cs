...
{
    [CustomEditor(typeof(Gs2MoneyWalletPaidEnabler))]
    public class Gs2MoneyWalletPaidEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyWalletPaidEnabler;
            ...
            if (original.expression == Gs2MoneyWalletPaidEnabler.Expression.In || original.expression == Gs2MoneyWalletPaidEnabler.Expression.NotIn) {
