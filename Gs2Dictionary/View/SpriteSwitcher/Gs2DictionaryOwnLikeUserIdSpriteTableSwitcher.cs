...
namespace Gs2.Unity.UiKit.Gs2Dictionary.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/Like/View/SpriteSwitcher/Properties/UserId/Gs2DictionaryOwnLikeUserIdSpriteTableSwitcher")]
    public partial class Gs2DictionaryOwnLikeUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Like.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Like.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2DictionaryOwnLikeUserIdSpriteTableSwitcher
    {
