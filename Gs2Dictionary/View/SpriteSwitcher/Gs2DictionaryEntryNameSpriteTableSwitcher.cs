...
namespace Gs2.Unity.UiKit.Gs2Dictionary.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/Entry/View/SpriteSwitcher/Properties/Name/Gs2DictionaryEntryNameSpriteTableSwitcher")]
    public partial class Gs2DictionaryEntryNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Entry != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Entry.Name) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Entry.Name).sprite);
                }
                else {
    ...
    public partial class Gs2DictionaryEntryNameSpriteTableSwitcher
    {
