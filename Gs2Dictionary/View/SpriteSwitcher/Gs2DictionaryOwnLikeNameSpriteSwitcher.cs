...
namespace Gs2.Unity.UiKit.Gs2Dictionary.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/Like/View/SpriteSwitcher/Properties/Name/Gs2DictionaryOwnLikeNameSpriteSwitcher")]
    public partial class Gs2DictionaryOwnLikeNameSpriteSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            ...
            {
                case Expression.In:
                    if (this.applyNames.Contains(this._fetcher.Like?.Name ?? "")) {
                ...
                case Expression.StartsWith:
                    if ((this._fetcher.Like?.Name ?? "").StartsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                case Expression.EndsWith:
                    if ((this._fetcher.Like?.Name ?? "").EndsWith(this.applyName)) {
                        this.onUpdate.Invoke(this.sprite);
                    }
                    break;
                default:
    ...
    public partial class Gs2DictionaryOwnLikeNameSpriteSwitcher
    {
