...
namespace Gs2.Unity.UiKit.Gs2Dictionary.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/Like/View/SpriteSwitcher/Properties/Name/Gs2DictionaryOwnLikeNameSpriteTableSwitcher")]
    public partial class Gs2DictionaryOwnLikeNameSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.Like.Name) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.Like.Name).sprite);
            }
            else {
    ...
    public partial class Gs2DictionaryOwnLikeNameSpriteTableSwitcher
    {
