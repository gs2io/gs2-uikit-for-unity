...
namespace Gs2.Unity.UiKit.Gs2Dictionary
{
	...
	[AddComponentMenu("GS2 UIKit/Dictionary/Like/View/Enabler/Gs2DictionaryOwnLikeEnabler")]
    public partial class Gs2DictionaryOwnLikeEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.Like == null)
            {
    ...
    public partial class Gs2DictionaryOwnLikeEnabler
    {
