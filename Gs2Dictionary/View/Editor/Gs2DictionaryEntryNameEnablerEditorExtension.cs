...
{
    [CustomEditor(typeof(Gs2DictionaryEntryNameEnabler))]
    public class Gs2DictionaryEntryNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryEntryNameEnabler;
            ...
            if (original.expression == Gs2DictionaryEntryNameEnabler.Expression.In || original.expression == Gs2DictionaryEntryNameEnabler.Expression.NotIn) {
