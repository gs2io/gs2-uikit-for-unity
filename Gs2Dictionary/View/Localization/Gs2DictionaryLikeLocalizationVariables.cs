...
namespace Gs2.Unity.UiKit.Gs2Dictionary.Localization
{
    ...
    [AddComponentMenu("GS2 UIKit/Dictionary/Like/View/Localization/Gs2DictionaryLikeLocalizationVariables")]
    public partial class Gs2DictionaryLikeLocalizationVariables : MonoBehaviour
    {
        private void OnFetched()
        {
            this.target.StringReference["likeId"] = new StringVariable {
                Value = _fetcher?.Like?.LikeId ?? "",
            };
            this.target.StringReference["userId"] = new StringVariable {
                Value = _fetcher?.Like?.UserId ?? "",
            };
            this.target.StringReference["name"] = new StringVariable {
                Value = _fetcher?.Like?.Name ?? "",
            };
    ...
    public partial class Gs2DictionaryLikeLocalizationVariables
    {
