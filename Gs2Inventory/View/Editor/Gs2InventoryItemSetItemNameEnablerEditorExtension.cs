...
{
    [CustomEditor(typeof(Gs2InventoryItemSetItemNameEnabler))]
    public class Gs2InventoryItemSetItemNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemSetItemNameEnabler;
            ...
            if (original.expression == Gs2InventoryItemSetItemNameEnabler.Expression.In || original.expression == Gs2InventoryItemSetItemNameEnabler.Expression.NotIn) {
