...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/Enabler/Properties/ExpiresAt/Gs2InventoryItemSetExpiresAtEnabler")]
    public partial class Gs2InventoryItemSetExpiresAtEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.ItemSet != null)
            {
                ...
                {
                    case Expression.In:
                        target.SetActive(enableExpiresAts.Contains(_fetcher.ItemSet[index].ExpiresAt));
                        break;
                    case Expression.NotIn:
                        target.SetActive(!enableExpiresAts.Contains(_fetcher.ItemSet[index].ExpiresAt));
                        break;
                    case Expression.Less:
                        target.SetActive(enableExpiresAt > _fetcher.ItemSet[index].ExpiresAt);
                        break;
    ...
    public partial class Gs2InventoryItemSetExpiresAtEnabler
    {
