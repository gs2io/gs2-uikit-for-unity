            ...
            if (_fetcher.Fetched && _fetcher.Inventory != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        target.SetActive(_fetcher.Inventory.InventoryName.StartsWith(enableInventoryName));
                        break;
                    case Expression.EndsWith:
                        target.SetActive(_fetcher.Inventory.InventoryName.EndsWith(enableInventoryName));
                        break;
                }
            }
            else
