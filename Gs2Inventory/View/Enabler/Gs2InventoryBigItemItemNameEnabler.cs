...
namespace Gs2.Unity.UiKit.Gs2Inventory.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/View/Enabler/Properties/ItemName/Gs2InventoryBigItemItemNameEnabler")]
    public partial class Gs2InventoryBigItemItemNameEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.BigItem != null)
            {
                ...
                {
                    case Expression.In:
                        target.SetActive(enableItemNames.Contains(_fetcher.BigItem.ItemName));
                        break;
                    case Expression.NotIn:
                        target.SetActive(!enableItemNames.Contains(_fetcher.BigItem.ItemName));
                        break;
                    case Expression.StartsWith:
                        target.SetActive(_fetcher.BigItem.ItemName.StartsWith(enableItemName));
                        break;
                    case Expression.EndsWith:
                        target.SetActive(_fetcher.BigItem.ItemName.EndsWith(enableItemName));
                        break;
                }
            }
            else
    ...
    public partial class Gs2InventoryBigItemItemNameEnabler
    {
