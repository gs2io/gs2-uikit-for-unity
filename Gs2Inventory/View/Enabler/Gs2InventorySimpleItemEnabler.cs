...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/SimpleItem/View/Enabler/Gs2InventorySimpleItemEnabler")]
    public partial class Gs2InventorySimpleItemEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
    ...
    public partial class Gs2InventorySimpleItemEnabler
    {
