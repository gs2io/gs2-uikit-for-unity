...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/View/Enabler/Gs2InventoryBigItemEnabler")]
    public partial class Gs2InventoryBigItemEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
    ...
    public partial class Gs2InventoryBigItemEnabler
    {
