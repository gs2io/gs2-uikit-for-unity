...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/SimpleItem/View/Enabler/Properties/Count/Gs2InventorySimpleItemCountEnabler")]
    public partial class Gs2InventorySimpleItemCountEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.SimpleItem != null)
            {
                ...
                {
                    case Expression.In:
                        target.SetActive(enableCounts.Contains(_fetcher.SimpleItem.Count));
                        break;
                    case Expression.NotIn:
                        target.SetActive(!enableCounts.Contains(_fetcher.SimpleItem.Count));
                        break;
                    case Expression.Less:
                        target.SetActive(enableCount > _fetcher.SimpleItem.Count);
                        break;
    ...
    public partial class Gs2InventorySimpleItemCountEnabler
    {
