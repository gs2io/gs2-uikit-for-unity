...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/SpriteSwitcher/Properties/Count/Gs2InventoryItemSetCountSpriteSwitcher")]
    public partial class Gs2InventoryItemSetCountSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.ItemSet != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyCounts.Contains(_fetcher.ItemSet[index].Count)) {
                    ...
                    case Expression.Less:
                        if (applyCount > _fetcher.ItemSet[index].Count) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
    ...
    public partial class Gs2InventoryItemSetCountSpriteSwitcher
    {
