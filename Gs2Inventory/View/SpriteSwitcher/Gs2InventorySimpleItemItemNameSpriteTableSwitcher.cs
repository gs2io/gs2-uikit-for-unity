...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/SimpleItem/View/SpriteSwitcher/Properties/ItemName/Gs2InventorySimpleItemItemNameSpriteTableSwitcher")]
    public partial class Gs2InventorySimpleItemItemNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.SimpleItem != null)
            {
                if (sprites.Count(v => v.value == _fetcher.SimpleItem.ItemName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.SimpleItem.ItemName).sprite);
                }
                else {
    ...
    public partial class Gs2InventorySimpleItemItemNameSpriteTableSwitcher
    {
