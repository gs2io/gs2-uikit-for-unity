...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/Inventory/View/SpriteSwitcher/Properties/InventoryName/Gs2InventoryInventoryInventoryNameSpriteTableSwitcher")]
    public partial class Gs2InventoryInventoryInventoryNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Inventory != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Inventory.InventoryName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Inventory.InventoryName).sprite);
                }
                else {
    ...
    public partial class Gs2InventoryInventoryInventoryNameSpriteTableSwitcher
    {
