...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/SpriteSwitcher/Properties/InventoryName/Gs2InventoryItemSetInventoryNameSpriteTableSwitcher")]
    public partial class Gs2InventoryItemSetInventoryNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.ItemSet != null)
            {
                if (sprites.Count(v => v.value == _fetcher.ItemSet[index].InventoryName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.ItemSet[index].InventoryName).sprite);
                }
                else {
    ...
    public partial class Gs2InventoryItemSetInventoryNameSpriteTableSwitcher
    {
