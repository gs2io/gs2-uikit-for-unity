...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/View/SpriteSwitcher/Properties/ItemName/Gs2InventoryBigItemItemNameSpriteSwitcher")]
    public partial class Gs2InventoryBigItemItemNameSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.BigItem != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyItemNames.Contains(_fetcher.BigItem.ItemName)) {
                    ...
                    case Expression.StartsWith:
                        if (_fetcher.BigItem.ItemName.StartsWith(applyItemName)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (_fetcher.BigItem.ItemName.EndsWith(applyItemName)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2InventoryBigItemItemNameSpriteSwitcher
    {
