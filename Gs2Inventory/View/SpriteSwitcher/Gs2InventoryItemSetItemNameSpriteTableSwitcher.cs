...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/SpriteSwitcher/Properties/ItemName/Gs2InventoryItemSetItemNameSpriteTableSwitcher")]
    public partial class Gs2InventoryItemSetItemNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.ItemSet != null)
            {
                if (sprites.Count(v => v.value == _fetcher.ItemSet[index].ItemName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.ItemSet[index].ItemName).sprite);
                }
                else {
    ...
    public partial class Gs2InventoryItemSetItemNameSpriteTableSwitcher
    {
