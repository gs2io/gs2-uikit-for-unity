...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/Inventory/View/SpriteSwitcher/Properties/InventoryName/Gs2InventoryInventoryInventoryNameSpriteSwitcher")]
    public partial class Gs2InventoryInventoryInventoryNameSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Inventory != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyInventoryNames.Contains(_fetcher.Inventory.InventoryName)) {
    ...
    public partial class Gs2InventoryInventoryInventoryNameSpriteSwitcher
    {
