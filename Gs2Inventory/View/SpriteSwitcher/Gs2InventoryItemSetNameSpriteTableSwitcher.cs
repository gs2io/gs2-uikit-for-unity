...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/SpriteSwitcher/Properties/Name/Gs2InventoryItemSetNameSpriteTableSwitcher")]
    public partial class Gs2InventoryItemSetNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.ItemSet != null)
            {
                if (sprites.Count(v => v.value == _fetcher.ItemSet[index].Name) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.ItemSet[index].Name).sprite);
                }
                else {
    ...
    public partial class Gs2InventoryItemSetNameSpriteTableSwitcher
    {
