...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/View/SpriteSwitcher/Properties/Count/Gs2InventoryBigItemCountSpriteTableSwitcher")]
    public partial class Gs2InventoryBigItemCountSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.BigItem != null)
            {
                if (sprites.Count(v => v.value == _fetcher.BigItem.Count.ToString("0")) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.BigItem.Count.ToString("0")).sprite);
                }
                else {
    ...
    public partial class Gs2InventoryBigItemCountSpriteTableSwitcher
    {
