...
namespace Gs2.Unity.UiKit.Gs2Inventory.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/BigItem/View/SpriteSwitcher/Properties/ItemName/Gs2InventoryBigItemItemNameSpriteTableSwitcher")]
    public partial class Gs2InventoryBigItemItemNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.BigItem != null)
            {
                if (sprites.Count(v => v.value == _fetcher.BigItem.ItemName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.BigItem.ItemName).sprite);
                }
                else {
    ...
    public partial class Gs2InventoryBigItemItemNameSpriteTableSwitcher
    {
