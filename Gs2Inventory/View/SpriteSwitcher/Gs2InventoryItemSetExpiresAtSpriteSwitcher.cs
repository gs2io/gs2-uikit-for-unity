...
namespace Gs2.Unity.UiKit.Gs2Inventory
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/ItemSet/View/SpriteSwitcher/Properties/ExpiresAt/Gs2InventoryItemSetExpiresAtSpriteSwitcher")]
    public partial class Gs2InventoryItemSetExpiresAtSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.ItemSet != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyExpiresAts.Contains(_fetcher.ItemSet[index].ExpiresAt)) {
                    ...
                    case Expression.Less:
                        if (applyExpiresAt > _fetcher.ItemSet[index].ExpiresAt) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
    ...
    public partial class Gs2InventoryItemSetExpiresAtSpriteSwitcher
    {
