...
namespace Gs2.Unity.UiKit.Gs2Inventory.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inventory/Inventory/Fetcher/Gs2InventoryInventoryListFetcher")]
    ...
    public partial class Gs2InventoryInventoryListFetcher
    {
        ...
        private Gs2InventoryUserContext _context;

        public void Awake()
        {
            _clientHolder = Gs2ClientHolder.Instance;
            _gameSessionHolder = Gs2GameSessionHolder.Instance;
            _context = GetComponentInParent<Gs2InventoryUserContext>();
        }
    }
