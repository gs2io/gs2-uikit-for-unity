        ...
        public override void OnInspectorGUI() {
            ...
            if (context == null) {
                ...
                if (context.transform.parent.GetComponent<Gs2InventoryOwnItemSetList>() != null) {
                    ...
                    EditorGUILayout.ObjectField("OwnItemSet", context.ItemSet, typeof(OwnItemSet), false);
                    EditorGUI.indentLevel++;
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("ConsumeCount"), true);
            EditorGUILayout.PropertyField(serializedObject.FindProperty("onChangeConsumeCount"), true);
