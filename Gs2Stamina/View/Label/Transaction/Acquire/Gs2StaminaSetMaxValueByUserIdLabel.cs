...
namespace Gs2.Unity.UiKit.Gs2Stamina.Label
{
    ...
    public partial class Gs2StaminaSetMaxValueByUserIdLabel
    {
        ...
        public void Awake()
        {
            _fetcher = GetComponent<Gs2StaminaSetMaxValueByUserIdFetcher>() ?? GetComponentInParent<Gs2StaminaSetMaxValueByUserIdFetcher>();
        ...
        {
            _fetcher = GetComponent<Gs2StaminaSetMaxValueByUserIdFetcher>() ?? GetComponentInParent<Gs2StaminaSetMaxValueByUserIdFetcher>(true);
