...
namespace Gs2.Unity.UiKit.Gs2Stamina.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/Stamina/View/Enabler/Properties/StaminaName/Gs2StaminaStaminaStaminaNameEnabler")]
    public partial class Gs2StaminaStaminaStaminaNameEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Stamina != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        target.SetActive(enableStaminaName.StartsWith(_fetcher.Stamina.StaminaName));
                        break;
                    case Expression.EndsWith:
                        target.SetActive(enableStaminaName.EndsWith(_fetcher.Stamina.StaminaName));
                        break;
                }
            }
            else
    ...
    public partial class Gs2StaminaStaminaStaminaNameEnabler
    {
