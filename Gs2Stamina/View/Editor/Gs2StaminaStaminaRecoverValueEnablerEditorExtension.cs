...
{
    [CustomEditor(typeof(Gs2StaminaStaminaRecoverValueEnabler))]
    public class Gs2StaminaStaminaRecoverValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaRecoverValueEnabler;
            ...
            if (original.expression == Gs2StaminaStaminaRecoverValueEnabler.Expression.In || original.expression == Gs2StaminaStaminaRecoverValueEnabler.Expression.NotIn) {
