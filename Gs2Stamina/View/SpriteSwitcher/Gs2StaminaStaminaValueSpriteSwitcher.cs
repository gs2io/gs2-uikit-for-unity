...
namespace Gs2.Unity.UiKit.Gs2Stamina
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/Stamina/View/SpriteSwitcher/Properties/Value/Gs2StaminaStaminaValueSpriteSwitcher")]
    public partial class Gs2StaminaStaminaValueSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Stamina != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyValues.Contains(_fetcher.Stamina.Value)) {
                    ...
                    case Expression.Less:
                        if (applyValue > _fetcher.Stamina.Value) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
    ...
    public partial class Gs2StaminaStaminaValueSpriteSwitcher
    {
