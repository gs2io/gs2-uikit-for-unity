...
namespace Gs2.Unity.UiKit.Gs2Stamina.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/Stamina/View/SpriteSwitcher/Properties/StaminaName/Gs2StaminaStaminaStaminaNameSpriteTableSwitcher")]
    public partial class Gs2StaminaStaminaStaminaNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Stamina != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Stamina.StaminaName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Stamina.StaminaName).sprite);
                }
                else {
    ...
    public partial class Gs2StaminaStaminaStaminaNameSpriteTableSwitcher
    {
