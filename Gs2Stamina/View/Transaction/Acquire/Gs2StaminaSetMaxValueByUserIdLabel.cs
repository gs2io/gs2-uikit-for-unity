...
namespace Gs2.Unity.UiKit.Gs2Stamina
{
	...
	[AddComponentMenu("GS2 UIKit/Stamina/Stamina/View/Transaction/Gs2StaminaSetMaxValueByUserIdLabel")]
    public partial class Gs2StaminaSetMaxValueByUserIdLabel : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.AcquireAction != null && _fetcher.AcquireAction.Action == "Gs2Stamina:SetMaxValueByUserId" &&
                    _userDataFetcher != null && _userDataFetcher.Fetched && _userDataFetcher.Stamina != null) {
                var request = SetMaxValueByUserIdRequest.FromJson(JsonMapper.ToObject(_fetcher.AcquireAction.Request));
                {
                    onUpdate?.Invoke(
                        format.Replace(
                            "{namespaceName}",
            ...
            } else if (_fetcher.Fetched && _fetcher.AcquireAction != null && _fetcher.AcquireAction.Action == "Gs2Stamina:SetMaxValueByUserId") {
                var request = SetMaxValueByUserIdRequest.FromJson(JsonMapper.ToObject(_fetcher.AcquireAction.Request));
                {
                    onUpdate?.Invoke(
                        format.Replace(
