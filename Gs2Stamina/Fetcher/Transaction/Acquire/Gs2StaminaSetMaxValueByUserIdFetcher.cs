...
namespace Gs2.Unity.UiKit.Gs2Stamina.Fetcher
{
    ...
    public partial class Gs2StaminaSetMaxValueByUserIdFetcher : MonoBehaviour
    {
        private IEnumerator Fetch()
        {
            ...
            {
                if (_fetcher != null) {
                    var action = _fetcher.AcquireActions().FirstOrDefault(v => v.Action == "Gs2Stamina:SetMaxValueByUserId");
                    if (action != null) {
