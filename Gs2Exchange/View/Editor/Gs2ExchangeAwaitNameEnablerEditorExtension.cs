...
{
    [CustomEditor(typeof(Gs2ExchangeAwaitNameEnabler))]
    public class Gs2ExchangeAwaitNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeAwaitNameEnabler;
            ...
            if (original.expression == Gs2ExchangeAwaitNameEnabler.Expression.In || original.expression == Gs2ExchangeAwaitNameEnabler.Expression.NotIn) {
