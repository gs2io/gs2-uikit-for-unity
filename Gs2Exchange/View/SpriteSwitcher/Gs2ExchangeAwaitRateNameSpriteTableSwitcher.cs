...
namespace Gs2.Unity.UiKit.Gs2Exchange.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/View/SpriteSwitcher/Properties/RateName/Gs2ExchangeAwaitRateNameSpriteTableSwitcher")]
    public partial class Gs2ExchangeAwaitRateNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Await != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Await.RateName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Await.RateName).sprite);
                }
                else {
    ...
    public partial class Gs2ExchangeAwaitRateNameSpriteTableSwitcher
    {
