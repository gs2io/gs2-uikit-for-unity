...
namespace Gs2.Unity.UiKit.Gs2Exchange.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/View/SpriteSwitcher/Properties/Name/Gs2ExchangeAwaitNameSpriteTableSwitcher")]
    public partial class Gs2ExchangeAwaitNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Await != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Await.Name) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Await.Name).sprite);
                }
                else {
    ...
    public partial class Gs2ExchangeAwaitNameSpriteTableSwitcher
    {
