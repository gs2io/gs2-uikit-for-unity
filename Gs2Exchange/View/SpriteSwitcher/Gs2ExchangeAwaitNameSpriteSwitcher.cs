...
namespace Gs2.Unity.UiKit.Gs2Exchange.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Exchange/Await/View/SpriteSwitcher/Properties/Name/Gs2ExchangeAwaitNameSpriteSwitcher")]
    public partial class Gs2ExchangeAwaitNameSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Await != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyNames.Contains(_fetcher.Await.Name)) {
                    ...
                    case Expression.StartsWith:
                        if (_fetcher.Await.Name.StartsWith(applyName)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (_fetcher.Await.Name.EndsWith(applyName)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2ExchangeAwaitNameSpriteSwitcher
    {
