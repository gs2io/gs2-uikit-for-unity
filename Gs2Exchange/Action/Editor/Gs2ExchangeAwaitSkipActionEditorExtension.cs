        ...
        public override void OnInspectorGUI() {
            ...
            if (context == null) {
                ...
                if (context.transform.parent.GetComponent<Gs2ExchangeOwnAwaitList>() != null) {
                    ...
                    EditorGUILayout.ObjectField("OwnAwait", context.Await_, typeof(OwnAwait), false);
                    EditorGUI.indentLevel++;
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("onSkipComplete"), true);
