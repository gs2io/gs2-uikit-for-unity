...
namespace Gs2.Unity.UiKit.Gs2Chat
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/Subscribe/View/Enabler/Gs2ChatSubscribeEnabler")]
    public partial class Gs2ChatSubscribeEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
    ...
    public partial class Gs2ChatSubscribeEnabler
    {
