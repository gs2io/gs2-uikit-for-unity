...
namespace Gs2.Unity.UiKit.Gs2Chat.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/Subscribe/View/SpriteSwitcher/Properties/RoomName/Gs2ChatSubscribeRoomNameSpriteTableSwitcher")]
    public partial class Gs2ChatSubscribeRoomNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Subscribe != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Subscribe.RoomName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Subscribe.RoomName).sprite);
                }
                else {
    ...
    public partial class Gs2ChatSubscribeRoomNameSpriteTableSwitcher
    {
