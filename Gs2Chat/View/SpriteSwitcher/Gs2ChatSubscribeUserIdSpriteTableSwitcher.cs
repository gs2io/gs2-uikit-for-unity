...
namespace Gs2.Unity.UiKit.Gs2Chat.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/Subscribe/View/SpriteSwitcher/Properties/UserId/Gs2ChatSubscribeUserIdSpriteTableSwitcher")]
    public partial class Gs2ChatSubscribeUserIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Subscribe != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Subscribe.UserId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Subscribe.UserId).sprite);
                }
                else {
    ...
    public partial class Gs2ChatSubscribeUserIdSpriteTableSwitcher
    {
