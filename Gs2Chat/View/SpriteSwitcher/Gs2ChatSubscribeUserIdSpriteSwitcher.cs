...
namespace Gs2.Unity.UiKit.Gs2Chat.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/Subscribe/View/SpriteSwitcher/Properties/UserId/Gs2ChatSubscribeUserIdSpriteSwitcher")]
    public partial class Gs2ChatSubscribeUserIdSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Subscribe != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyUserIds.Contains(_fetcher.Subscribe.UserId)) {
                    ...
                    case Expression.StartsWith:
                        if (applyUserId.StartsWith(_fetcher.Subscribe.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyUserId.EndsWith(_fetcher.Subscribe.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2ChatSubscribeUserIdSpriteSwitcher
    {
