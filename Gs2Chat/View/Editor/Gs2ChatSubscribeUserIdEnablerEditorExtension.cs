...
{
    [CustomEditor(typeof(Gs2ChatSubscribeUserIdEnabler))]
    public class Gs2ChatSubscribeUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatSubscribeUserIdEnabler;
            ...
            if (original.expression == Gs2ChatSubscribeUserIdEnabler.Expression.In || original.expression == Gs2ChatSubscribeUserIdEnabler.Expression.NotIn) {
