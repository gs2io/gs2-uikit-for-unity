...
namespace Gs2.Unity.UiKit.Gs2Chat.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/CategoryModel/Fetcher/Gs2ChatCategoryModelListFetcher")]
    public partial class Gs2ChatCategoryModelListFetcher : MonoBehaviour
    {
        ...
        private IEnumerator Load() {
            ...
            var items = new List<Gs2.Unity.Gs2Chat.Model.EzCategoryModel>();
            while (it.HasNext())
            {
    ...
    public partial class Gs2ChatCategoryModelListFetcher
    {
        public Gs2ChatNamespaceContext Context { get; private set; }
    ...
    public partial class Gs2ChatCategoryModelListFetcher
    {
        public List<Gs2.Unity.Gs2Chat.Model.EzCategoryModel> CategoryModels { get; private set; }
