...
namespace Gs2.Unity.UiKit.Gs2Chat.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Chat/Subscribe/Fetcher/Gs2ChatSubscribeFetcher")]
    public partial class Gs2ChatSubscribeFetcher : MonoBehaviour
    {
    ...
    public partial class Gs2ChatSubscribeFetcher
    {
        ...
        public void Awake()
        {
            ...
            _context = GetComponentInParent<Gs2ChatSubscribeContext>();
        }
    }
    ...
    public partial class Gs2ChatSubscribeFetcher
    {
        public EzSubscribe Subscribe { get; private set; }
