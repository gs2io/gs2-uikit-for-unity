...
namespace Gs2.Unity.UiKit.Gs2MegaField
{
	...
	[AddComponentMenu("GS2 UIKit/MegaField/Spatial/View/Enabler/Gs2MegaFieldSpatialEnabler")]
    public partial class Gs2MegaFieldSpatialEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
    ...
    public partial class Gs2MegaFieldSpatialEnabler
    {
