...
namespace Gs2.Unity.UiKit.Gs2MegaField.Editor
{
    ...
    public class Gs2MegaFieldSpatialAreaModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldSpatialAreaModelNameEnabler;
            ...
            if (original.expression == Gs2MegaFieldSpatialAreaModelNameEnabler.Expression.In || original.expression == Gs2MegaFieldSpatialAreaModelNameEnabler.Expression.NotIn) {
