...
namespace Gs2.Unity.UiKit.Gs2MegaField.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/MegaField/Spatial/View/SpriteSwitcher/Properties/AreaModelName/Gs2MegaFieldSpatialAreaModelNameSpriteTableSwitcher")]
    public partial class Gs2MegaFieldSpatialAreaModelNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Spatial != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Spatial.AreaModelName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Spatial.AreaModelName).sprite);
                }
                else {
    ...
    public partial class Gs2MegaFieldSpatialAreaModelNameSpriteTableSwitcher
    {
