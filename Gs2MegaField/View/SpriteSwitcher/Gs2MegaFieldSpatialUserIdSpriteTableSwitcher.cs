...
namespace Gs2.Unity.UiKit.Gs2MegaField.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/MegaField/Spatial/View/SpriteSwitcher/Properties/UserId/Gs2MegaFieldSpatialUserIdSpriteTableSwitcher")]
    public partial class Gs2MegaFieldSpatialUserIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Spatial != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Spatial.UserId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Spatial.UserId).sprite);
                }
                else {
    ...
    public partial class Gs2MegaFieldSpatialUserIdSpriteTableSwitcher
    {
