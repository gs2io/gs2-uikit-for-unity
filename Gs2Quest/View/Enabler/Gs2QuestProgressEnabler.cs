...
namespace Gs2.Unity.UiKit.Gs2Quest
{
	...
	[AddComponentMenu("GS2 UIKit/Quest/Progress/View/Enabler/Gs2QuestProgressEnabler")]
    public partial class Gs2QuestProgressEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
    ...
    public partial class Gs2QuestProgressEnabler
    {
