...
namespace Gs2.Unity.UiKit.Gs2Quest.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Quest/Progress/View/SpriteSwitcher/Properties/TransactionId/Gs2QuestProgressTransactionIdSpriteTableSwitcher")]
    public partial class Gs2QuestProgressTransactionIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Progress != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Progress.TransactionId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Progress.TransactionId).sprite);
                }
                else {
    ...
    public partial class Gs2QuestProgressTransactionIdSpriteTableSwitcher
    {
