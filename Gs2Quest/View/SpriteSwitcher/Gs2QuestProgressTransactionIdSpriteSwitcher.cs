...
namespace Gs2.Unity.UiKit.Gs2Quest.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Quest/Progress/View/SpriteSwitcher/Properties/TransactionId/Gs2QuestProgressTransactionIdSpriteSwitcher")]
    public partial class Gs2QuestProgressTransactionIdSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Progress != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        if (applyTransactionId.StartsWith(_fetcher.Progress.TransactionId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyTransactionId.EndsWith(_fetcher.Progress.TransactionId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2QuestProgressTransactionIdSpriteSwitcher
    {
