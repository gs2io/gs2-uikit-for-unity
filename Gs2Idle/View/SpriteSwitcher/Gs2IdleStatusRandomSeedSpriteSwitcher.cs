...
namespace Gs2.Unity.UiKit.Gs2Idle
{
	...
	[AddComponentMenu("GS2 UIKit/Idle/Status/View/SpriteSwitcher/Properties/RandomSeed/Gs2IdleStatusRandomSeedSpriteSwitcher")]
    public partial class Gs2IdleStatusRandomSeedSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Status != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyRandomSeeds.Contains(_fetcher.Status.RandomSeed)) {
                    ...
                    case Expression.Less:
                        if (applyRandomSeed > _fetcher.Status.RandomSeed) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
    ...
    public partial class Gs2IdleStatusRandomSeedSpriteSwitcher
    {
