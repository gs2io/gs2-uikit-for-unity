...
namespace Gs2.Unity.UiKit.Gs2Idle
{
	...
	[AddComponentMenu("GS2 UIKit/Idle/Status/View/Enabler/Properties/RandomSeed/Gs2IdleStatusRandomSeedEnabler")]
    public partial class Gs2IdleStatusRandomSeedEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Status != null)
            {
                ...
                {
                    case Expression.In:
                        target.SetActive(enableRandomSeeds.Contains(_fetcher.Status.RandomSeed));
                        break;
                    case Expression.NotIn:
                        target.SetActive(!enableRandomSeeds.Contains(_fetcher.Status.RandomSeed));
                        break;
                    case Expression.Less:
                        target.SetActive(enableRandomSeed > _fetcher.Status.RandomSeed);
                        break;
    ...
    public partial class Gs2IdleStatusRandomSeedEnabler
    {
