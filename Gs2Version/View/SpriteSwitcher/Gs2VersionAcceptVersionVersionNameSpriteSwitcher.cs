...
namespace Gs2.Unity.UiKit.Gs2Version.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Version/AcceptVersion/View/SpriteSwitcher/Properties/VersionName/Gs2VersionAcceptVersionVersionNameSpriteSwitcher")]
    public partial class Gs2VersionAcceptVersionVersionNameSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.AcceptVersion != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        if (applyVersionName.StartsWith(_fetcher.AcceptVersion.VersionName)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyVersionName.EndsWith(_fetcher.AcceptVersion.VersionName)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2VersionAcceptVersionVersionNameSpriteSwitcher
    {
