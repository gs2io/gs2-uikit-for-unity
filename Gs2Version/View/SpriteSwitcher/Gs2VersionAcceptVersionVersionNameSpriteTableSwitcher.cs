...
namespace Gs2.Unity.UiKit.Gs2Version.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Version/AcceptVersion/View/SpriteSwitcher/Properties/VersionName/Gs2VersionAcceptVersionVersionNameSpriteTableSwitcher")]
    public partial class Gs2VersionAcceptVersionVersionNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.AcceptVersion != null)
            {
                if (sprites.Count(v => v.value == _fetcher.AcceptVersion.VersionName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.AcceptVersion.VersionName).sprite);
                }
                else {
    ...
    public partial class Gs2VersionAcceptVersionVersionNameSpriteTableSwitcher
    {
