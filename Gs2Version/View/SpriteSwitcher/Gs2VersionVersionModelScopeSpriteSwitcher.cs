    ...
    public partial class Gs2VersionVersionModelScopeSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.VersionModel != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyScopes.Contains(_fetcher.VersionModel.Scope)) {
                    ...
                    case Expression.StartsWith:
                        if (applyScope.StartsWith(_fetcher.VersionModel.Scope)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyScope.EndsWith(_fetcher.VersionModel.Scope)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
