        ...
        public override void OnInspectorGUI() {
            ...
            if (context == null) {
                ...
                if (context.transform.parent.GetComponent<Gs2VersionOwnAcceptVersionList>() != null) {
                    ...
                    EditorGUILayout.ObjectField("OwnAcceptVersion", context.AcceptVersion, typeof(OwnAcceptVersion), false);
                    EditorGUI.indentLevel++;
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("onDeleteComplete"), true);
