...
namespace Gs2.Unity.UiKit.Gs2Enhance.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enhance/Progress/View/SpriteSwitcher/Properties/RateName/Gs2EnhanceProgressRateNameSpriteTableSwitcher")]
    public partial class Gs2EnhanceProgressRateNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Progress != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Progress.RateName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Progress.RateName).sprite);
                }
                else {
    ...
    public partial class Gs2EnhanceProgressRateNameSpriteTableSwitcher
    {
