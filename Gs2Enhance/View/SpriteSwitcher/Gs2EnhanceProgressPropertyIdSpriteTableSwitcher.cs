...
namespace Gs2.Unity.UiKit.Gs2Enhance.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enhance/Progress/View/SpriteSwitcher/Properties/PropertyId/Gs2EnhanceProgressPropertyIdSpriteTableSwitcher")]
    public partial class Gs2EnhanceProgressPropertyIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Progress != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Progress.PropertyId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Progress.PropertyId).sprite);
                }
                else {
    ...
    public partial class Gs2EnhanceProgressPropertyIdSpriteTableSwitcher
    {
