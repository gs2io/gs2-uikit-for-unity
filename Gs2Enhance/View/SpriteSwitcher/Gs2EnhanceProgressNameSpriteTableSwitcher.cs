...
namespace Gs2.Unity.UiKit.Gs2Enhance.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enhance/Progress/View/SpriteSwitcher/Properties/Name/Gs2EnhanceProgressNameSpriteTableSwitcher")]
    public partial class Gs2EnhanceProgressNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Progress != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Progress.Name) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Progress.Name).sprite);
                }
                else {
    ...
    public partial class Gs2EnhanceProgressNameSpriteTableSwitcher
    {
