...
namespace Gs2.Unity.UiKit.Gs2Enhance
{
	...
	[AddComponentMenu("GS2 UIKit/Enhance/Progress/View/SpriteSwitcher/Properties/ExperienceValue/Gs2EnhanceProgressExperienceValueSpriteSwitcher")]
    public partial class Gs2EnhanceProgressExperienceValueSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Progress != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyExperienceValues.Contains(_fetcher.Progress.ExperienceValue)) {
                    ...
                    case Expression.Less:
                        if (applyExperienceValue > _fetcher.Progress.ExperienceValue) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
    ...
    public partial class Gs2EnhanceProgressExperienceValueSpriteSwitcher
    {
