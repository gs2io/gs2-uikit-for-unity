    ...
    public class Gs2InventorySimpleInventoryModelContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            ...
            if (original.SimpleInventoryModel == null) {
                if (original.GetComponentInParent<Gs2InventorySimpleInventoryModelList>(true) != null) {
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("SimpleInventoryModel"), true);
                }
            }
            else {
