    ...
    public class Gs2InventoryBigInventoryModelLocalizationVariablesEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            ...
            if (fetcher == null) {
                ...
                else if (fetcher.gameObject.GetComponentInParent<Gs2InventoryOwnBigInventoryList>(true) != null) {
                    EditorGUI.BeginDisabledGroup(true);
                    EditorGUILayout.ObjectField("Fetcher", fetcher.gameObject, typeof(Gs2InventoryOwnBigInventoryFetcher), false);
                    EditorGUI.EndDisabledGroup();
                    EditorGUILayout.HelpBox("BigInventoryModel is auto assign from Gs2InventoryOwnBigInventoryList.", MessageType.Info);
                }
                else {
