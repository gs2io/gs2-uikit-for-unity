...
{
    [CustomEditor(typeof(Gs2InventoryBigItemLabel))]
    public class Gs2InventoryBigItemLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigItemLabel;
            ...
            if (fetcher == null) {
                ...
                if (fetcher.gameObject.GetComponentInParent<Gs2InventoryOwnBigItemList>(true) != null) {
                    ...
                    if (fetcher.Context != null) {
                        fetcher.Context.BigItem = EditorGUILayout.ObjectField("BigItem", fetcher.Context.BigItem, typeof(OwnBigItem), false) as OwnBigItem;
                        EditorGUI.indentLevel++;
