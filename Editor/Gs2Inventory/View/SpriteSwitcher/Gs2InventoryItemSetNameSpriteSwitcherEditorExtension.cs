...
{
    [CustomEditor(typeof(Gs2InventoryItemSetNameSpriteSwitcher))]
    public class Gs2InventoryItemSetNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemSetNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryItemSetNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryItemSetNameSpriteSwitcher.Expression.NotIn) {
