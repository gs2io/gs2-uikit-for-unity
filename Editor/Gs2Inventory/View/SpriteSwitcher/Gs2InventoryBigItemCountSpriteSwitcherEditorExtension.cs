...
{
    [CustomEditor(typeof(Gs2InventoryBigItemCountSpriteSwitcher))]
    public class Gs2InventoryBigItemCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigItemCountSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryBigItemCountSpriteSwitcher.Expression.In || original.expression == Gs2InventoryBigItemCountSpriteSwitcher.Expression.NotIn) {
