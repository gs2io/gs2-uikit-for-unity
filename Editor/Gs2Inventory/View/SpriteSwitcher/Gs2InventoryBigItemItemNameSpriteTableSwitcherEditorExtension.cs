...
{
    [CustomEditor(typeof(Gs2InventoryBigItemItemNameSpriteTableSwitcher))]
    public class Gs2InventoryBigItemItemNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigItemItemNameSpriteTableSwitcher;
