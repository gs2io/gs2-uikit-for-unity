...
{
    [CustomEditor(typeof(Gs2InventorySimpleItemItemNameSpriteSwitcher))]
    public class Gs2InventorySimpleItemItemNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleItemItemNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventorySimpleItemItemNameSpriteSwitcher.Expression.In || original.expression == Gs2InventorySimpleItemItemNameSpriteSwitcher.Expression.NotIn) {
