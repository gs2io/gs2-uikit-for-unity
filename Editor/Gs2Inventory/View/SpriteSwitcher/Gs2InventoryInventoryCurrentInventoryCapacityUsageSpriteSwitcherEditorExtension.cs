...
{
    [CustomEditor(typeof(Gs2InventoryInventoryCurrentInventoryCapacityUsageSpriteSwitcher))]
    public class Gs2InventoryInventoryCurrentInventoryCapacityUsageSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryInventoryCurrentInventoryCapacityUsageSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryInventoryCurrentInventoryCapacityUsageSpriteSwitcher.Expression.In || original.expression == Gs2InventoryInventoryCurrentInventoryCapacityUsageSpriteSwitcher.Expression.NotIn) {
