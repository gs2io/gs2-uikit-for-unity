...
{
    [CustomEditor(typeof(Gs2InventorySimpleItemCountSpriteSwitcher))]
    public class Gs2InventorySimpleItemCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleItemCountSpriteSwitcher;
            ...
            if (original.expression == Gs2InventorySimpleItemCountSpriteSwitcher.Expression.In || original.expression == Gs2InventorySimpleItemCountSpriteSwitcher.Expression.NotIn) {
