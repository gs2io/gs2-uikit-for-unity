...
{
    [CustomEditor(typeof(Gs2InventoryInventoryCurrentInventoryMaxCapacitySpriteSwitcher))]
    public class Gs2InventoryInventoryCurrentInventoryMaxCapacitySpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryInventoryCurrentInventoryMaxCapacitySpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryInventoryCurrentInventoryMaxCapacitySpriteSwitcher.Expression.In || original.expression == Gs2InventoryInventoryCurrentInventoryMaxCapacitySpriteSwitcher.Expression.NotIn) {
