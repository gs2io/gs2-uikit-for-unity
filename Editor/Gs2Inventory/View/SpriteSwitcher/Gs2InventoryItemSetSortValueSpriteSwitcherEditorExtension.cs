...
{
    [CustomEditor(typeof(Gs2InventoryItemSetSortValueSpriteSwitcher))]
    public class Gs2InventoryItemSetSortValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemSetSortValueSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryItemSetSortValueSpriteSwitcher.Expression.In || original.expression == Gs2InventoryItemSetSortValueSpriteSwitcher.Expression.NotIn) {
