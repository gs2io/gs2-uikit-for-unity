...
{
    [CustomEditor(typeof(Gs2InventoryInventoryInventoryNameSpriteSwitcher))]
    public class Gs2InventoryInventoryInventoryNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryInventoryInventoryNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryInventoryInventoryNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryInventoryInventoryNameSpriteSwitcher.Expression.NotIn) {
