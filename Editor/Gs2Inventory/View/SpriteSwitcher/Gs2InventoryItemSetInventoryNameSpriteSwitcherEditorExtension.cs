...
{
    [CustomEditor(typeof(Gs2InventoryItemSetInventoryNameSpriteSwitcher))]
    public class Gs2InventoryItemSetInventoryNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemSetInventoryNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryItemSetInventoryNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryItemSetInventoryNameSpriteSwitcher.Expression.NotIn) {
