...
{
    [CustomEditor(typeof(Gs2InventoryItemSetInventoryNameSpriteTableSwitcher))]
    public class Gs2InventoryItemSetInventoryNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemSetInventoryNameSpriteTableSwitcher;
