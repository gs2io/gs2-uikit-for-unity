...
{
    [CustomEditor(typeof(Gs2InventoryBigItemItemNameSpriteSwitcher))]
    public class Gs2InventoryBigItemItemNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigItemItemNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryBigItemItemNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryBigItemItemNameSpriteSwitcher.Expression.NotIn) {
