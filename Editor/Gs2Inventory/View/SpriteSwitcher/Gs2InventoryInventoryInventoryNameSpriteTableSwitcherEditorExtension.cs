...
{
    [CustomEditor(typeof(Gs2InventoryInventoryInventoryNameSpriteTableSwitcher))]
    public class Gs2InventoryInventoryInventoryNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryInventoryInventoryNameSpriteTableSwitcher;
