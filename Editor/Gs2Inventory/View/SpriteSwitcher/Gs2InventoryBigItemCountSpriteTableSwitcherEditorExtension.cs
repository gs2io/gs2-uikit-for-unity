...
{
    [CustomEditor(typeof(Gs2InventoryBigItemCountSpriteTableSwitcher))]
    public class Gs2InventoryBigItemCountSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigItemCountSpriteTableSwitcher;
