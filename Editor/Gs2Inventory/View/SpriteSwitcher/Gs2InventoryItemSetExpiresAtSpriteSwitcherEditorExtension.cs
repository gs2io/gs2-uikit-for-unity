...
{
    [CustomEditor(typeof(Gs2InventoryItemSetExpiresAtSpriteSwitcher))]
    public class Gs2InventoryItemSetExpiresAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemSetExpiresAtSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryItemSetExpiresAtSpriteSwitcher.Expression.In || original.expression == Gs2InventoryItemSetExpiresAtSpriteSwitcher.Expression.NotIn) {
