...
{
    [CustomEditor(typeof(Gs2InventoryItemSetItemNameSpriteTableSwitcher))]
    public class Gs2InventoryItemSetItemNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemSetItemNameSpriteTableSwitcher;
