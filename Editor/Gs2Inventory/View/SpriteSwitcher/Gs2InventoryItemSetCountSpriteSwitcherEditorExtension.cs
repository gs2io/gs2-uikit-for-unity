...
{
    [CustomEditor(typeof(Gs2InventoryItemSetCountSpriteSwitcher))]
    public class Gs2InventoryItemSetCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemSetCountSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryItemSetCountSpriteSwitcher.Expression.In || original.expression == Gs2InventoryItemSetCountSpriteSwitcher.Expression.NotIn) {
