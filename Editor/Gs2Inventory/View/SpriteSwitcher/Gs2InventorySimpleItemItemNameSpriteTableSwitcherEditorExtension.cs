...
{
    [CustomEditor(typeof(Gs2InventorySimpleItemItemNameSpriteTableSwitcher))]
    public class Gs2InventorySimpleItemItemNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleItemItemNameSpriteTableSwitcher;
