...
{
    [CustomEditor(typeof(Gs2InventoryItemSetItemNameSpriteSwitcher))]
    public class Gs2InventoryItemSetItemNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemSetItemNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InventoryItemSetItemNameSpriteSwitcher.Expression.In || original.expression == Gs2InventoryItemSetItemNameSpriteSwitcher.Expression.NotIn) {
