...
{
    [CustomEditor(typeof(Gs2InventoryItemSetNameSpriteTableSwitcher))]
    public class Gs2InventoryItemSetNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemSetNameSpriteTableSwitcher;
