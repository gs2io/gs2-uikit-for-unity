...
{
    [CustomEditor(typeof(Gs2InventoryInventoryInventoryNameEnabler))]
    public class Gs2InventoryInventoryInventoryNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryInventoryInventoryNameEnabler;
            ...
            if (original.expression == Gs2InventoryInventoryInventoryNameEnabler.Expression.In || original.expression == Gs2InventoryInventoryInventoryNameEnabler.Expression.NotIn) {
