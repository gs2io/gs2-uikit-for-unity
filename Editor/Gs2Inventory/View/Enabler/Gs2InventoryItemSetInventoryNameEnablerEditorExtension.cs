...
{
    [CustomEditor(typeof(Gs2InventoryItemSetInventoryNameEnabler))]
    public class Gs2InventoryItemSetInventoryNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemSetInventoryNameEnabler;
            ...
            if (original.expression == Gs2InventoryItemSetInventoryNameEnabler.Expression.In || original.expression == Gs2InventoryItemSetInventoryNameEnabler.Expression.NotIn) {
