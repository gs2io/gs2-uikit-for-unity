...
{
    [CustomEditor(typeof(Gs2InventoryBigItemItemNameEnabler))]
    public class Gs2InventoryBigItemItemNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigItemItemNameEnabler;
            ...
            if (original.expression == Gs2InventoryBigItemItemNameEnabler.Expression.In || original.expression == Gs2InventoryBigItemItemNameEnabler.Expression.NotIn) {
