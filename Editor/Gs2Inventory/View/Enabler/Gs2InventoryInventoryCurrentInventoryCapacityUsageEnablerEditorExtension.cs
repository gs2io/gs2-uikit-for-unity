...
{
    [CustomEditor(typeof(Gs2InventoryInventoryCurrentInventoryCapacityUsageEnabler))]
    public class Gs2InventoryInventoryCurrentInventoryCapacityUsageEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryInventoryCurrentInventoryCapacityUsageEnabler;
            ...
            if (original.expression == Gs2InventoryInventoryCurrentInventoryCapacityUsageEnabler.Expression.In || original.expression == Gs2InventoryInventoryCurrentInventoryCapacityUsageEnabler.Expression.NotIn) {
