...
{
    [CustomEditor(typeof(Gs2InventoryItemSetCountEnabler))]
    public class Gs2InventoryItemSetCountEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemSetCountEnabler;
            ...
            if (original.expression == Gs2InventoryItemSetCountEnabler.Expression.In || original.expression == Gs2InventoryItemSetCountEnabler.Expression.NotIn) {
