...
{
    [CustomEditor(typeof(Gs2InventorySimpleItemItemNameEnabler))]
    public class Gs2InventorySimpleItemItemNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleItemItemNameEnabler;
            ...
            if (original.expression == Gs2InventorySimpleItemItemNameEnabler.Expression.In || original.expression == Gs2InventorySimpleItemItemNameEnabler.Expression.NotIn) {
