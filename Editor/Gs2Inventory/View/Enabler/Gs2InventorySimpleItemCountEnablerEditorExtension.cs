...
{
    [CustomEditor(typeof(Gs2InventorySimpleItemCountEnabler))]
    public class Gs2InventorySimpleItemCountEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventorySimpleItemCountEnabler;
            ...
            if (original.expression == Gs2InventorySimpleItemCountEnabler.Expression.In || original.expression == Gs2InventorySimpleItemCountEnabler.Expression.NotIn) {
