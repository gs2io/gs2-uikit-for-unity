...
{
    [CustomEditor(typeof(Gs2InventoryBigItemCountEnabler))]
    public class Gs2InventoryBigItemCountEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryBigItemCountEnabler;
            ...
            if (original.expression == Gs2InventoryBigItemCountEnabler.Expression.In || original.expression == Gs2InventoryBigItemCountEnabler.Expression.NotIn) {
