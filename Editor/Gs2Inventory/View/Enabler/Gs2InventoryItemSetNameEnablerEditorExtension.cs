...
{
    [CustomEditor(typeof(Gs2InventoryItemSetNameEnabler))]
    public class Gs2InventoryItemSetNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InventoryItemSetNameEnabler;
            ...
            if (original.expression == Gs2InventoryItemSetNameEnabler.Expression.In || original.expression == Gs2InventoryItemSetNameEnabler.Expression.NotIn) {
