...
{
    [CustomEditor(typeof(Gs2InboxMessageMetadataSpriteSwitcher))]
    public class Gs2InboxMessageMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2InboxMessageMetadataSpriteSwitcher.Expression.In || original.expression == Gs2InboxMessageMetadataSpriteSwitcher.Expression.NotIn) {
