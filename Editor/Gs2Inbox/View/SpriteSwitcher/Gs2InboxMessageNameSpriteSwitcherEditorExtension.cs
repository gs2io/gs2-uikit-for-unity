...
{
    [CustomEditor(typeof(Gs2InboxMessageNameSpriteSwitcher))]
    public class Gs2InboxMessageNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageNameSpriteSwitcher;
            ...
            if (original.expression == Gs2InboxMessageNameSpriteSwitcher.Expression.In || original.expression == Gs2InboxMessageNameSpriteSwitcher.Expression.NotIn) {
