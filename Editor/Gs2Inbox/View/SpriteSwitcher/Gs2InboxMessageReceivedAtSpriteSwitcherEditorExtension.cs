...
{
    [CustomEditor(typeof(Gs2InboxMessageReceivedAtSpriteSwitcher))]
    public class Gs2InboxMessageReceivedAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageReceivedAtSpriteSwitcher;
            ...
            if (original.expression == Gs2InboxMessageReceivedAtSpriteSwitcher.Expression.In || original.expression == Gs2InboxMessageReceivedAtSpriteSwitcher.Expression.NotIn) {
