...
{
    [CustomEditor(typeof(Gs2InboxMessageMetadataSpriteTableSwitcher))]
    public class Gs2InboxMessageMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageMetadataSpriteTableSwitcher;
