...
{
    [CustomEditor(typeof(Gs2InboxMessageExpiresAtSpriteSwitcher))]
    public class Gs2InboxMessageExpiresAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageExpiresAtSpriteSwitcher;
            ...
            if (original.expression == Gs2InboxMessageExpiresAtSpriteSwitcher.Expression.In || original.expression == Gs2InboxMessageExpiresAtSpriteSwitcher.Expression.NotIn) {
