...
{
    [CustomEditor(typeof(Gs2InboxMessageNameSpriteTableSwitcher))]
    public class Gs2InboxMessageNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageNameSpriteTableSwitcher;
