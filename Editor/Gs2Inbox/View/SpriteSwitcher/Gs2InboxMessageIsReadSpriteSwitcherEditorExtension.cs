...
{
    [CustomEditor(typeof(Gs2InboxMessageIsReadSpriteSwitcher))]
    public class Gs2InboxMessageIsReadSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageIsReadSpriteSwitcher;
