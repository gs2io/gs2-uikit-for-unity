...
{
    [CustomEditor(typeof(Gs2InboxMessageReadAtSpriteSwitcher))]
    public class Gs2InboxMessageReadAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageReadAtSpriteSwitcher;
            ...
            if (original.expression == Gs2InboxMessageReadAtSpriteSwitcher.Expression.In || original.expression == Gs2InboxMessageReadAtSpriteSwitcher.Expression.NotIn) {
