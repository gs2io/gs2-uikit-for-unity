...
{
    [CustomEditor(typeof(Gs2InboxMessageIsReadEnabler))]
    public class Gs2InboxMessageIsReadEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageIsReadEnabler;
