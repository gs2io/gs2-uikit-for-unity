...
namespace Gs2.Unity.UiKit.Gs2Inbox.Enabler.Editor
{
    ...
    public class Gs2InboxMessageMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageMetadataEnabler;
            ...
            if (original.expression == Gs2InboxMessageMetadataEnabler.Expression.In || original.expression == Gs2InboxMessageMetadataEnabler.Expression.NotIn) {
