...
{
    [CustomEditor(typeof(Gs2InboxMessageEnabler))]
    public class Gs2InboxMessageEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageEnabler;
