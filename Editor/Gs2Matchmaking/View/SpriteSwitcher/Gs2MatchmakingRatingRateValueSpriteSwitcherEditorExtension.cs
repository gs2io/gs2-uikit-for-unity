...
{
    [CustomEditor(typeof(Gs2MatchmakingRatingRateValueSpriteSwitcher))]
    public class Gs2MatchmakingRatingRateValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingRatingRateValueSpriteSwitcher;
            ...
            if (original.expression == Gs2MatchmakingRatingRateValueSpriteSwitcher.Expression.In || original.expression == Gs2MatchmakingRatingRateValueSpriteSwitcher.Expression.NotIn) {
