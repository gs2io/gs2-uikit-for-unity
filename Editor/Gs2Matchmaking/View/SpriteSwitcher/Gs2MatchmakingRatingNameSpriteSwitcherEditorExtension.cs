...
{
    [CustomEditor(typeof(Gs2MatchmakingRatingNameSpriteSwitcher))]
    public class Gs2MatchmakingRatingNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingRatingNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MatchmakingRatingNameSpriteSwitcher.Expression.In || original.expression == Gs2MatchmakingRatingNameSpriteSwitcher.Expression.NotIn) {
