...
{
    [CustomEditor(typeof(Gs2MatchmakingRatingNameSpriteTableSwitcher))]
    public class Gs2MatchmakingRatingNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingRatingNameSpriteTableSwitcher;
