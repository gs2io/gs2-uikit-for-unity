...
{
    [CustomEditor(typeof(Gs2MatchmakingRatingUserIdSpriteTableSwitcher))]
    public class Gs2MatchmakingRatingUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingRatingUserIdSpriteTableSwitcher;
