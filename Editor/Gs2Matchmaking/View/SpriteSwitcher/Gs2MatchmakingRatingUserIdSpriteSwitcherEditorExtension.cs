...
{
    [CustomEditor(typeof(Gs2MatchmakingRatingUserIdSpriteSwitcher))]
    public class Gs2MatchmakingRatingUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingRatingUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2MatchmakingRatingUserIdSpriteSwitcher.Expression.In || original.expression == Gs2MatchmakingRatingUserIdSpriteSwitcher.Expression.NotIn) {
