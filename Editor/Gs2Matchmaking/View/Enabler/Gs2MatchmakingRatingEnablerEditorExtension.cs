...
{
    [CustomEditor(typeof(Gs2MatchmakingRatingEnabler))]
    public class Gs2MatchmakingRatingEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingRatingEnabler;
