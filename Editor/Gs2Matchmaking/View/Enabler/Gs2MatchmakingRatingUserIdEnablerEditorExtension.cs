...
namespace Gs2.Unity.UiKit.Gs2Matchmaking.Enabler.Editor
{
    ...
    public class Gs2MatchmakingRatingUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MatchmakingRatingUserIdEnabler;
            ...
            if (original.expression == Gs2MatchmakingRatingUserIdEnabler.Expression.In || original.expression == Gs2MatchmakingRatingUserIdEnabler.Expression.NotIn) {
