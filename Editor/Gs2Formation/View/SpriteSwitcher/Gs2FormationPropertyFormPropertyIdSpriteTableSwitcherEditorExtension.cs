...
{
    [CustomEditor(typeof(Gs2FormationPropertyFormPropertyIdSpriteTableSwitcher))]
    public class Gs2FormationPropertyFormPropertyIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationPropertyFormPropertyIdSpriteTableSwitcher;
