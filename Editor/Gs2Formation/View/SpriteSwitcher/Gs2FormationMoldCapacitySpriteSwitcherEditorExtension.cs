...
{
    [CustomEditor(typeof(Gs2FormationMoldCapacitySpriteSwitcher))]
    public class Gs2FormationMoldCapacitySpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldCapacitySpriteSwitcher;
            ...
            if (original.expression == Gs2FormationMoldCapacitySpriteSwitcher.Expression.In || original.expression == Gs2FormationMoldCapacitySpriteSwitcher.Expression.NotIn) {
