...
{
    [CustomEditor(typeof(Gs2FormationMoldUserIdSpriteSwitcher))]
    public class Gs2FormationMoldUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationMoldUserIdSpriteSwitcher.Expression.In || original.expression == Gs2FormationMoldUserIdSpriteSwitcher.Expression.NotIn) {
