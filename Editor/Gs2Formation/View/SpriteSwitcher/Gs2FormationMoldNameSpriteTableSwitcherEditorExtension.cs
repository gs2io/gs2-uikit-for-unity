...
{
    [CustomEditor(typeof(Gs2FormationMoldNameSpriteTableSwitcher))]
    public class Gs2FormationMoldNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldNameSpriteTableSwitcher;
