...
{
    [CustomEditor(typeof(Gs2FormationFormNameSpriteSwitcher))]
    public class Gs2FormationFormNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationFormNameSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationFormNameSpriteSwitcher.Expression.In || original.expression == Gs2FormationFormNameSpriteSwitcher.Expression.NotIn) {
