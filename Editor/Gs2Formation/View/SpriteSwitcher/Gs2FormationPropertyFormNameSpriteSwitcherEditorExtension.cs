...
{
    [CustomEditor(typeof(Gs2FormationPropertyFormNameSpriteSwitcher))]
    public class Gs2FormationPropertyFormNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationPropertyFormNameSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationPropertyFormNameSpriteSwitcher.Expression.In || original.expression == Gs2FormationPropertyFormNameSpriteSwitcher.Expression.NotIn) {
