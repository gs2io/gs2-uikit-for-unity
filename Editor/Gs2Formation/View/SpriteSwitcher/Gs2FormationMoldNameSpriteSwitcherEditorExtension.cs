...
{
    [CustomEditor(typeof(Gs2FormationMoldNameSpriteSwitcher))]
    public class Gs2FormationMoldNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldNameSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationMoldNameSpriteSwitcher.Expression.In || original.expression == Gs2FormationMoldNameSpriteSwitcher.Expression.NotIn) {
