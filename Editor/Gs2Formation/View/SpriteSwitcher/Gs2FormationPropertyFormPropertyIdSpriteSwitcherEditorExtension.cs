...
{
    [CustomEditor(typeof(Gs2FormationPropertyFormPropertyIdSpriteSwitcher))]
    public class Gs2FormationPropertyFormPropertyIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationPropertyFormPropertyIdSpriteSwitcher;
            ...
            if (original.expression == Gs2FormationPropertyFormPropertyIdSpriteSwitcher.Expression.In || original.expression == Gs2FormationPropertyFormPropertyIdSpriteSwitcher.Expression.NotIn) {
