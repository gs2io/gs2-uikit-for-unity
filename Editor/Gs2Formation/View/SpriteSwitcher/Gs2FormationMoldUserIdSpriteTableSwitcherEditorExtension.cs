...
{
    [CustomEditor(typeof(Gs2FormationMoldUserIdSpriteTableSwitcher))]
    public class Gs2FormationMoldUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldUserIdSpriteTableSwitcher;
