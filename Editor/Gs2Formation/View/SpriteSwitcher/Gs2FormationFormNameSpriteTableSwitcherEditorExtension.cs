...
{
    [CustomEditor(typeof(Gs2FormationFormNameSpriteTableSwitcher))]
    public class Gs2FormationFormNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationFormNameSpriteTableSwitcher;
