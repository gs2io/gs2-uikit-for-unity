...
{
    [CustomEditor(typeof(Gs2FormationPropertyFormNameSpriteTableSwitcher))]
    public class Gs2FormationPropertyFormNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationPropertyFormNameSpriteTableSwitcher;
