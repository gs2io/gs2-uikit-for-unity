...
{
    [CustomEditor(typeof(Gs2FormationPropertyFormEnabler))]
    public class Gs2FormationPropertyFormEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationPropertyFormEnabler;
