...
{
    [CustomEditor(typeof(Gs2FormationMoldNameEnabler))]
    public class Gs2FormationMoldNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldNameEnabler;
            ...
            if (original.expression == Gs2FormationMoldNameEnabler.Expression.In || original.expression == Gs2FormationMoldNameEnabler.Expression.NotIn) {
