...
{
    [CustomEditor(typeof(Gs2FormationFormEnabler))]
    public class Gs2FormationFormEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationFormEnabler;
