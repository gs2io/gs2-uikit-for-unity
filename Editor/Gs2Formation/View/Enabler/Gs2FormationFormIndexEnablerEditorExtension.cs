...
{
    [CustomEditor(typeof(Gs2FormationFormIndexEnabler))]
    public class Gs2FormationFormIndexEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationFormIndexEnabler;
            ...
            if (original.expression == Gs2FormationFormIndexEnabler.Expression.In || original.expression == Gs2FormationFormIndexEnabler.Expression.NotIn) {
