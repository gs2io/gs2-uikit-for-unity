...
{
    [CustomEditor(typeof(Gs2FormationMoldUserIdEnabler))]
    public class Gs2FormationMoldUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationMoldUserIdEnabler;

            if (original == null) return;

            var context = original.GetComponent<Gs2FormationOwnMoldContext>() ?? original.GetComponentInParent<Gs2FormationOwnMoldContext>();
            if (context == null) {
            ...
            if (original.expression == Gs2FormationMoldUserIdEnabler.Expression.In || original.expression == Gs2FormationMoldUserIdEnabler.Expression.NotIn) {
