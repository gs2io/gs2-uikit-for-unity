...
{
    [CustomEditor(typeof(Gs2FormationSlotLabel))]
    public class Gs2FormationSlotLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FormationSlotLabel;
            ...
            if (fetcher == null) {
                ...
                if (fetcher.gameObject.GetComponentInParent<Gs2FormationOwnSlotList>(true) != null) {
                    ...
                    if (fetcher.Context != null) {
                        ...
                        EditorGUILayout.TextField("MoldName", fetcher.Context.Slot?.MoldName.ToString());
