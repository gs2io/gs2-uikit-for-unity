...
{
    [CustomEditor(typeof(Gs2MissionCompleteEvaluateCompleteAction))]
    public class Gs2MissionCompleteEvaluateCompleteActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionCompleteEvaluateCompleteAction;
