...
{
    [CustomEditor(typeof(Gs2MissionCounterResetCounterAction))]
    public class Gs2MissionCounterResetCounterActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionCounterResetCounterAction;
