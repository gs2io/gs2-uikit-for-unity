...
{
    [CustomEditor(typeof(Gs2MissionResetCounterByUserIdLabel))]
    public class Gs2MissionResetCounterByUserIdLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionResetCounterByUserIdLabel;

            if (original == null) return;

            var fetcher = original.GetComponent<Gs2MissionResetCounterByUserIdFetcher>() ?? original.GetComponentInParent<Gs2MissionResetCounterByUserIdFetcher>(true);
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("Gs2MissionResetCounterByUserIdFetcher not found.", MessageType.Error);
                if (GUILayout.Button("Add Fetcher")) {
                    original.gameObject.AddComponent<Gs2MissionResetCounterByUserIdFetcher>();
                }
            }
