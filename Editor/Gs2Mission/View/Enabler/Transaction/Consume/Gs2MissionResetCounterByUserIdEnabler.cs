...
{
    [CustomEditor(typeof(Gs2MissionResetCounterByUserIdEnabler))]
    public class Gs2MissionResetCounterByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionResetCounterByUserIdEnabler;
