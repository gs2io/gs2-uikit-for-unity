...
{
    [CustomEditor(typeof(Gs2MissionCounterEnabler))]
    public class Gs2MissionCounterEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionCounterEnabler;
