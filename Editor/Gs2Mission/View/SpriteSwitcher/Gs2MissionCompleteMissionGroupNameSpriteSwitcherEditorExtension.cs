...
{
    [CustomEditor(typeof(Gs2MissionCompleteMissionGroupNameSpriteSwitcher))]
    public class Gs2MissionCompleteMissionGroupNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionCompleteMissionGroupNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionCompleteMissionGroupNameSpriteSwitcher.Expression.In || original.expression == Gs2MissionCompleteMissionGroupNameSpriteSwitcher.Expression.NotIn) {
