...
{
    [CustomEditor(typeof(Gs2MissionCounterNameSpriteTableSwitcher))]
    public class Gs2MissionCounterNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionCounterNameSpriteTableSwitcher;
