...
{
    [CustomEditor(typeof(Gs2MissionCompleteMissionGroupNameSpriteTableSwitcher))]
    public class Gs2MissionCompleteMissionGroupNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionCompleteMissionGroupNameSpriteTableSwitcher;
