...
{
    [CustomEditor(typeof(Gs2MissionCounterNameSpriteSwitcher))]
    public class Gs2MissionCounterNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionCounterNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MissionCounterNameSpriteSwitcher.Expression.In || original.expression == Gs2MissionCounterNameSpriteSwitcher.Expression.NotIn) {
