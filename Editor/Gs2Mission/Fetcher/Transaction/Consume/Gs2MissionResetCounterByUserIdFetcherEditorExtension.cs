...
{
    [CustomEditor(typeof(Gs2MissionResetCounterByUserIdFetcher))]
    public class Gs2MissionResetCounterByUserIdFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MissionResetCounterByUserIdFetcher;
