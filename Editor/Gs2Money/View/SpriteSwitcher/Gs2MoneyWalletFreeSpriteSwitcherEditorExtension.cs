...
{
    [CustomEditor(typeof(Gs2MoneyWalletFreeSpriteSwitcher))]
    public class Gs2MoneyWalletFreeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyWalletFreeSpriteSwitcher;
            ...
            if (original.expression == Gs2MoneyWalletFreeSpriteSwitcher.Expression.In || original.expression == Gs2MoneyWalletFreeSpriteSwitcher.Expression.NotIn) {
