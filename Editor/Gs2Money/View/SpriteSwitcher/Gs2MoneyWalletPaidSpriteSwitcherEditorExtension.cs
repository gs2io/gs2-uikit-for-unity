...
{
    [CustomEditor(typeof(Gs2MoneyWalletPaidSpriteSwitcher))]
    public class Gs2MoneyWalletPaidSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyWalletPaidSpriteSwitcher;
            ...
            if (original.expression == Gs2MoneyWalletPaidSpriteSwitcher.Expression.In || original.expression == Gs2MoneyWalletPaidSpriteSwitcher.Expression.NotIn) {
