...
{
    [CustomEditor(typeof(Gs2MoneyWalletSlotSpriteSwitcher))]
    public class Gs2MoneyWalletSlotSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyWalletSlotSpriteSwitcher;
            ...
            if (original.expression == Gs2MoneyWalletSlotSpriteSwitcher.Expression.In || original.expression == Gs2MoneyWalletSlotSpriteSwitcher.Expression.NotIn) {
