...
{
    [CustomEditor(typeof(Gs2MoneyWalletEnabler))]
    public class Gs2MoneyWalletEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyWalletEnabler;
