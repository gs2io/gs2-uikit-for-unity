...
{
    [CustomEditor(typeof(Gs2MoneyWalletSlotEnabler))]
    public class Gs2MoneyWalletSlotEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MoneyWalletSlotEnabler;
            ...
            if (original.expression == Gs2MoneyWalletSlotEnabler.Expression.In || original.expression == Gs2MoneyWalletSlotEnabler.Expression.NotIn) {
