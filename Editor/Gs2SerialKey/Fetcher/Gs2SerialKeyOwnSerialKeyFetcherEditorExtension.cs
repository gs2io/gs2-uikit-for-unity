...
{
    [CustomEditor(typeof(Gs2SerialKeyOwnSerialKeyFetcher))]
    public class Gs2SerialKeyOwnSerialKeyFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2SerialKeyOwnSerialKeyFetcher;
