...
{
    [CustomEditor(typeof(Gs2ExchangeAwaitRateNameEnabler))]
    public class Gs2ExchangeAwaitRateNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeAwaitRateNameEnabler;
            ...
            if (original.expression == Gs2ExchangeAwaitRateNameEnabler.Expression.In || original.expression == Gs2ExchangeAwaitRateNameEnabler.Expression.NotIn) {
