...
{
    [CustomEditor(typeof(Gs2ExchangeAwaitEnabler))]
    public class Gs2ExchangeAwaitEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeAwaitEnabler;
