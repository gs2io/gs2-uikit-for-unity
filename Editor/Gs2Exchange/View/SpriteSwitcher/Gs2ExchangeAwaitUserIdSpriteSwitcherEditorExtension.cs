...
{
    [CustomEditor(typeof(Gs2ExchangeAwaitUserIdSpriteSwitcher))]
    public class Gs2ExchangeAwaitUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeAwaitUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeAwaitUserIdSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeAwaitUserIdSpriteSwitcher.Expression.NotIn) {
