...
{
    [CustomEditor(typeof(Gs2ExchangeAwaitNameSpriteSwitcher))]
    public class Gs2ExchangeAwaitNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeAwaitNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeAwaitNameSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeAwaitNameSpriteSwitcher.Expression.NotIn) {
