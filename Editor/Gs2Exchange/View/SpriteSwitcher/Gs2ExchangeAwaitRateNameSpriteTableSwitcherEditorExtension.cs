...
{
    [CustomEditor(typeof(Gs2ExchangeAwaitRateNameSpriteTableSwitcher))]
    public class Gs2ExchangeAwaitRateNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeAwaitRateNameSpriteTableSwitcher;
