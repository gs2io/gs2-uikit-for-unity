...
{
    [CustomEditor(typeof(Gs2ExchangeAwaitNameSpriteTableSwitcher))]
    public class Gs2ExchangeAwaitNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeAwaitNameSpriteTableSwitcher;
