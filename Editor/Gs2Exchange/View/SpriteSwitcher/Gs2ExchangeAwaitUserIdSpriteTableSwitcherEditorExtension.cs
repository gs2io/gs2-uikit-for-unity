...
{
    [CustomEditor(typeof(Gs2ExchangeAwaitUserIdSpriteTableSwitcher))]
    public class Gs2ExchangeAwaitUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeAwaitUserIdSpriteTableSwitcher;
