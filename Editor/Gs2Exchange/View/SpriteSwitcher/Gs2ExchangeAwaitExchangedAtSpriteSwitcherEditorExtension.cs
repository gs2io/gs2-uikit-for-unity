...
{
    [CustomEditor(typeof(Gs2ExchangeAwaitExchangedAtSpriteSwitcher))]
    public class Gs2ExchangeAwaitExchangedAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeAwaitExchangedAtSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeAwaitExchangedAtSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeAwaitExchangedAtSpriteSwitcher.Expression.NotIn) {
