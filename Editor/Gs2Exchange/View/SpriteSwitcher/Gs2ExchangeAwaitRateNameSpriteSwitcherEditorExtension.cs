...
{
    [CustomEditor(typeof(Gs2ExchangeAwaitRateNameSpriteSwitcher))]
    public class Gs2ExchangeAwaitRateNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExchangeAwaitRateNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ExchangeAwaitRateNameSpriteSwitcher.Expression.In || original.expression == Gs2ExchangeAwaitRateNameSpriteSwitcher.Expression.NotIn) {
