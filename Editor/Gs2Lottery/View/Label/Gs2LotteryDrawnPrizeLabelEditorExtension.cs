...
{
    [CustomEditor(typeof(Gs2LotteryDrawnPrizeLabel))]
    public class Gs2LotteryDrawnPrizeLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryDrawnPrizeLabel;
