...
{
    [CustomEditor(typeof(Gs2LotteryBoxItemsEnabler))]
    public class Gs2LotteryBoxItemsEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryBoxItemsEnabler;
