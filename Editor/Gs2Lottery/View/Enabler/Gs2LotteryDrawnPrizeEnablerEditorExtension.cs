...
{
    [CustomEditor(typeof(Gs2LotteryDrawnPrizeEnabler))]
    public class Gs2LotteryDrawnPrizeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryDrawnPrizeEnabler;
