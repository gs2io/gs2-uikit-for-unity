...
{
    [CustomEditor(typeof(Gs2LotteryBoxItemsPrizeTableNameSpriteSwitcher))]
    public class Gs2LotteryBoxItemsPrizeTableNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryBoxItemsPrizeTableNameSpriteSwitcher;
            ...
            if (original.expression == Gs2LotteryBoxItemsPrizeTableNameSpriteSwitcher.Expression.In || original.expression == Gs2LotteryBoxItemsPrizeTableNameSpriteSwitcher.Expression.NotIn) {
