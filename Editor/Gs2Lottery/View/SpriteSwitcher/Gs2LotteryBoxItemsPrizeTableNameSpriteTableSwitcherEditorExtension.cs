...
{
    [CustomEditor(typeof(Gs2LotteryBoxItemsPrizeTableNameSpriteTableSwitcher))]
    public class Gs2LotteryBoxItemsPrizeTableNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryBoxItemsPrizeTableNameSpriteTableSwitcher;
