...
{
    [CustomEditor(typeof(Gs2LotteryOwnBoxItemListFetcher))]
    public class Gs2LotteryOwnBoxItemListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LotteryOwnBoxItemListFetcher;
