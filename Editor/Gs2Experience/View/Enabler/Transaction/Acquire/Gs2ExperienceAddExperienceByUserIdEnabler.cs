...
namespace Gs2.Unity.UiKit.Gs2Experience.Editor
{
    ...
    public class Gs2ExperienceAddExperienceByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            ...
            if (original.expression == Gs2ExperienceAddExperienceByUserIdEnabler.Expression.In || original.expression == Gs2ExperienceAddExperienceByUserIdEnabler.Expression.NotIn) {
