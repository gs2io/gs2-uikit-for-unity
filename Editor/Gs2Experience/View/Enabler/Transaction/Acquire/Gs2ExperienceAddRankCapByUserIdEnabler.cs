...
namespace Gs2.Unity.UiKit.Gs2Experience.Enabler.Editor
{
    ...
    public class Gs2ExperienceAddRankCapByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            ...
            if (original.expression == Gs2ExperienceAddRankCapByUserIdEnabler.Expression.In || original.expression == Gs2ExperienceAddRankCapByUserIdEnabler.Expression.NotIn) {
