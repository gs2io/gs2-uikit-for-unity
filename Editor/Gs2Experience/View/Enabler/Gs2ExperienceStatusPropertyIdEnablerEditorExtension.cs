...
{
    [CustomEditor(typeof(Gs2ExperienceStatusPropertyIdEnabler))]
    public class Gs2ExperienceStatusPropertyIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceStatusPropertyIdEnabler;
            ...
            if (original.expression == Gs2ExperienceStatusPropertyIdEnabler.Expression.In || original.expression == Gs2ExperienceStatusPropertyIdEnabler.Expression.NotIn) {
