...
{
    [CustomEditor(typeof(Gs2ExperienceStatusNextRankUpExperienceValueEnabler))]
    public class Gs2ExperienceStatusNextRankUpExperienceValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceStatusNextRankUpExperienceValueEnabler;
            ...
            if (original.expression == Gs2ExperienceStatusNextRankUpExperienceValueEnabler.Expression.In || original.expression == Gs2ExperienceStatusNextRankUpExperienceValueEnabler.Expression.NotIn) {
