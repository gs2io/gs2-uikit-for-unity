...
{
    [CustomEditor(typeof(Gs2ExperienceStatusEnabler))]
    public class Gs2ExperienceStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceStatusEnabler;
