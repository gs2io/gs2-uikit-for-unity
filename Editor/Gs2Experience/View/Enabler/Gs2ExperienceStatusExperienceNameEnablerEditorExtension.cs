...
{
    [CustomEditor(typeof(Gs2ExperienceStatusExperienceNameEnabler))]
    public class Gs2ExperienceStatusExperienceNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceStatusExperienceNameEnabler;
            ...
            if (original.expression == Gs2ExperienceStatusExperienceNameEnabler.Expression.In || original.expression == Gs2ExperienceStatusExperienceNameEnabler.Expression.NotIn) {
