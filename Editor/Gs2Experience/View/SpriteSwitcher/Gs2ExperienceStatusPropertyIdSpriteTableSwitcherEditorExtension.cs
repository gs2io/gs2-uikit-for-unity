...
{
    [CustomEditor(typeof(Gs2ExperienceStatusPropertyIdSpriteTableSwitcher))]
    public class Gs2ExperienceStatusPropertyIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceStatusPropertyIdSpriteTableSwitcher;
