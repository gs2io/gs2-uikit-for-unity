...
{
    [CustomEditor(typeof(Gs2ExperienceStatusExperienceValueSpriteSwitcher))]
    public class Gs2ExperienceStatusExperienceValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceStatusExperienceValueSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceStatusExperienceValueSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceStatusExperienceValueSpriteSwitcher.Expression.NotIn) {
