...
{
    [CustomEditor(typeof(Gs2ExperienceStatusPropertyIdSpriteSwitcher))]
    public class Gs2ExperienceStatusPropertyIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceStatusPropertyIdSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceStatusPropertyIdSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceStatusPropertyIdSpriteSwitcher.Expression.NotIn) {
