...
{
    [CustomEditor(typeof(Gs2ExperienceStatusExperienceNameSpriteSwitcher))]
    public class Gs2ExperienceStatusExperienceNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceStatusExperienceNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceStatusExperienceNameSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceStatusExperienceNameSpriteSwitcher.Expression.NotIn) {
