...
{
    [CustomEditor(typeof(Gs2ExperienceStatusRankValueSpriteSwitcher))]
    public class Gs2ExperienceStatusRankValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceStatusRankValueSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceStatusRankValueSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceStatusRankValueSpriteSwitcher.Expression.NotIn) {
