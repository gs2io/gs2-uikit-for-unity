...
{
    [CustomEditor(typeof(Gs2ExperienceStatusExperienceNameSpriteTableSwitcher))]
    public class Gs2ExperienceStatusExperienceNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceStatusExperienceNameSpriteTableSwitcher;
