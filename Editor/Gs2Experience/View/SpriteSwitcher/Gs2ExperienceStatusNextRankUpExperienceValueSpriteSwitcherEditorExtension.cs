...
{
    [CustomEditor(typeof(Gs2ExperienceStatusNextRankUpExperienceValueSpriteSwitcher))]
    public class Gs2ExperienceStatusNextRankUpExperienceValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceStatusNextRankUpExperienceValueSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceStatusNextRankUpExperienceValueSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceStatusNextRankUpExperienceValueSpriteSwitcher.Expression.NotIn) {
