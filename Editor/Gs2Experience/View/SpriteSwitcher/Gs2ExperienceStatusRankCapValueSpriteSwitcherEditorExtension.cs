...
{
    [CustomEditor(typeof(Gs2ExperienceStatusRankCapValueSpriteSwitcher))]
    public class Gs2ExperienceStatusRankCapValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceStatusRankCapValueSpriteSwitcher;
            ...
            if (original.expression == Gs2ExperienceStatusRankCapValueSpriteSwitcher.Expression.In || original.expression == Gs2ExperienceStatusRankCapValueSpriteSwitcher.Expression.NotIn) {
