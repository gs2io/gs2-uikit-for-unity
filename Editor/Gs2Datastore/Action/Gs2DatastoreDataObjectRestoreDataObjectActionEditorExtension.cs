...
namespace Gs2.Unity.UiKit.Gs2Datastore.Editor
{
    ...
    public class Gs2DatastoreDataObjectRestoreDataObjectActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            ...
            var context = original.GetComponent<Gs2DatastoreDataObjectContext>() ?? original.GetComponentInParent<Gs2DatastoreDataObjectContext>();
            if (context == null) {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("DataObjectId"), true);
            EditorGUILayout.PropertyField(serializedObject.FindProperty("onChangeDataObjectId"), true);
            EditorGUILayout.PropertyField(serializedObject.FindProperty("onRestoreDataObjectComplete"), true);
