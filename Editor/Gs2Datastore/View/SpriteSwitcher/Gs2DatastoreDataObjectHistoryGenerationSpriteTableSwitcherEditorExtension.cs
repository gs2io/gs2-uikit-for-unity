...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectHistoryGenerationSpriteTableSwitcher))]
    public class Gs2DatastoreDataObjectHistoryGenerationSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectHistoryGenerationSpriteTableSwitcher;
