...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectHistoryGenerationSpriteSwitcher))]
    public class Gs2DatastoreDataObjectHistoryGenerationSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectHistoryGenerationSpriteSwitcher;
            ...
            if (original.expression == Gs2DatastoreDataObjectHistoryGenerationSpriteSwitcher.Expression.In || original.expression == Gs2DatastoreDataObjectHistoryGenerationSpriteSwitcher.Expression.NotIn) {
