...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectHistoryContentLengthSpriteSwitcher))]
    public class Gs2DatastoreDataObjectHistoryContentLengthSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectHistoryContentLengthSpriteSwitcher;
            ...
            if (original.expression == Gs2DatastoreDataObjectHistoryContentLengthSpriteSwitcher.Expression.In || original.expression == Gs2DatastoreDataObjectHistoryContentLengthSpriteSwitcher.Expression.NotIn) {
