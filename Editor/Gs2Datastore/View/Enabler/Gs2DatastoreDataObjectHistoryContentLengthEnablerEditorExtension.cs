...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectHistoryContentLengthEnabler))]
    public class Gs2DatastoreDataObjectHistoryContentLengthEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectHistoryContentLengthEnabler;
            ...
            if (original.expression == Gs2DatastoreDataObjectHistoryContentLengthEnabler.Expression.In || original.expression == Gs2DatastoreDataObjectHistoryContentLengthEnabler.Expression.NotIn) {
