...
{
    [CustomEditor(typeof(Gs2DatastoreDataObjectHistoryEnabler))]
    public class Gs2DatastoreDataObjectHistoryEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DatastoreDataObjectHistoryEnabler;
