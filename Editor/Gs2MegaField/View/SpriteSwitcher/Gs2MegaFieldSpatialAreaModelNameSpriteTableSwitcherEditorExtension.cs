...
{
    [CustomEditor(typeof(Gs2MegaFieldSpatialAreaModelNameSpriteTableSwitcher))]
    public class Gs2MegaFieldSpatialAreaModelNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldSpatialAreaModelNameSpriteTableSwitcher;
