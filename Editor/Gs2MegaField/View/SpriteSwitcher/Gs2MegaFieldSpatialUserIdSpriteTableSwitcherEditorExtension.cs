...
{
    [CustomEditor(typeof(Gs2MegaFieldSpatialUserIdSpriteTableSwitcher))]
    public class Gs2MegaFieldSpatialUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldSpatialUserIdSpriteTableSwitcher;
