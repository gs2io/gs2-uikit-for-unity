...
{
    [CustomEditor(typeof(Gs2MegaFieldSpatialLayerModelNameSpriteTableSwitcher))]
    public class Gs2MegaFieldSpatialLayerModelNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldSpatialLayerModelNameSpriteTableSwitcher;
