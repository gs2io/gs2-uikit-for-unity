...
{
    [CustomEditor(typeof(Gs2MegaFieldSpatialUserIdSpriteSwitcher))]
    public class Gs2MegaFieldSpatialUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldSpatialUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2MegaFieldSpatialUserIdSpriteSwitcher.Expression.In || original.expression == Gs2MegaFieldSpatialUserIdSpriteSwitcher.Expression.NotIn) {
