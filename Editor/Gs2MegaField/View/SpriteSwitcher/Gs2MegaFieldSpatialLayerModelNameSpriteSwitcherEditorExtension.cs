...
{
    [CustomEditor(typeof(Gs2MegaFieldSpatialLayerModelNameSpriteSwitcher))]
    public class Gs2MegaFieldSpatialLayerModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldSpatialLayerModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MegaFieldSpatialLayerModelNameSpriteSwitcher.Expression.In || original.expression == Gs2MegaFieldSpatialLayerModelNameSpriteSwitcher.Expression.NotIn) {
