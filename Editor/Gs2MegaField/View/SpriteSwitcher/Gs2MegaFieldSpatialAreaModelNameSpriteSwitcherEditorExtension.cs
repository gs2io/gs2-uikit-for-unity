...
{
    [CustomEditor(typeof(Gs2MegaFieldSpatialAreaModelNameSpriteSwitcher))]
    public class Gs2MegaFieldSpatialAreaModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldSpatialAreaModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2MegaFieldSpatialAreaModelNameSpriteSwitcher.Expression.In || original.expression == Gs2MegaFieldSpatialAreaModelNameSpriteSwitcher.Expression.NotIn) {
