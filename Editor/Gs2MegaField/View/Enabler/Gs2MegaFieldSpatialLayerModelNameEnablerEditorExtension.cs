...
{
    [CustomEditor(typeof(Gs2MegaFieldSpatialLayerModelNameEnabler))]
    public class Gs2MegaFieldSpatialLayerModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2MegaFieldSpatialLayerModelNameEnabler;
            ...
            if (original.expression == Gs2MegaFieldSpatialLayerModelNameEnabler.Expression.In || original.expression == Gs2MegaFieldSpatialLayerModelNameEnabler.Expression.NotIn) {
