...
{
    [CustomEditor(typeof(Gs2ScheduleEventListFetcher))]
    public class Gs2ScheduleEventListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventListFetcher;
