...
{
    [CustomEditor(typeof(Gs2ScheduleEventMetadataEnabler))]
    public class Gs2ScheduleEventMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventMetadataEnabler;
            ...
            if (original.expression == Gs2ScheduleEventMetadataEnabler.Expression.In || original.expression == Gs2ScheduleEventMetadataEnabler.Expression.NotIn) {
