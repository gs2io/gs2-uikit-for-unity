...
{
    [CustomEditor(typeof(Gs2ScheduleEventEnabler))]
    public class Gs2ScheduleEventEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventEnabler;
