...
{
    [CustomEditor(typeof(Gs2ScheduleEventNameEnabler))]
    public class Gs2ScheduleEventNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventNameEnabler;
            ...
            if (original.expression == Gs2ScheduleEventNameEnabler.Expression.In || original.expression == Gs2ScheduleEventNameEnabler.Expression.NotIn) {
