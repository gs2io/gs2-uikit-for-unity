...
{
    [CustomEditor(typeof(Gs2ScheduleOwnTriggerTriggeredAtEnabler))]
    public class Gs2ScheduleOwnTriggerTriggeredAtEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnTriggerTriggeredAtEnabler;
            ...
            if (original.expression == Gs2ScheduleOwnTriggerTriggeredAtEnabler.Expression.In || original.expression == Gs2ScheduleOwnTriggerTriggeredAtEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTriggeredAts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableTriggeredAt"), true);
            }
