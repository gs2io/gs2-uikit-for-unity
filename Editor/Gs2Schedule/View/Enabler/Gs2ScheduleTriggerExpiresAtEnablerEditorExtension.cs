...
{
    [CustomEditor(typeof(Gs2ScheduleTriggerExpiresAtEnabler))]
    public class Gs2ScheduleTriggerExpiresAtEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleTriggerExpiresAtEnabler;
            ...
            if (original.expression == Gs2ScheduleTriggerExpiresAtEnabler.Expression.In || original.expression == Gs2ScheduleTriggerExpiresAtEnabler.Expression.NotIn) {
