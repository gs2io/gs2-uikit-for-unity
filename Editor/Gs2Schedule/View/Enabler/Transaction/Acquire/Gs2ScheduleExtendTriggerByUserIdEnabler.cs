...
{
    [CustomEditor(typeof(Gs2ScheduleExtendTriggerByUserIdEnabler))]
    public class Gs2ScheduleExtendTriggerByUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleExtendTriggerByUserIdEnabler;
