...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatBeginHourEnabler))]
    public class Gs2ScheduleEventRepeatBeginHourEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatBeginHourEnabler;
            ...
            if (original.expression == Gs2ScheduleEventRepeatBeginHourEnabler.Expression.In || original.expression == Gs2ScheduleEventRepeatBeginHourEnabler.Expression.NotIn) {
