...
{
    [CustomEditor(typeof(Gs2ScheduleEventScheduleTypeEnabler))]
    public class Gs2ScheduleEventScheduleTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventScheduleTypeEnabler;
            ...
            if (original.expression == Gs2ScheduleEventScheduleTypeEnabler.Expression.In || original.expression == Gs2ScheduleEventScheduleTypeEnabler.Expression.NotIn) {
