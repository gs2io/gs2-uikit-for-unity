...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatEndHourEnabler))]
    public class Gs2ScheduleEventRepeatEndHourEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatEndHourEnabler;
            ...
            if (original.expression == Gs2ScheduleEventRepeatEndHourEnabler.Expression.In || original.expression == Gs2ScheduleEventRepeatEndHourEnabler.Expression.NotIn) {
