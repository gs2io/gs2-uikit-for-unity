...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatEndDayOfMonthEnabler))]
    public class Gs2ScheduleEventRepeatEndDayOfMonthEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatEndDayOfMonthEnabler;
            ...
            if (original.expression == Gs2ScheduleEventRepeatEndDayOfMonthEnabler.Expression.In || original.expression == Gs2ScheduleEventRepeatEndDayOfMonthEnabler.Expression.NotIn) {
