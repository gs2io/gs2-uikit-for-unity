...
{
    [CustomEditor(typeof(Gs2ScheduleEventAbsoluteBeginEnabler))]
    public class Gs2ScheduleEventAbsoluteBeginEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventAbsoluteBeginEnabler;
            ...
            if (original.expression == Gs2ScheduleEventAbsoluteBeginEnabler.Expression.In || original.expression == Gs2ScheduleEventAbsoluteBeginEnabler.Expression.NotIn) {
