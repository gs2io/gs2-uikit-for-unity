...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatTypeEnabler))]
    public class Gs2ScheduleEventRepeatTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatTypeEnabler;
            ...
            if (original.expression == Gs2ScheduleEventRepeatTypeEnabler.Expression.In || original.expression == Gs2ScheduleEventRepeatTypeEnabler.Expression.NotIn) {
