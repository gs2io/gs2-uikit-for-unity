...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatBeginDayOfWeekSpriteSwitcher))]
    public class Gs2ScheduleEventRepeatBeginDayOfWeekSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatBeginDayOfWeekSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleEventRepeatBeginDayOfWeekSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleEventRepeatBeginDayOfWeekSpriteSwitcher.Expression.NotIn) {
