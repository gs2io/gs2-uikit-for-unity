...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatEndDayOfWeekSpriteSwitcher))]
    public class Gs2ScheduleEventRepeatEndDayOfWeekSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatEndDayOfWeekSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleEventRepeatEndDayOfWeekSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleEventRepeatEndDayOfWeekSpriteSwitcher.Expression.NotIn) {
