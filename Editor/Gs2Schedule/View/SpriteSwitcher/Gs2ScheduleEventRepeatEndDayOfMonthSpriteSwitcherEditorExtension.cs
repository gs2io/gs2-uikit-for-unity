...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatEndDayOfMonthSpriteSwitcher))]
    public class Gs2ScheduleEventRepeatEndDayOfMonthSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatEndDayOfMonthSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleEventRepeatEndDayOfMonthSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleEventRepeatEndDayOfMonthSpriteSwitcher.Expression.NotIn) {
