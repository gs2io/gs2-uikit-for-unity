...
{
    [CustomEditor(typeof(Gs2ScheduleEventAbsoluteEndSpriteSwitcher))]
    public class Gs2ScheduleEventAbsoluteEndSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventAbsoluteEndSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleEventAbsoluteEndSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleEventAbsoluteEndSpriteSwitcher.Expression.NotIn) {
