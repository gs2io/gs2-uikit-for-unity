...
{
    [CustomEditor(typeof(Gs2ScheduleEventAbsoluteBeginSpriteSwitcher))]
    public class Gs2ScheduleEventAbsoluteBeginSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventAbsoluteBeginSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleEventAbsoluteBeginSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleEventAbsoluteBeginSpriteSwitcher.Expression.NotIn) {
