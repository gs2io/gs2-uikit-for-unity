...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatBeginDayOfWeekSpriteTableSwitcher))]
    public class Gs2ScheduleEventRepeatBeginDayOfWeekSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatBeginDayOfWeekSpriteTableSwitcher;
