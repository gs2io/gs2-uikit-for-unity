...
{
    [CustomEditor(typeof(Gs2ScheduleTriggerExpiresAtSpriteSwitcher))]
    public class Gs2ScheduleTriggerExpiresAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleTriggerExpiresAtSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleTriggerExpiresAtSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleTriggerExpiresAtSpriteSwitcher.Expression.NotIn) {
