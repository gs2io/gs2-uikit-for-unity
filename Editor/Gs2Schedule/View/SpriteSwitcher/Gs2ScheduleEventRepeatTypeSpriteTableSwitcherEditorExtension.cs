...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatTypeSpriteTableSwitcher))]
    public class Gs2ScheduleEventRepeatTypeSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatTypeSpriteTableSwitcher;
