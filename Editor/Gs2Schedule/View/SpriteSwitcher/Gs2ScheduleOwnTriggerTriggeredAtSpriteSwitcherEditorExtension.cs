...
{
    [CustomEditor(typeof(Gs2ScheduleOwnTriggerTriggeredAtSpriteSwitcher))]
    public class Gs2ScheduleOwnTriggerTriggeredAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleOwnTriggerTriggeredAtSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleOwnTriggerTriggeredAtSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleOwnTriggerTriggeredAtSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTriggeredAts"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyTriggeredAt"), true);
            }
