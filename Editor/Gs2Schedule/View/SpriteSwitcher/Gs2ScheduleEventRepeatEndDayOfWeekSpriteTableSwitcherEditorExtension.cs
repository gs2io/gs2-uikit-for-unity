...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatEndDayOfWeekSpriteTableSwitcher))]
    public class Gs2ScheduleEventRepeatEndDayOfWeekSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatEndDayOfWeekSpriteTableSwitcher;
