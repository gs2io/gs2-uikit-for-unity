...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatTypeSpriteSwitcher))]
    public class Gs2ScheduleEventRepeatTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleEventRepeatTypeSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleEventRepeatTypeSpriteSwitcher.Expression.NotIn) {
