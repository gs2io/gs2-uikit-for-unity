...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatBeginHourSpriteSwitcher))]
    public class Gs2ScheduleEventRepeatBeginHourSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatBeginHourSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleEventRepeatBeginHourSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleEventRepeatBeginHourSpriteSwitcher.Expression.NotIn) {
