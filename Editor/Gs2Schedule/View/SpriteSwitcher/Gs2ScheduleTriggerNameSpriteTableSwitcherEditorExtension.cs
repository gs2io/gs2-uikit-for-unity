...
{
    [CustomEditor(typeof(Gs2ScheduleTriggerNameSpriteTableSwitcher))]
    public class Gs2ScheduleTriggerNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleTriggerNameSpriteTableSwitcher;
