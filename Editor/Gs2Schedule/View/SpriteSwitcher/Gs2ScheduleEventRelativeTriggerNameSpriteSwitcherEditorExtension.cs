...
{
    [CustomEditor(typeof(Gs2ScheduleEventRelativeTriggerNameSpriteSwitcher))]
    public class Gs2ScheduleEventRelativeTriggerNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRelativeTriggerNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleEventRelativeTriggerNameSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleEventRelativeTriggerNameSpriteSwitcher.Expression.NotIn) {
