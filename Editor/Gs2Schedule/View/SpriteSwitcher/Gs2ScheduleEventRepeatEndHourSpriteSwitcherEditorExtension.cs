...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatEndHourSpriteSwitcher))]
    public class Gs2ScheduleEventRepeatEndHourSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatEndHourSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleEventRepeatEndHourSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleEventRepeatEndHourSpriteSwitcher.Expression.NotIn) {
