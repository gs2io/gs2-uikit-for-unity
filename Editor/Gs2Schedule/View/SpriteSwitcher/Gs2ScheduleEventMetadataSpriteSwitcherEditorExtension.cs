...
{
    [CustomEditor(typeof(Gs2ScheduleEventMetadataSpriteSwitcher))]
    public class Gs2ScheduleEventMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleEventMetadataSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleEventMetadataSpriteSwitcher.Expression.NotIn) {
