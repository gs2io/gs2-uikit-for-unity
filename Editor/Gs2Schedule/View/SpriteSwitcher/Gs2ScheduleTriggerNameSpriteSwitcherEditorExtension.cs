...
{
    [CustomEditor(typeof(Gs2ScheduleTriggerNameSpriteSwitcher))]
    public class Gs2ScheduleTriggerNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleTriggerNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleTriggerNameSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleTriggerNameSpriteSwitcher.Expression.NotIn) {
