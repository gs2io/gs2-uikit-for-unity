...
{
    [CustomEditor(typeof(Gs2ScheduleEventMetadataSpriteTableSwitcher))]
    public class Gs2ScheduleEventMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventMetadataSpriteTableSwitcher;
