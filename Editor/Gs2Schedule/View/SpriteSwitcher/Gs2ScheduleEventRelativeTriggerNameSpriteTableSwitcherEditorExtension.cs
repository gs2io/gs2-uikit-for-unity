...
{
    [CustomEditor(typeof(Gs2ScheduleEventRelativeTriggerNameSpriteTableSwitcher))]
    public class Gs2ScheduleEventRelativeTriggerNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRelativeTriggerNameSpriteTableSwitcher;
