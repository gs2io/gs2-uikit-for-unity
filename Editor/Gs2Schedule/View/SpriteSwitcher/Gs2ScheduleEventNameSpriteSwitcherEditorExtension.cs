...
{
    [CustomEditor(typeof(Gs2ScheduleEventNameSpriteSwitcher))]
    public class Gs2ScheduleEventNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleEventNameSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleEventNameSpriteSwitcher.Expression.NotIn) {
