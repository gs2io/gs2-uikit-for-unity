...
{
    [CustomEditor(typeof(Gs2ScheduleEventRepeatBeginDayOfMonthSpriteSwitcher))]
    public class Gs2ScheduleEventRepeatBeginDayOfMonthSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventRepeatBeginDayOfMonthSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleEventRepeatBeginDayOfMonthSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleEventRepeatBeginDayOfMonthSpriteSwitcher.Expression.NotIn) {
