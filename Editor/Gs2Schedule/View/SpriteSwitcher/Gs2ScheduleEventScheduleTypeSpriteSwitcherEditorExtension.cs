...
{
    [CustomEditor(typeof(Gs2ScheduleEventScheduleTypeSpriteSwitcher))]
    public class Gs2ScheduleEventScheduleTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventScheduleTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2ScheduleEventScheduleTypeSpriteSwitcher.Expression.In || original.expression == Gs2ScheduleEventScheduleTypeSpriteSwitcher.Expression.NotIn) {
