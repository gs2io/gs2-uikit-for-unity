...
{
    [CustomEditor(typeof(Gs2ScheduleEventScheduleTypeSpriteTableSwitcher))]
    public class Gs2ScheduleEventScheduleTypeSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ScheduleEventScheduleTypeSpriteTableSwitcher;
