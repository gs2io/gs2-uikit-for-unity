...
{
    [CustomEditor(typeof(Gs2ChatCategoryModelListFetcher))]
    public class Gs2ChatCategoryModelListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatCategoryModelListFetcher;
