...
{
    [CustomEditor(typeof(Gs2ChatSubscribeUserIdSpriteSwitcher))]
    public class Gs2ChatSubscribeUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatSubscribeUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2ChatSubscribeUserIdSpriteSwitcher.Expression.In || original.expression == Gs2ChatSubscribeUserIdSpriteSwitcher.Expression.NotIn) {
