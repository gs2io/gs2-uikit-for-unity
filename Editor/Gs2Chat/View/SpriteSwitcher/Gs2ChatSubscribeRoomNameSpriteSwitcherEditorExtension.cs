...
{
    [CustomEditor(typeof(Gs2ChatSubscribeRoomNameSpriteSwitcher))]
    public class Gs2ChatSubscribeRoomNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatSubscribeRoomNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ChatSubscribeRoomNameSpriteSwitcher.Expression.In || original.expression == Gs2ChatSubscribeRoomNameSpriteSwitcher.Expression.NotIn) {
