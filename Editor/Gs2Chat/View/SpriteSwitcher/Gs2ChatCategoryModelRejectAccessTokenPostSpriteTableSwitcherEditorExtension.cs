...
{
    [CustomEditor(typeof(Gs2ChatCategoryModelRejectAccessTokenPostSpriteTableSwitcher))]
    public class Gs2ChatCategoryModelRejectAccessTokenPostSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatCategoryModelRejectAccessTokenPostSpriteTableSwitcher;
