...
{
    [CustomEditor(typeof(Gs2ChatSubscribeRoomNameSpriteTableSwitcher))]
    public class Gs2ChatSubscribeRoomNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatSubscribeRoomNameSpriteTableSwitcher;
