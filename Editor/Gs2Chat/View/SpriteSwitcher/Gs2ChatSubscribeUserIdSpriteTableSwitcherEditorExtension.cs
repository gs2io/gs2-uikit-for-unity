...
{
    [CustomEditor(typeof(Gs2ChatSubscribeUserIdSpriteTableSwitcher))]
    public class Gs2ChatSubscribeUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatSubscribeUserIdSpriteTableSwitcher;
