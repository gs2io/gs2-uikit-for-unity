...
{
    [CustomEditor(typeof(Gs2ChatCategoryModelEnabler))]
    public class Gs2ChatCategoryModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatCategoryModelEnabler;
