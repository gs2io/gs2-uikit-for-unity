...
{
    [CustomEditor(typeof(Gs2ChatSubscribeEnabler))]
    public class Gs2ChatSubscribeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ChatSubscribeEnabler;
