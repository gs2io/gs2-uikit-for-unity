...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterStatusEnabler))]
    public class Gs2EnchantBalanceParameterStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterStatusEnabler;
