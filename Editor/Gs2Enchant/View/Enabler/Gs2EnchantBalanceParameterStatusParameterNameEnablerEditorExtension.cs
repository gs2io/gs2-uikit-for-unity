...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterStatusParameterNameEnabler))]
    public class Gs2EnchantBalanceParameterStatusParameterNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterStatusParameterNameEnabler;
            ...
            if (original.expression == Gs2EnchantBalanceParameterStatusParameterNameEnabler.Expression.In || original.expression == Gs2EnchantBalanceParameterStatusParameterNameEnabler.Expression.NotIn) {
