...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterStatusPropertyIdEnabler))]
    public class Gs2EnchantBalanceParameterStatusPropertyIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterStatusPropertyIdEnabler;
            ...
            if (original.expression == Gs2EnchantBalanceParameterStatusPropertyIdEnabler.Expression.In || original.expression == Gs2EnchantBalanceParameterStatusPropertyIdEnabler.Expression.NotIn) {
