...
{
    [CustomEditor(typeof(Gs2EnchantRarityParameterStatusParameterNameEnabler))]
    public class Gs2EnchantRarityParameterStatusParameterNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantRarityParameterStatusParameterNameEnabler;
            ...
            if (original.expression == Gs2EnchantRarityParameterStatusParameterNameEnabler.Expression.In || original.expression == Gs2EnchantRarityParameterStatusParameterNameEnabler.Expression.NotIn) {
