...
{
    [CustomEditor(typeof(Gs2EnchantRarityParameterStatusPropertyIdEnabler))]
    public class Gs2EnchantRarityParameterStatusPropertyIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantRarityParameterStatusPropertyIdEnabler;
            ...
            if (original.expression == Gs2EnchantRarityParameterStatusPropertyIdEnabler.Expression.In || original.expression == Gs2EnchantRarityParameterStatusPropertyIdEnabler.Expression.NotIn) {
