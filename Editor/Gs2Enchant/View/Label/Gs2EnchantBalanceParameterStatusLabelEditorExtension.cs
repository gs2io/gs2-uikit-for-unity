...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterStatusLabel))]
    public class Gs2EnchantBalanceParameterStatusLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterStatusLabel;
