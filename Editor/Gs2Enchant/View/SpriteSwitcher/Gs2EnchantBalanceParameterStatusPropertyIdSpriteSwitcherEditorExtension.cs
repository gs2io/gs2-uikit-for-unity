...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterStatusPropertyIdSpriteSwitcher))]
    public class Gs2EnchantBalanceParameterStatusPropertyIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterStatusPropertyIdSpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantBalanceParameterStatusPropertyIdSpriteSwitcher.Expression.In || original.expression == Gs2EnchantBalanceParameterStatusPropertyIdSpriteSwitcher.Expression.NotIn) {
