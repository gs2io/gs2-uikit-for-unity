...
{
    [CustomEditor(typeof(Gs2EnchantRarityParameterStatusParameterNameSpriteTableSwitcher))]
    public class Gs2EnchantRarityParameterStatusParameterNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantRarityParameterStatusParameterNameSpriteTableSwitcher;
