...
{
    [CustomEditor(typeof(Gs2EnchantRarityParameterStatusPropertyIdSpriteTableSwitcher))]
    public class Gs2EnchantRarityParameterStatusPropertyIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantRarityParameterStatusPropertyIdSpriteTableSwitcher;
