...
{
    [CustomEditor(typeof(Gs2EnchantRarityParameterStatusParameterNameSpriteSwitcher))]
    public class Gs2EnchantRarityParameterStatusParameterNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantRarityParameterStatusParameterNameSpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantRarityParameterStatusParameterNameSpriteSwitcher.Expression.In || original.expression == Gs2EnchantRarityParameterStatusParameterNameSpriteSwitcher.Expression.NotIn) {
