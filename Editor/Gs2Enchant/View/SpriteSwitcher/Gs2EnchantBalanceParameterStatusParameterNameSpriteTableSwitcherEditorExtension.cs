...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterStatusParameterNameSpriteTableSwitcher))]
    public class Gs2EnchantBalanceParameterStatusParameterNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterStatusParameterNameSpriteTableSwitcher;
