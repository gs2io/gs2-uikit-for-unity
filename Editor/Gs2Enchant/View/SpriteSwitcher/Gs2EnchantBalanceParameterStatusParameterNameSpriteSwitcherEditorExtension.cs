...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterStatusParameterNameSpriteSwitcher))]
    public class Gs2EnchantBalanceParameterStatusParameterNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterStatusParameterNameSpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantBalanceParameterStatusParameterNameSpriteSwitcher.Expression.In || original.expression == Gs2EnchantBalanceParameterStatusParameterNameSpriteSwitcher.Expression.NotIn) {
