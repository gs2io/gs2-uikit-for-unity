...
{
    [CustomEditor(typeof(Gs2EnchantBalanceParameterStatusPropertyIdSpriteTableSwitcher))]
    public class Gs2EnchantBalanceParameterStatusPropertyIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantBalanceParameterStatusPropertyIdSpriteTableSwitcher;
