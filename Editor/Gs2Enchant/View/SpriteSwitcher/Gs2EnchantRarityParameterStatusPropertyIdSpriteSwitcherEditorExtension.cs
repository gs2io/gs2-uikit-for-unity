...
{
    [CustomEditor(typeof(Gs2EnchantRarityParameterStatusPropertyIdSpriteSwitcher))]
    public class Gs2EnchantRarityParameterStatusPropertyIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnchantRarityParameterStatusPropertyIdSpriteSwitcher;
            ...
            if (original.expression == Gs2EnchantRarityParameterStatusPropertyIdSpriteSwitcher.Expression.In || original.expression == Gs2EnchantRarityParameterStatusPropertyIdSpriteSwitcher.Expression.NotIn) {
