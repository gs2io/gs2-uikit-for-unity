...
{
    [CustomEditor(typeof(Gs2DictionaryLikeDeleteLikesAction))]
    public class Gs2DictionaryLikeDeleteLikesActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryLikeDeleteLikesAction;
            ...
            if (context == null) {
                ...
                if (context.transform.GetComponentInParent<Gs2DictionaryOwnLikeList>(true) != null) {
                    EditorGUI.BeginDisabledGroup(true);
                    EditorGUILayout.ObjectField("Context", context.gameObject, typeof(Gs2DictionaryOwnLikeContext), false);
                    EditorGUI.EndDisabledGroup();
                    EditorGUILayout.HelpBox("Like is auto assign from Gs2DictionaryLikeList.", MessageType.Info);
                }
                else {
                    EditorGUI.BeginDisabledGroup(true);
                    EditorGUILayout.ObjectField("Context", context.gameObject, typeof(Gs2DictionaryOwnLikeContext), false);
                    EditorGUI.indentLevel++;
                    context.Like = EditorGUILayout.ObjectField("OwnLike", context.Like, typeof(OwnLike), false) as OwnLike;
