...
{
    [CustomEditor(typeof(Gs2DictionaryOwnLikeUserIdEnabler))]
    public class Gs2DictionaryOwnLikeUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnLikeUserIdEnabler;
            ...
            if (original.expression == Gs2DictionaryOwnLikeUserIdEnabler.Expression.In || original.expression == Gs2DictionaryOwnLikeUserIdEnabler.Expression.NotIn) {
