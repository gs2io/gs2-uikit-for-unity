...
{
    [CustomEditor(typeof(Gs2DictionaryEntryUserIdEnabler))]
    public class Gs2DictionaryEntryUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryEntryUserIdEnabler;
            ...
            if (original.expression == Gs2DictionaryEntryUserIdEnabler.Expression.In || original.expression == Gs2DictionaryEntryUserIdEnabler.Expression.NotIn) {
