...
{
    [CustomEditor(typeof(Gs2DictionaryOwnLikeEnabler))]
    public class Gs2DictionaryOwnLikeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnLikeEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("LikeFetcher not assigned.", MessageType.Error);
