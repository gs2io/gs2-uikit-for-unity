...
{
    [CustomEditor(typeof(Gs2DictionaryOwnLikeNameEnabler))]
    public class Gs2DictionaryOwnLikeNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnLikeNameEnabler;
            ...
            if (original.expression == Gs2DictionaryOwnLikeNameEnabler.Expression.In || original.expression == Gs2DictionaryOwnLikeNameEnabler.Expression.NotIn) {
