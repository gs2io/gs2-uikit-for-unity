...
{
    [CustomEditor(typeof(Gs2DictionaryEntryEnabler))]
    public class Gs2DictionaryEntryEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryEntryEnabler;
