...
{
    [CustomEditor(typeof(Gs2DictionaryEntryNameSpriteTableSwitcher))]
    public class Gs2DictionaryEntryNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryEntryNameSpriteTableSwitcher;
