...
{
    [CustomEditor(typeof(Gs2DictionaryEntryUserIdSpriteSwitcher))]
    public class Gs2DictionaryEntryUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryEntryUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2DictionaryEntryUserIdSpriteSwitcher.Expression.In || original.expression == Gs2DictionaryEntryUserIdSpriteSwitcher.Expression.NotIn) {
