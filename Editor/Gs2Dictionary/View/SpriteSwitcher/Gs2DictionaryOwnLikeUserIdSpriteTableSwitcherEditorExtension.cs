...
{
    [CustomEditor(typeof(Gs2DictionaryOwnLikeUserIdSpriteTableSwitcher))]
    public class Gs2DictionaryOwnLikeUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnLikeUserIdSpriteTableSwitcher;
