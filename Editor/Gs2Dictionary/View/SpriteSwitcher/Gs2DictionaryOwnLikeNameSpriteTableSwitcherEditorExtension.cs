...
{
    [CustomEditor(typeof(Gs2DictionaryOwnLikeNameSpriteTableSwitcher))]
    public class Gs2DictionaryOwnLikeNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnLikeNameSpriteTableSwitcher;
