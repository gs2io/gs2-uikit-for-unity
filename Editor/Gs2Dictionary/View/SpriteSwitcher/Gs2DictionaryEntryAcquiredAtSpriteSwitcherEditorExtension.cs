...
{
    [CustomEditor(typeof(Gs2DictionaryEntryAcquiredAtSpriteSwitcher))]
    public class Gs2DictionaryEntryAcquiredAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryEntryAcquiredAtSpriteSwitcher;
            ...
            if (original.expression == Gs2DictionaryEntryAcquiredAtSpriteSwitcher.Expression.In || original.expression == Gs2DictionaryEntryAcquiredAtSpriteSwitcher.Expression.NotIn) {
