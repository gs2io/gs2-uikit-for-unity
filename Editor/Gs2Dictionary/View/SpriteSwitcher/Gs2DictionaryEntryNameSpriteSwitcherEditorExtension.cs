...
{
    [CustomEditor(typeof(Gs2DictionaryEntryNameSpriteSwitcher))]
    public class Gs2DictionaryEntryNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryEntryNameSpriteSwitcher;
            ...
            if (original.expression == Gs2DictionaryEntryNameSpriteSwitcher.Expression.In || original.expression == Gs2DictionaryEntryNameSpriteSwitcher.Expression.NotIn) {
