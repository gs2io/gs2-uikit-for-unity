...
{
    [CustomEditor(typeof(Gs2DictionaryOwnLikeNameSpriteSwitcher))]
    public class Gs2DictionaryOwnLikeNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnLikeNameSpriteSwitcher;
            ...
            if (original.expression == Gs2DictionaryOwnLikeNameSpriteSwitcher.Expression.In || original.expression == Gs2DictionaryOwnLikeNameSpriteSwitcher.Expression.NotIn) {
