...
{
    [CustomEditor(typeof(Gs2DictionaryOwnLikeUserIdSpriteSwitcher))]
    public class Gs2DictionaryOwnLikeUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryOwnLikeUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2DictionaryOwnLikeUserIdSpriteSwitcher.Expression.In || original.expression == Gs2DictionaryOwnLikeUserIdSpriteSwitcher.Expression.NotIn) {
