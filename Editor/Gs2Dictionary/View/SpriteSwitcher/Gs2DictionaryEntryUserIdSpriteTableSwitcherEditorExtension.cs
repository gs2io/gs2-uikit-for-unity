...
{
    [CustomEditor(typeof(Gs2DictionaryEntryUserIdSpriteTableSwitcher))]
    public class Gs2DictionaryEntryUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2DictionaryEntryUserIdSpriteTableSwitcher;
