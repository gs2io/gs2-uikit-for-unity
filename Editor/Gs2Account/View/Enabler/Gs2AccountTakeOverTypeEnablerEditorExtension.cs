...
{
    [CustomEditor(typeof(Gs2AccountTakeOverTypeEnabler))]
    public class Gs2AccountTakeOverTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountTakeOverTypeEnabler;
            ...
            if (original.expression == Gs2AccountTakeOverTypeEnabler.Expression.In || original.expression == Gs2AccountTakeOverTypeEnabler.Expression.NotIn) {
