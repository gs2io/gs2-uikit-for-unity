...
{
    [CustomEditor(typeof(Gs2AccountTakeOverUserIdentifierEnabler))]
    public class Gs2AccountTakeOverUserIdentifierEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountTakeOverUserIdentifierEnabler;
            ...
            if (original.expression == Gs2AccountTakeOverUserIdentifierEnabler.Expression.In || original.expression == Gs2AccountTakeOverUserIdentifierEnabler.Expression.NotIn) {
