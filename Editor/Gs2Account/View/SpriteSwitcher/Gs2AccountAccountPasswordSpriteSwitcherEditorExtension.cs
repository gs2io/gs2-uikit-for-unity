...
{
    [CustomEditor(typeof(Gs2AccountAccountPasswordSpriteSwitcher))]
    public class Gs2AccountAccountPasswordSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountAccountPasswordSpriteSwitcher;
            ...
            if (original.expression == Gs2AccountAccountPasswordSpriteSwitcher.Expression.In || original.expression == Gs2AccountAccountPasswordSpriteSwitcher.Expression.NotIn) {
