...
{
    [CustomEditor(typeof(Gs2AccountTakeOverUserIdSpriteSwitcher))]
    public class Gs2AccountTakeOverUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountTakeOverUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2AccountTakeOverUserIdSpriteSwitcher.Expression.In || original.expression == Gs2AccountTakeOverUserIdSpriteSwitcher.Expression.NotIn) {
