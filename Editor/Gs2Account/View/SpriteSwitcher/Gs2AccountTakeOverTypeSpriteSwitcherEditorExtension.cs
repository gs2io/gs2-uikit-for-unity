...
{
    [CustomEditor(typeof(Gs2AccountTakeOverTypeSpriteSwitcher))]
    public class Gs2AccountTakeOverTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountTakeOverTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2AccountTakeOverTypeSpriteSwitcher.Expression.In || original.expression == Gs2AccountTakeOverTypeSpriteSwitcher.Expression.NotIn) {
