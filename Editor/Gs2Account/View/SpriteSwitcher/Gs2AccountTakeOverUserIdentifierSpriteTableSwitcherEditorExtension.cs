...
{
    [CustomEditor(typeof(Gs2AccountTakeOverUserIdentifierSpriteTableSwitcher))]
    public class Gs2AccountTakeOverUserIdentifierSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountTakeOverUserIdentifierSpriteTableSwitcher;
