...
{
    [CustomEditor(typeof(Gs2AccountAccountUserIdSpriteSwitcher))]
    public class Gs2AccountAccountUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountAccountUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2AccountAccountUserIdSpriteSwitcher.Expression.In || original.expression == Gs2AccountAccountUserIdSpriteSwitcher.Expression.NotIn) {
