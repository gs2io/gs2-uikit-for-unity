...
{
    [CustomEditor(typeof(Gs2AccountAccountUserIdSpriteTableSwitcher))]
    public class Gs2AccountAccountUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountAccountUserIdSpriteTableSwitcher;
