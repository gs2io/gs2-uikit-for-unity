...
{
    [CustomEditor(typeof(Gs2AccountAccountPasswordSpriteTableSwitcher))]
    public class Gs2AccountAccountPasswordSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountAccountPasswordSpriteTableSwitcher;
