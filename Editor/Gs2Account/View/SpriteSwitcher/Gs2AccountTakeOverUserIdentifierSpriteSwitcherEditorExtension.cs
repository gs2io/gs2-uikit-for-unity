...
{
    [CustomEditor(typeof(Gs2AccountTakeOverUserIdentifierSpriteSwitcher))]
    public class Gs2AccountTakeOverUserIdentifierSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountTakeOverUserIdentifierSpriteSwitcher;
            ...
            if (original.expression == Gs2AccountTakeOverUserIdentifierSpriteSwitcher.Expression.In || original.expression == Gs2AccountTakeOverUserIdentifierSpriteSwitcher.Expression.NotIn) {
