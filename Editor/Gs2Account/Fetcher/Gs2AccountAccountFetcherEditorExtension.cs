...
{
    [CustomEditor(typeof(Gs2AccountAccountFetcher))]
    public class Gs2AccountAccountFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2AccountAccountFetcher;
