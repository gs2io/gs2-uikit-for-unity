...
namespace Gs2.Unity.UiKit.Gs2Account.Editor
{
    ...
    public class Gs2AccountTakeOverDeleteTakeOverSettingActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            ...
            var context = original.GetComponent<Gs2AccountTakeOverContext>() ?? original.GetComponentInParent<Gs2AccountTakeOverContext>(true);
            if (context == null) {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("onDeleteTakeOverSettingComplete"), true);
