...
{
    [CustomEditor(typeof(Gs2LimitCounterCountSpriteSwitcher))]
    public class Gs2LimitCounterCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitCounterCountSpriteSwitcher;
            ...
            if (original.expression == Gs2LimitCounterCountSpriteSwitcher.Expression.In || original.expression == Gs2LimitCounterCountSpriteSwitcher.Expression.NotIn) {
