...
{
    [CustomEditor(typeof(Gs2LimitLimitModelDaysSpriteSwitcher))]
    public class Gs2LimitLimitModelDaysSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelDaysSpriteSwitcher;
            ...
            if (original.expression == Gs2LimitLimitModelDaysSpriteSwitcher.Expression.In || original.expression == Gs2LimitLimitModelDaysSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyDayses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyDays"), true);
            }
