...
{
    [CustomEditor(typeof(Gs2LimitCounterLimitNameSpriteTableSwitcher))]
    public class Gs2LimitCounterLimitNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitCounterLimitNameSpriteTableSwitcher;
