...
{
    [CustomEditor(typeof(Gs2LimitCounterNameSpriteSwitcher))]
    public class Gs2LimitCounterNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitCounterNameSpriteSwitcher;
            ...
            if (original.expression == Gs2LimitCounterNameSpriteSwitcher.Expression.In || original.expression == Gs2LimitCounterNameSpriteSwitcher.Expression.NotIn) {
