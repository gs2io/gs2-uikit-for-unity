...
{
    [CustomEditor(typeof(Gs2LimitCounterLimitNameSpriteSwitcher))]
    public class Gs2LimitCounterLimitNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitCounterLimitNameSpriteSwitcher;
            ...
            if (original.expression == Gs2LimitCounterLimitNameSpriteSwitcher.Expression.In || original.expression == Gs2LimitCounterLimitNameSpriteSwitcher.Expression.NotIn) {
