...
{
    [CustomEditor(typeof(Gs2LimitCounterNameSpriteTableSwitcher))]
    public class Gs2LimitCounterNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitCounterNameSpriteTableSwitcher;
