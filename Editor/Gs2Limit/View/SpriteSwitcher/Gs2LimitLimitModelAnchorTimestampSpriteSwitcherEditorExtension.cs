...
{
    [CustomEditor(typeof(Gs2LimitLimitModelAnchorTimestampSpriteSwitcher))]
    public class Gs2LimitLimitModelAnchorTimestampSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelAnchorTimestampSpriteSwitcher;
            ...
            if (original.expression == Gs2LimitLimitModelAnchorTimestampSpriteSwitcher.Expression.In || original.expression == Gs2LimitLimitModelAnchorTimestampSpriteSwitcher.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyAnchorTimestamps"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("applyAnchorTimestamp"), true);
            }
