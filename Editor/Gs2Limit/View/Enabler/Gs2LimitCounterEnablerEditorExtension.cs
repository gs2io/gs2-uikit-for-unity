...
{
    [CustomEditor(typeof(Gs2LimitCounterEnabler))]
    public class Gs2LimitCounterEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitCounterEnabler;
