...
{
    [CustomEditor(typeof(Gs2LimitLimitModelAnchorTimestampEnabler))]
    public class Gs2LimitLimitModelAnchorTimestampEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelAnchorTimestampEnabler;
            ...
            if (original.expression == Gs2LimitLimitModelAnchorTimestampEnabler.Expression.In || original.expression == Gs2LimitLimitModelAnchorTimestampEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableAnchorTimestamps"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableAnchorTimestamp"), true);
            }
