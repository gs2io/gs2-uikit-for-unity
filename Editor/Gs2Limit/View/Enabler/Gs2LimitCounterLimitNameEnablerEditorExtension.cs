...
{
    [CustomEditor(typeof(Gs2LimitCounterLimitNameEnabler))]
    public class Gs2LimitCounterLimitNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitCounterLimitNameEnabler;
            ...
            if (original.expression == Gs2LimitCounterLimitNameEnabler.Expression.In || original.expression == Gs2LimitCounterLimitNameEnabler.Expression.NotIn) {
