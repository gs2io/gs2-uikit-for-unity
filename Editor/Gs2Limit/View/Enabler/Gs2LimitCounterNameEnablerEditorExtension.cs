...
{
    [CustomEditor(typeof(Gs2LimitCounterNameEnabler))]
    public class Gs2LimitCounterNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitCounterNameEnabler;
            ...
            if (original.expression == Gs2LimitCounterNameEnabler.Expression.In || original.expression == Gs2LimitCounterNameEnabler.Expression.NotIn) {
