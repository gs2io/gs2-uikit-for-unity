...
{
    [CustomEditor(typeof(Gs2LimitLimitModelDaysEnabler))]
    public class Gs2LimitLimitModelDaysEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LimitLimitModelDaysEnabler;
            ...
            if (original.expression == Gs2LimitLimitModelDaysEnabler.Expression.In || original.expression == Gs2LimitLimitModelDaysEnabler.Expression.NotIn) {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableDayses"), true);
            } else {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("enableDays"), true);
            }
