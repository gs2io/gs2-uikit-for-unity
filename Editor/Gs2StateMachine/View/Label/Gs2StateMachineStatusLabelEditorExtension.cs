...
{
    [CustomEditor(typeof(Gs2StateMachineStatusLabel))]
    public class Gs2StateMachineStatusLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusLabel;
