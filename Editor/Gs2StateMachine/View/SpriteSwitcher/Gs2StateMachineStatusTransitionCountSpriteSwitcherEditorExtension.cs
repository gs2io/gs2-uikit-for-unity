...
{
    [CustomEditor(typeof(Gs2StateMachineStatusTransitionCountSpriteSwitcher))]
    public class Gs2StateMachineStatusTransitionCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusTransitionCountSpriteSwitcher;
            ...
            if (original.expression == Gs2StateMachineStatusTransitionCountSpriteSwitcher.Expression.In || original.expression == Gs2StateMachineStatusTransitionCountSpriteSwitcher.Expression.NotIn) {
