...
{
    [CustomEditor(typeof(Gs2StateMachineStatusLastErrorSpriteSwitcher))]
    public class Gs2StateMachineStatusLastErrorSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusLastErrorSpriteSwitcher;
            ...
            if (original.expression == Gs2StateMachineStatusLastErrorSpriteSwitcher.Expression.In || original.expression == Gs2StateMachineStatusLastErrorSpriteSwitcher.Expression.NotIn) {
