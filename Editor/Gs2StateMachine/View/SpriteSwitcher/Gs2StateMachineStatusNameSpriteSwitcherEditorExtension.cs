...
{
    [CustomEditor(typeof(Gs2StateMachineStatusNameSpriteSwitcher))]
    public class Gs2StateMachineStatusNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusNameSpriteSwitcher;
            ...
            if (original.expression == Gs2StateMachineStatusNameSpriteSwitcher.Expression.In || original.expression == Gs2StateMachineStatusNameSpriteSwitcher.Expression.NotIn) {
