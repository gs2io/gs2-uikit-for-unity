...
{
    [CustomEditor(typeof(Gs2StateMachineStatusLastErrorSpriteTableSwitcher))]
    public class Gs2StateMachineStatusLastErrorSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusLastErrorSpriteTableSwitcher;
