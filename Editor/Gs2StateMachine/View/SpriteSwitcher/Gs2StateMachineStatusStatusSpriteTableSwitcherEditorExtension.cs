...
{
    [CustomEditor(typeof(Gs2StateMachineStatusStatusSpriteTableSwitcher))]
    public class Gs2StateMachineStatusStatusSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusStatusSpriteTableSwitcher;
