...
{
    [CustomEditor(typeof(Gs2StateMachineStatusStatusSpriteSwitcher))]
    public class Gs2StateMachineStatusStatusSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusStatusSpriteSwitcher;
            ...
            if (original.expression == Gs2StateMachineStatusStatusSpriteSwitcher.Expression.In || original.expression == Gs2StateMachineStatusStatusSpriteSwitcher.Expression.NotIn) {
