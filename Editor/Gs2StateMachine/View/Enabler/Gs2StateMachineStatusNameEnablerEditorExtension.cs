...
{
    [CustomEditor(typeof(Gs2StateMachineStatusNameEnabler))]
    public class Gs2StateMachineStatusNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusNameEnabler;
            ...
            if (original.expression == Gs2StateMachineStatusNameEnabler.Expression.In || original.expression == Gs2StateMachineStatusNameEnabler.Expression.NotIn) {
