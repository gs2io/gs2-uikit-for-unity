...
{
    [CustomEditor(typeof(Gs2StateMachineStatusLastErrorEnabler))]
    public class Gs2StateMachineStatusLastErrorEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusLastErrorEnabler;
            ...
            if (original.expression == Gs2StateMachineStatusLastErrorEnabler.Expression.In || original.expression == Gs2StateMachineStatusLastErrorEnabler.Expression.NotIn) {
