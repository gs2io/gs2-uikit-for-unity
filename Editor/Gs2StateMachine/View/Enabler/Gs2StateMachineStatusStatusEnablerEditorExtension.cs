...
{
    [CustomEditor(typeof(Gs2StateMachineStatusStatusEnabler))]
    public class Gs2StateMachineStatusStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusStatusEnabler;
            ...
            if (original.expression == Gs2StateMachineStatusStatusEnabler.Expression.In || original.expression == Gs2StateMachineStatusStatusEnabler.Expression.NotIn) {
