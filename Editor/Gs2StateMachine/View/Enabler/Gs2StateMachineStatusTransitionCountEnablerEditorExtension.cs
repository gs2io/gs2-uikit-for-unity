...
{
    [CustomEditor(typeof(Gs2StateMachineStatusTransitionCountEnabler))]
    public class Gs2StateMachineStatusTransitionCountEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StateMachineStatusTransitionCountEnabler;
            ...
            if (original.expression == Gs2StateMachineStatusTransitionCountEnabler.Expression.In || original.expression == Gs2StateMachineStatusTransitionCountEnabler.Expression.NotIn) {
