...
{
    [CustomEditor(typeof(Gs2ShowcaseUserContext))]
    public class Gs2ShowcaseUserContextEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseUserContext;
