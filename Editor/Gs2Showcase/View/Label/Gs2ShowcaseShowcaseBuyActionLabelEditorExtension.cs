...
{
    [CustomEditor(typeof(Gs2ShowcaseShowcaseBuyActionLabel))]
    public class Gs2ShowcaseShowcaseBuyActionLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseShowcaseBuyActionLabel;
