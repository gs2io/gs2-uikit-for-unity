...
{
    [CustomEditor(typeof(Gs2ShowcaseSalesItemMetadataEnabler))]
    public class Gs2ShowcaseSalesItemMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseSalesItemMetadataEnabler;
            ...
            if (original.expression == Gs2ShowcaseSalesItemMetadataEnabler.Expression.In || original.expression == Gs2ShowcaseSalesItemMetadataEnabler.Expression.NotIn) {
