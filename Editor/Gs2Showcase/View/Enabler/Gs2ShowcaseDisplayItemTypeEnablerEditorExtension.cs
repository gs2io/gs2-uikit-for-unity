...
{
    [CustomEditor(typeof(Gs2ShowcaseDisplayItemTypeEnabler))]
    public class Gs2ShowcaseDisplayItemTypeEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseDisplayItemTypeEnabler;
            ...
            if (original.expression == Gs2ShowcaseDisplayItemTypeEnabler.Expression.In || original.expression == Gs2ShowcaseDisplayItemTypeEnabler.Expression.NotIn) {
