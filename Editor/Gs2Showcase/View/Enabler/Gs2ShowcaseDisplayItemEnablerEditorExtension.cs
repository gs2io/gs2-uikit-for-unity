...
{
    [CustomEditor(typeof(Gs2ShowcaseDisplayItemEnabler))]
    public class Gs2ShowcaseDisplayItemEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseDisplayItemEnabler;
