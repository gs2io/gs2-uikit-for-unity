...
{
    [CustomEditor(typeof(Gs2ShowcaseShowcaseNameEnabler))]
    public class Gs2ShowcaseShowcaseNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseShowcaseNameEnabler;
            ...
            if (original.expression == Gs2ShowcaseShowcaseNameEnabler.Expression.In || original.expression == Gs2ShowcaseShowcaseNameEnabler.Expression.NotIn) {
