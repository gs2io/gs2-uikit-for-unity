...
{
    [CustomEditor(typeof(Gs2ShowcaseShowcaseNameSpriteSwitcher))]
    public class Gs2ShowcaseShowcaseNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseShowcaseNameSpriteSwitcher;
            ...
            if (original.expression == Gs2ShowcaseShowcaseNameSpriteSwitcher.Expression.In || original.expression == Gs2ShowcaseShowcaseNameSpriteSwitcher.Expression.NotIn) {
