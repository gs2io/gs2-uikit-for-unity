...
{
    [CustomEditor(typeof(Gs2ShowcaseShowcaseNameSpriteTableSwitcher))]
    public class Gs2ShowcaseShowcaseNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseShowcaseNameSpriteTableSwitcher;
