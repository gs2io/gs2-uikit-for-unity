...
{
    [CustomEditor(typeof(Gs2ShowcaseShowcaseMetadataSpriteSwitcher))]
    public class Gs2ShowcaseShowcaseMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseShowcaseMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2ShowcaseShowcaseMetadataSpriteSwitcher.Expression.In || original.expression == Gs2ShowcaseShowcaseMetadataSpriteSwitcher.Expression.NotIn) {
