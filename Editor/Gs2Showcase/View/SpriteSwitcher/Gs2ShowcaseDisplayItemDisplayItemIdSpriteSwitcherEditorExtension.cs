...
{
    [CustomEditor(typeof(Gs2ShowcaseDisplayItemDisplayItemIdSpriteSwitcher))]
    public class Gs2ShowcaseDisplayItemDisplayItemIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseDisplayItemDisplayItemIdSpriteSwitcher;
            ...
            if (original.expression == Gs2ShowcaseDisplayItemDisplayItemIdSpriteSwitcher.Expression.In || original.expression == Gs2ShowcaseDisplayItemDisplayItemIdSpriteSwitcher.Expression.NotIn) {
