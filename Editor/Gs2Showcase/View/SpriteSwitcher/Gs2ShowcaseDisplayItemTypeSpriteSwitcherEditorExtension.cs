...
{
    [CustomEditor(typeof(Gs2ShowcaseDisplayItemTypeSpriteSwitcher))]
    public class Gs2ShowcaseDisplayItemTypeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseDisplayItemTypeSpriteSwitcher;
            ...
            if (original.expression == Gs2ShowcaseDisplayItemTypeSpriteSwitcher.Expression.In || original.expression == Gs2ShowcaseDisplayItemTypeSpriteSwitcher.Expression.NotIn) {
