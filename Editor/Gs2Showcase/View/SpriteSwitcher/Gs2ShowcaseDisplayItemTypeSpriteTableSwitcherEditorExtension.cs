...
{
    [CustomEditor(typeof(Gs2ShowcaseDisplayItemTypeSpriteTableSwitcher))]
    public class Gs2ShowcaseDisplayItemTypeSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseDisplayItemTypeSpriteTableSwitcher;
