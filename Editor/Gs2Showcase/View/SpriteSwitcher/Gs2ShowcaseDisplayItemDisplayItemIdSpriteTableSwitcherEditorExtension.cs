...
{
    [CustomEditor(typeof(Gs2ShowcaseDisplayItemDisplayItemIdSpriteTableSwitcher))]
    public class Gs2ShowcaseDisplayItemDisplayItemIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseDisplayItemDisplayItemIdSpriteTableSwitcher;
