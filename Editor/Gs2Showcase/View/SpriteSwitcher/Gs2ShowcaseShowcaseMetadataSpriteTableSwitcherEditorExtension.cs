...
{
    [CustomEditor(typeof(Gs2ShowcaseShowcaseMetadataSpriteTableSwitcher))]
    public class Gs2ShowcaseShowcaseMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseShowcaseMetadataSpriteTableSwitcher;
