...
{
    [CustomEditor(typeof(Gs2ShowcaseShowcaseFetcher))]
    public class Gs2ShowcaseShowcaseFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseShowcaseFetcher;
