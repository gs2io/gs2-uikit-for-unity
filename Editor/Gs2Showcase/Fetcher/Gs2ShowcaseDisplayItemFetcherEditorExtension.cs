...
{
    [CustomEditor(typeof(Gs2ShowcaseDisplayItemFetcher))]
    public class Gs2ShowcaseDisplayItemFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseDisplayItemFetcher;
