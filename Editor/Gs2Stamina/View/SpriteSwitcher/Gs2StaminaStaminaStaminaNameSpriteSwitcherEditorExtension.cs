...
{
    [CustomEditor(typeof(Gs2StaminaStaminaStaminaNameSpriteSwitcher))]
    public class Gs2StaminaStaminaStaminaNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaStaminaNameSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaStaminaStaminaNameSpriteSwitcher.Expression.In || original.expression == Gs2StaminaStaminaStaminaNameSpriteSwitcher.Expression.NotIn) {
