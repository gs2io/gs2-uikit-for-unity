...
{
    [CustomEditor(typeof(Gs2StaminaStaminaMaxValueSpriteSwitcher))]
    public class Gs2StaminaStaminaMaxValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaMaxValueSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaStaminaMaxValueSpriteSwitcher.Expression.In || original.expression == Gs2StaminaStaminaMaxValueSpriteSwitcher.Expression.NotIn) {
