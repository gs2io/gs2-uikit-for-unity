...
{
    [CustomEditor(typeof(Gs2StaminaStaminaNextRecoverAtSpriteSwitcher))]
    public class Gs2StaminaStaminaNextRecoverAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaNextRecoverAtSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaStaminaNextRecoverAtSpriteSwitcher.Expression.In || original.expression == Gs2StaminaStaminaNextRecoverAtSpriteSwitcher.Expression.NotIn) {
