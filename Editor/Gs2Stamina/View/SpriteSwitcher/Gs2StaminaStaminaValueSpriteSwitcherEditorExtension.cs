...
{
    [CustomEditor(typeof(Gs2StaminaStaminaValueSpriteSwitcher))]
    public class Gs2StaminaStaminaValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaValueSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaStaminaValueSpriteSwitcher.Expression.In || original.expression == Gs2StaminaStaminaValueSpriteSwitcher.Expression.NotIn) {
