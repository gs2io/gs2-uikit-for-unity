...
{
    [CustomEditor(typeof(Gs2StaminaStaminaRecoverIntervalMinutesSpriteSwitcher))]
    public class Gs2StaminaStaminaRecoverIntervalMinutesSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaRecoverIntervalMinutesSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaStaminaRecoverIntervalMinutesSpriteSwitcher.Expression.In || original.expression == Gs2StaminaStaminaRecoverIntervalMinutesSpriteSwitcher.Expression.NotIn) {
