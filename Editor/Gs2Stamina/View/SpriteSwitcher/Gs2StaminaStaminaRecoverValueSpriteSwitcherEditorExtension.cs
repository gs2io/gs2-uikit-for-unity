...
{
    [CustomEditor(typeof(Gs2StaminaStaminaRecoverValueSpriteSwitcher))]
    public class Gs2StaminaStaminaRecoverValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaRecoverValueSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaStaminaRecoverValueSpriteSwitcher.Expression.In || original.expression == Gs2StaminaStaminaRecoverValueSpriteSwitcher.Expression.NotIn) {
