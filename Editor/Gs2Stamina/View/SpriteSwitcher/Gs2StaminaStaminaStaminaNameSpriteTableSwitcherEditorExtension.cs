...
{
    [CustomEditor(typeof(Gs2StaminaStaminaStaminaNameSpriteTableSwitcher))]
    public class Gs2StaminaStaminaStaminaNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaStaminaNameSpriteTableSwitcher;
