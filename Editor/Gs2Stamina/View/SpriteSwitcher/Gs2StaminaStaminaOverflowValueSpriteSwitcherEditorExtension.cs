...
{
    [CustomEditor(typeof(Gs2StaminaStaminaOverflowValueSpriteSwitcher))]
    public class Gs2StaminaStaminaOverflowValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaOverflowValueSpriteSwitcher;
            ...
            if (original.expression == Gs2StaminaStaminaOverflowValueSpriteSwitcher.Expression.In || original.expression == Gs2StaminaStaminaOverflowValueSpriteSwitcher.Expression.NotIn) {
