...
{
    [CustomEditor(typeof(Gs2StaminaStaminaStaminaNameEnabler))]
    public class Gs2StaminaStaminaStaminaNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaStaminaNameEnabler;
            ...
            if (original.expression == Gs2StaminaStaminaStaminaNameEnabler.Expression.In || original.expression == Gs2StaminaStaminaStaminaNameEnabler.Expression.NotIn) {
