...
{
    [CustomEditor(typeof(Gs2StaminaStaminaRecoverIntervalMinutesEnabler))]
    public class Gs2StaminaStaminaRecoverIntervalMinutesEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaRecoverIntervalMinutesEnabler;
            ...
            if (original.expression == Gs2StaminaStaminaRecoverIntervalMinutesEnabler.Expression.In || original.expression == Gs2StaminaStaminaRecoverIntervalMinutesEnabler.Expression.NotIn) {
