...
{
    [CustomEditor(typeof(Gs2StaminaStaminaEnabler))]
    public class Gs2StaminaStaminaEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaEnabler;
