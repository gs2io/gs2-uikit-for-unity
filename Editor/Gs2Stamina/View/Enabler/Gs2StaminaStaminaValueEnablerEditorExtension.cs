...
{
    [CustomEditor(typeof(Gs2StaminaStaminaValueEnabler))]
    public class Gs2StaminaStaminaValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaValueEnabler;
