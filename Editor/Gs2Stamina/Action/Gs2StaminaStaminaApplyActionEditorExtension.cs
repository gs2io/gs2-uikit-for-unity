...
{
    [CustomEditor(typeof(Gs2StaminaStaminaApplyAction))]
    public class Gs2StaminaStaminaApplyActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2StaminaStaminaApplyAction;
