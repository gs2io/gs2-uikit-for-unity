...
{
    [CustomEditor(typeof(Gs2JobQueueJobCurrentRetryCountSpriteSwitcher))]
    public class Gs2JobQueueJobCurrentRetryCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueJobCurrentRetryCountSpriteSwitcher;
            ...
            if (original.expression == Gs2JobQueueJobCurrentRetryCountSpriteSwitcher.Expression.In || original.expression == Gs2JobQueueJobCurrentRetryCountSpriteSwitcher.Expression.NotIn) {
