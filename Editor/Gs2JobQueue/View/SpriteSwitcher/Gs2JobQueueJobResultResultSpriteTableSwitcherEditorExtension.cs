...
{
    [CustomEditor(typeof(Gs2JobQueueJobResultResultSpriteTableSwitcher))]
    public class Gs2JobQueueJobResultResultSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueJobResultResultSpriteTableSwitcher;
