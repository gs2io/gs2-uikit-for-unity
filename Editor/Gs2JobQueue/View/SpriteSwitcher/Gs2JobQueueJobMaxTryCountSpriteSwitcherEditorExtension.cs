...
{
    [CustomEditor(typeof(Gs2JobQueueJobMaxTryCountSpriteSwitcher))]
    public class Gs2JobQueueJobMaxTryCountSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueJobMaxTryCountSpriteSwitcher;
            ...
            if (original.expression == Gs2JobQueueJobMaxTryCountSpriteSwitcher.Expression.In || original.expression == Gs2JobQueueJobMaxTryCountSpriteSwitcher.Expression.NotIn) {
