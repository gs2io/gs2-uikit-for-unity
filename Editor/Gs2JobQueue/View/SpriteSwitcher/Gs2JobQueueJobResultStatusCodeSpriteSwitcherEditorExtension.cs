...
{
    [CustomEditor(typeof(Gs2JobQueueJobResultStatusCodeSpriteSwitcher))]
    public class Gs2JobQueueJobResultStatusCodeSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueJobResultStatusCodeSpriteSwitcher;
            ...
            if (original.expression == Gs2JobQueueJobResultStatusCodeSpriteSwitcher.Expression.In || original.expression == Gs2JobQueueJobResultStatusCodeSpriteSwitcher.Expression.NotIn) {
