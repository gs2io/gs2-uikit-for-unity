...
{
    [CustomEditor(typeof(Gs2JobQueueJobResultResultSpriteSwitcher))]
    public class Gs2JobQueueJobResultResultSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueJobResultResultSpriteSwitcher;
            ...
            if (original.expression == Gs2JobQueueJobResultResultSpriteSwitcher.Expression.In || original.expression == Gs2JobQueueJobResultResultSpriteSwitcher.Expression.NotIn) {
