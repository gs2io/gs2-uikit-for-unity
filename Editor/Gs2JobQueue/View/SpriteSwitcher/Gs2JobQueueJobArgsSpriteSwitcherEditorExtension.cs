...
{
    [CustomEditor(typeof(Gs2JobQueueJobArgsSpriteSwitcher))]
    public class Gs2JobQueueJobArgsSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueJobArgsSpriteSwitcher;
            ...
            if (original.expression == Gs2JobQueueJobArgsSpriteSwitcher.Expression.In || original.expression == Gs2JobQueueJobArgsSpriteSwitcher.Expression.NotIn) {
