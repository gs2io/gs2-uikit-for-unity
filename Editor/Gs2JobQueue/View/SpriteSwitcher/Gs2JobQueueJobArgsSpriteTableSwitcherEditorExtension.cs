...
{
    [CustomEditor(typeof(Gs2JobQueueJobArgsSpriteTableSwitcher))]
    public class Gs2JobQueueJobArgsSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueJobArgsSpriteTableSwitcher;
