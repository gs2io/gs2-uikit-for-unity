...
{
    [CustomEditor(typeof(Gs2JobQueueJobResultEnabler))]
    public class Gs2JobQueueJobResultEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueJobResultEnabler;
