...
{
    [CustomEditor(typeof(Gs2JobQueueJobEnabler))]
    public class Gs2JobQueueJobEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueJobEnabler;
