...
{
    [CustomEditor(typeof(Gs2IdleStatusIdleMinutesEnabler))]
    public class Gs2IdleStatusIdleMinutesEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleStatusIdleMinutesEnabler;
            ...
            if (original.expression == Gs2IdleStatusIdleMinutesEnabler.Expression.In || original.expression == Gs2IdleStatusIdleMinutesEnabler.Expression.NotIn) {
