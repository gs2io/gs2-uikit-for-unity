...
{
    [CustomEditor(typeof(Gs2IdleStatusCategoryNameSpriteTableSwitcher))]
    public class Gs2IdleStatusCategoryNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleStatusCategoryNameSpriteTableSwitcher;
