...
{
    [CustomEditor(typeof(Gs2IdleStatusCategoryNameSpriteSwitcher))]
    public class Gs2IdleStatusCategoryNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleStatusCategoryNameSpriteSwitcher;
            ...
            if (original.expression == Gs2IdleStatusCategoryNameSpriteSwitcher.Expression.In || original.expression == Gs2IdleStatusCategoryNameSpriteSwitcher.Expression.NotIn) {
