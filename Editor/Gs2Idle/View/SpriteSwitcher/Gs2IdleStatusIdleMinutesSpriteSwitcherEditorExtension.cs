...
{
    [CustomEditor(typeof(Gs2IdleStatusIdleMinutesSpriteSwitcher))]
    public class Gs2IdleStatusIdleMinutesSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleStatusIdleMinutesSpriteSwitcher;
            ...
            if (original.expression == Gs2IdleStatusIdleMinutesSpriteSwitcher.Expression.In || original.expression == Gs2IdleStatusIdleMinutesSpriteSwitcher.Expression.NotIn) {
