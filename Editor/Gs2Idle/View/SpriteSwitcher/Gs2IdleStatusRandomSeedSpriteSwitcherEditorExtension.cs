...
{
    [CustomEditor(typeof(Gs2IdleStatusRandomSeedSpriteSwitcher))]
    public class Gs2IdleStatusRandomSeedSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleStatusRandomSeedSpriteSwitcher;
            ...
            if (original.expression == Gs2IdleStatusRandomSeedSpriteSwitcher.Expression.In || original.expression == Gs2IdleStatusRandomSeedSpriteSwitcher.Expression.NotIn) {
