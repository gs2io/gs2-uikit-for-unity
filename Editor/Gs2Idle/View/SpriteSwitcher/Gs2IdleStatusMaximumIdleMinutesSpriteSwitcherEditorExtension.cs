...
{
    [CustomEditor(typeof(Gs2IdleStatusMaximumIdleMinutesSpriteSwitcher))]
    public class Gs2IdleStatusMaximumIdleMinutesSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2IdleStatusMaximumIdleMinutesSpriteSwitcher;
            ...
            if (original.expression == Gs2IdleStatusMaximumIdleMinutesSpriteSwitcher.Expression.In || original.expression == Gs2IdleStatusMaximumIdleMinutesSpriteSwitcher.Expression.NotIn) {
