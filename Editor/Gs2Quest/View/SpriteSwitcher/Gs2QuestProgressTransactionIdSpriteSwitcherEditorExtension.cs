...
{
    [CustomEditor(typeof(Gs2QuestProgressTransactionIdSpriteSwitcher))]
    public class Gs2QuestProgressTransactionIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestProgressTransactionIdSpriteSwitcher;
            ...
            if (original.expression == Gs2QuestProgressTransactionIdSpriteSwitcher.Expression.In || original.expression == Gs2QuestProgressTransactionIdSpriteSwitcher.Expression.NotIn) {
