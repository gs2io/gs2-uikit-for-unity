...
{
    [CustomEditor(typeof(Gs2QuestOwnProgressMetadataSpriteTableSwitcher))]
    public class Gs2QuestOwnProgressMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestOwnProgressMetadataSpriteTableSwitcher;
