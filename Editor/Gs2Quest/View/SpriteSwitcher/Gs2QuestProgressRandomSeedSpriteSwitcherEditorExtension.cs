...
{
    [CustomEditor(typeof(Gs2QuestProgressRandomSeedSpriteSwitcher))]
    public class Gs2QuestProgressRandomSeedSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestProgressRandomSeedSpriteSwitcher;
            ...
            if (original.expression == Gs2QuestProgressRandomSeedSpriteSwitcher.Expression.In || original.expression == Gs2QuestProgressRandomSeedSpriteSwitcher.Expression.NotIn) {
