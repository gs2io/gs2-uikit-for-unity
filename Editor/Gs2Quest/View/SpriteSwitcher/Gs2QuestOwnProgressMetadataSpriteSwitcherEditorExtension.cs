...
{
    [CustomEditor(typeof(Gs2QuestOwnProgressMetadataSpriteSwitcher))]
    public class Gs2QuestOwnProgressMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestOwnProgressMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2QuestOwnProgressMetadataSpriteSwitcher.Expression.In || original.expression == Gs2QuestOwnProgressMetadataSpriteSwitcher.Expression.NotIn) {
