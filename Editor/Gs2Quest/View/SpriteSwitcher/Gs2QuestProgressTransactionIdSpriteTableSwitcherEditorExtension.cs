...
{
    [CustomEditor(typeof(Gs2QuestProgressTransactionIdSpriteTableSwitcher))]
    public class Gs2QuestProgressTransactionIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestProgressTransactionIdSpriteTableSwitcher;
