...
{
    [CustomEditor(typeof(Gs2QuestCompletedQuestListQuestGroupNameSpriteSwitcher))]
    public class Gs2QuestCompletedQuestListQuestGroupNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestCompletedQuestListQuestGroupNameSpriteSwitcher;
            ...
            if (original.expression == Gs2QuestCompletedQuestListQuestGroupNameSpriteSwitcher.Expression.In || original.expression == Gs2QuestCompletedQuestListQuestGroupNameSpriteSwitcher.Expression.NotIn) {
