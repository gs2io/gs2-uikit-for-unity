...
{
    [CustomEditor(typeof(Gs2QuestCompletedQuestListQuestGroupNameSpriteTableSwitcher))]
    public class Gs2QuestCompletedQuestListQuestGroupNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestCompletedQuestListQuestGroupNameSpriteTableSwitcher;
