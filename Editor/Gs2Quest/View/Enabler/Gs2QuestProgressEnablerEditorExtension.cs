...
{
    [CustomEditor(typeof(Gs2QuestProgressEnabler))]
    public class Gs2QuestProgressEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestProgressEnabler;
