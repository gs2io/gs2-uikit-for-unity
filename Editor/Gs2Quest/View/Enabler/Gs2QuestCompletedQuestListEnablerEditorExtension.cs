...
{
    [CustomEditor(typeof(Gs2QuestCompletedQuestListEnabler))]
    public class Gs2QuestCompletedQuestListEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestCompletedQuestListEnabler;
