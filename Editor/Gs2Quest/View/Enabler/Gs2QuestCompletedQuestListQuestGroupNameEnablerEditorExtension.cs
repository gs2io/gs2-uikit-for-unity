...
{
    [CustomEditor(typeof(Gs2QuestCompletedQuestListQuestGroupNameEnabler))]
    public class Gs2QuestCompletedQuestListQuestGroupNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestCompletedQuestListQuestGroupNameEnabler;
            ...
            if (original.expression == Gs2QuestCompletedQuestListQuestGroupNameEnabler.Expression.In || original.expression == Gs2QuestCompletedQuestListQuestGroupNameEnabler.Expression.NotIn) {
