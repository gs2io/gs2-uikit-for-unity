...
{
    [CustomEditor(typeof(Gs2QuestQuestStatusEnabler))]
    public class Gs2QuestQuestStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestQuestStatusEnabler;
