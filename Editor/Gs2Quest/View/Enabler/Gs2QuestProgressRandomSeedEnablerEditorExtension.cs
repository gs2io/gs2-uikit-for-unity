...
{
    [CustomEditor(typeof(Gs2QuestProgressRandomSeedEnabler))]
    public class Gs2QuestProgressRandomSeedEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2QuestProgressRandomSeedEnabler;
            ...
            if (original.expression == Gs2QuestProgressRandomSeedEnabler.Expression.In || original.expression == Gs2QuestProgressRandomSeedEnabler.Expression.NotIn) {
