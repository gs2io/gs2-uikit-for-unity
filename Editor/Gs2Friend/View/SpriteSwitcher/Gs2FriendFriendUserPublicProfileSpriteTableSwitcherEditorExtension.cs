...
{
    [CustomEditor(typeof(Gs2FriendFriendUserPublicProfileSpriteTableSwitcher))]
    public class Gs2FriendFriendUserPublicProfileSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFriendUserPublicProfileSpriteTableSwitcher;
