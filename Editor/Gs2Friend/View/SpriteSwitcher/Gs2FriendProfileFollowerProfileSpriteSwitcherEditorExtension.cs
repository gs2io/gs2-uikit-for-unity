...
{
    [CustomEditor(typeof(Gs2FriendProfileFollowerProfileSpriteSwitcher))]
    public class Gs2FriendProfileFollowerProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendProfileFollowerProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendProfileFollowerProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendProfileFollowerProfileSpriteSwitcher.Expression.NotIn) {
