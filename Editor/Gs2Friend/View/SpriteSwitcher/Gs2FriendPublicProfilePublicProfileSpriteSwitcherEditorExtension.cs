...
{
    [CustomEditor(typeof(Gs2FriendPublicProfilePublicProfileSpriteSwitcher))]
    public class Gs2FriendPublicProfilePublicProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendPublicProfilePublicProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendPublicProfilePublicProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendPublicProfilePublicProfileSpriteSwitcher.Expression.NotIn) {
