...
{
    [CustomEditor(typeof(Gs2FriendProfileFollowerProfileSpriteTableSwitcher))]
    public class Gs2FriendProfileFollowerProfileSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendProfileFollowerProfileSpriteTableSwitcher;
