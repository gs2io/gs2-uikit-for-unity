...
{
    [CustomEditor(typeof(Gs2FriendFollowUserUserIdSpriteSwitcher))]
    public class Gs2FriendFollowUserUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFollowUserUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendFollowUserUserIdSpriteSwitcher.Expression.In || original.expression == Gs2FriendFollowUserUserIdSpriteSwitcher.Expression.NotIn) {
