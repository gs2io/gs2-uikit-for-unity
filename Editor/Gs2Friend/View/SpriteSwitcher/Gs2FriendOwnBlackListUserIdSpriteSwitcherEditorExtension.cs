...
{
    [CustomEditor(typeof(Gs2FriendOwnBlackListUserIdSpriteSwitcher))]
    public class Gs2FriendOwnBlackListUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnBlackListUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendOwnBlackListUserIdSpriteSwitcher.Expression.In || original.expression == Gs2FriendOwnBlackListUserIdSpriteSwitcher.Expression.NotIn) {
