...
{
    [CustomEditor(typeof(Gs2FriendProfilePublicProfileSpriteTableSwitcher))]
    public class Gs2FriendProfilePublicProfileSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendProfilePublicProfileSpriteTableSwitcher;
