...
{
    [CustomEditor(typeof(Gs2FriendFollowUserUserIdSpriteTableSwitcher))]
    public class Gs2FriendFollowUserUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFollowUserUserIdSpriteTableSwitcher;
