...
{
    [CustomEditor(typeof(Gs2FriendFollowUserPublicProfileSpriteTableSwitcher))]
    public class Gs2FriendFollowUserPublicProfileSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFollowUserPublicProfileSpriteTableSwitcher;
