...
{
    [CustomEditor(typeof(Gs2FriendFriendUserPublicProfileSpriteSwitcher))]
    public class Gs2FriendFriendUserPublicProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFriendUserPublicProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendFriendUserPublicProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendFriendUserPublicProfileSpriteSwitcher.Expression.NotIn) {
