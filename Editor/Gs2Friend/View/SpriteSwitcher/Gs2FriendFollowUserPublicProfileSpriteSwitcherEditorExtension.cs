...
{
    [CustomEditor(typeof(Gs2FriendFollowUserPublicProfileSpriteSwitcher))]
    public class Gs2FriendFollowUserPublicProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFollowUserPublicProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendFollowUserPublicProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendFollowUserPublicProfileSpriteSwitcher.Expression.NotIn) {
