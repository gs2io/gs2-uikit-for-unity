...
{
    [CustomEditor(typeof(Gs2FriendFriendUserUserIdSpriteTableSwitcher))]
    public class Gs2FriendFriendUserUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFriendUserUserIdSpriteTableSwitcher;
