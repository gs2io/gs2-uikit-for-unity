...
{
    [CustomEditor(typeof(Gs2FriendPublicProfileUserIdSpriteSwitcher))]
    public class Gs2FriendPublicProfileUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendPublicProfileUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendPublicProfileUserIdSpriteSwitcher.Expression.In || original.expression == Gs2FriendPublicProfileUserIdSpriteSwitcher.Expression.NotIn) {
