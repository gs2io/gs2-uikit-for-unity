...
{
    [CustomEditor(typeof(Gs2FriendProfileFriendProfileSpriteTableSwitcher))]
    public class Gs2FriendProfileFriendProfileSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendProfileFriendProfileSpriteTableSwitcher;
