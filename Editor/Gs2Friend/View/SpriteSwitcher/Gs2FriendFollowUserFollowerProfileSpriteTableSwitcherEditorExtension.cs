...
{
    [CustomEditor(typeof(Gs2FriendFollowUserFollowerProfileSpriteTableSwitcher))]
    public class Gs2FriendFollowUserFollowerProfileSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFollowUserFollowerProfileSpriteTableSwitcher;
