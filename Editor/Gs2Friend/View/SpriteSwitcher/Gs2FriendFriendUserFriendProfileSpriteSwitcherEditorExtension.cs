...
{
    [CustomEditor(typeof(Gs2FriendFriendUserFriendProfileSpriteSwitcher))]
    public class Gs2FriendFriendUserFriendProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFriendUserFriendProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendFriendUserFriendProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendFriendUserFriendProfileSpriteSwitcher.Expression.NotIn) {
