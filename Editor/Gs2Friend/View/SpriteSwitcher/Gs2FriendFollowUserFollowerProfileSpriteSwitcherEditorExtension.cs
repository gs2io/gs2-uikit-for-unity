...
{
    [CustomEditor(typeof(Gs2FriendFollowUserFollowerProfileSpriteSwitcher))]
    public class Gs2FriendFollowUserFollowerProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFollowUserFollowerProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendFollowUserFollowerProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendFollowUserFollowerProfileSpriteSwitcher.Expression.NotIn) {
