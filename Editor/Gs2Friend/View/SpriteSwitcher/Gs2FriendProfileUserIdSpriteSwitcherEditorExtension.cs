...
{
    [CustomEditor(typeof(Gs2FriendProfileUserIdSpriteSwitcher))]
    public class Gs2FriendProfileUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendProfileUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendProfileUserIdSpriteSwitcher.Expression.In || original.expression == Gs2FriendProfileUserIdSpriteSwitcher.Expression.NotIn) {
