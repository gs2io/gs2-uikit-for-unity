...
{
    [CustomEditor(typeof(Gs2FriendFriendUserFriendProfileSpriteTableSwitcher))]
    public class Gs2FriendFriendUserFriendProfileSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFriendUserFriendProfileSpriteTableSwitcher;
