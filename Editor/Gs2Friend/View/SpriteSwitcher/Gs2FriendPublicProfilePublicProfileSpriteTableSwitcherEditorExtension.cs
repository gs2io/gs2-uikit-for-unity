...
{
    [CustomEditor(typeof(Gs2FriendPublicProfilePublicProfileSpriteTableSwitcher))]
    public class Gs2FriendPublicProfilePublicProfileSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendPublicProfilePublicProfileSpriteTableSwitcher;
