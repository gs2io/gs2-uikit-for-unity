...
{
    [CustomEditor(typeof(Gs2FriendProfilePublicProfileSpriteSwitcher))]
    public class Gs2FriendProfilePublicProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendProfilePublicProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendProfilePublicProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendProfilePublicProfileSpriteSwitcher.Expression.NotIn) {
