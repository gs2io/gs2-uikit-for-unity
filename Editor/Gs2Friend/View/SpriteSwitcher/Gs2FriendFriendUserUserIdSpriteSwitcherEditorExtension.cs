...
{
    [CustomEditor(typeof(Gs2FriendFriendUserUserIdSpriteSwitcher))]
    public class Gs2FriendFriendUserUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFriendUserUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendFriendUserUserIdSpriteSwitcher.Expression.In || original.expression == Gs2FriendFriendUserUserIdSpriteSwitcher.Expression.NotIn) {
