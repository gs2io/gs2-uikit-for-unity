...
{
    [CustomEditor(typeof(Gs2FriendProfileUserIdSpriteTableSwitcher))]
    public class Gs2FriendProfileUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendProfileUserIdSpriteTableSwitcher;
