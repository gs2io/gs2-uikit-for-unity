...
{
    [CustomEditor(typeof(Gs2FriendBlackListUserIdSpriteTableSwitcher))]
    public class Gs2FriendBlackListUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendBlackListUserIdSpriteTableSwitcher;
