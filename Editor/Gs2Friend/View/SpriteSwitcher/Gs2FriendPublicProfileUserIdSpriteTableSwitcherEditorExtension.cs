...
{
    [CustomEditor(typeof(Gs2FriendPublicProfileUserIdSpriteTableSwitcher))]
    public class Gs2FriendPublicProfileUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendPublicProfileUserIdSpriteTableSwitcher;
