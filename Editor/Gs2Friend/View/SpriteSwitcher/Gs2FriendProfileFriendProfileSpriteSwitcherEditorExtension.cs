...
{
    [CustomEditor(typeof(Gs2FriendProfileFriendProfileSpriteSwitcher))]
    public class Gs2FriendProfileFriendProfileSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendProfileFriendProfileSpriteSwitcher;
            ...
            if (original.expression == Gs2FriendProfileFriendProfileSpriteSwitcher.Expression.In || original.expression == Gs2FriendProfileFriendProfileSpriteSwitcher.Expression.NotIn) {
