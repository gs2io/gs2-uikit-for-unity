...
{
    [CustomEditor(typeof(Gs2FriendFollowStatusEnabler))]
    public class Gs2FriendFollowStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFollowStatusEnabler;
