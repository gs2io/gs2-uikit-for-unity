...
{
    [CustomEditor(typeof(Gs2FriendBlackListUserIdEnabler))]
    public class Gs2FriendBlackListUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendBlackListUserIdEnabler;
            ...
            if (original.expression == Gs2FriendBlackListUserIdEnabler.Expression.In || original.expression == Gs2FriendBlackListUserIdEnabler.Expression.NotIn) {
