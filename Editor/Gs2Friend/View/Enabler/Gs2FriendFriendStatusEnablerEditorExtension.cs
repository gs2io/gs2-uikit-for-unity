...
{
    [CustomEditor(typeof(Gs2FriendFriendStatusEnabler))]
    public class Gs2FriendFriendStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFriendStatusEnabler;
