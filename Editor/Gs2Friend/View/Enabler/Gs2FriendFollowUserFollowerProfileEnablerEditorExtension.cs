...
{
    [CustomEditor(typeof(Gs2FriendFollowUserFollowerProfileEnabler))]
    public class Gs2FriendFollowUserFollowerProfileEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFollowUserFollowerProfileEnabler;
            ...
            if (original.expression == Gs2FriendFollowUserFollowerProfileEnabler.Expression.In || original.expression == Gs2FriendFollowUserFollowerProfileEnabler.Expression.NotIn) {
