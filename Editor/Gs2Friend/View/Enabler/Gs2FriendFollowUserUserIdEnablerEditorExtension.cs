...
namespace Gs2.Unity.UiKit.Gs2Friend.Enabler.Editor
{
    ...
    public class Gs2FriendFollowUserUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFollowUserUserIdEnabler;
            ...
            if (original.expression == Gs2FriendFollowUserUserIdEnabler.Expression.In || original.expression == Gs2FriendFollowUserUserIdEnabler.Expression.NotIn) {
