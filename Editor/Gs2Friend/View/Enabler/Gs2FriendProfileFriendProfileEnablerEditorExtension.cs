...
{
    [CustomEditor(typeof(Gs2FriendProfileFriendProfileEnabler))]
    public class Gs2FriendProfileFriendProfileEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendProfileFriendProfileEnabler;
            ...
            if (original.expression == Gs2FriendProfileFriendProfileEnabler.Expression.In || original.expression == Gs2FriendProfileFriendProfileEnabler.Expression.NotIn) {
