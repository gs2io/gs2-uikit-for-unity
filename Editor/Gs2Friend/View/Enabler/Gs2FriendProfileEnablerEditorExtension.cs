...
{
    [CustomEditor(typeof(Gs2FriendProfileEnabler))]
    public class Gs2FriendProfileEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendProfileEnabler;
