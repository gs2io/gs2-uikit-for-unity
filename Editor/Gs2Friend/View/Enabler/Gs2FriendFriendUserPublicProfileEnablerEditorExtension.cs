...
{
    [CustomEditor(typeof(Gs2FriendFriendUserPublicProfileEnabler))]
    public class Gs2FriendFriendUserPublicProfileEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendFriendUserPublicProfileEnabler;
            ...
            if (original.expression == Gs2FriendFriendUserPublicProfileEnabler.Expression.In || original.expression == Gs2FriendFriendUserPublicProfileEnabler.Expression.NotIn) {
