...
{
    [CustomEditor(typeof(Gs2FriendPublicProfilePublicProfileEnabler))]
    public class Gs2FriendPublicProfilePublicProfileEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendPublicProfilePublicProfileEnabler;
            ...
            if (original.expression == Gs2FriendPublicProfilePublicProfileEnabler.Expression.In || original.expression == Gs2FriendPublicProfilePublicProfileEnabler.Expression.NotIn) {
