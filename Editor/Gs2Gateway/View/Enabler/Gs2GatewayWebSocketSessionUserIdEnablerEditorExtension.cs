...
{
    [CustomEditor(typeof(Gs2GatewayWebSocketSessionUserIdEnabler))]
    public class Gs2GatewayWebSocketSessionUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayWebSocketSessionUserIdEnabler;
            ...
            if (original.expression == Gs2GatewayWebSocketSessionUserIdEnabler.Expression.In || original.expression == Gs2GatewayWebSocketSessionUserIdEnabler.Expression.NotIn) {
