...
{
    [CustomEditor(typeof(Gs2GatewayWebSocketSessionNamespaceNameEnabler))]
    public class Gs2GatewayWebSocketSessionNamespaceNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayWebSocketSessionNamespaceNameEnabler;
            ...
            if (original.expression == Gs2GatewayWebSocketSessionNamespaceNameEnabler.Expression.In || original.expression == Gs2GatewayWebSocketSessionNamespaceNameEnabler.Expression.NotIn) {
