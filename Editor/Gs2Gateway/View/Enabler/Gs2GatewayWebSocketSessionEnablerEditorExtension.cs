...
{
    [CustomEditor(typeof(Gs2GatewayWebSocketSessionEnabler))]
    public class Gs2GatewayWebSocketSessionEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayWebSocketSessionEnabler;
