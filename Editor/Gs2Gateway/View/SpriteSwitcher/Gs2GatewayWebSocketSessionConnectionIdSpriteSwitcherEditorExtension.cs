...
{
    [CustomEditor(typeof(Gs2GatewayWebSocketSessionConnectionIdSpriteSwitcher))]
    public class Gs2GatewayWebSocketSessionConnectionIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayWebSocketSessionConnectionIdSpriteSwitcher;
            ...
            if (original.expression == Gs2GatewayWebSocketSessionConnectionIdSpriteSwitcher.Expression.In || original.expression == Gs2GatewayWebSocketSessionConnectionIdSpriteSwitcher.Expression.NotIn) {
