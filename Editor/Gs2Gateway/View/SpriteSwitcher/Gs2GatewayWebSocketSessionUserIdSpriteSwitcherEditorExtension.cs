...
{
    [CustomEditor(typeof(Gs2GatewayWebSocketSessionUserIdSpriteSwitcher))]
    public class Gs2GatewayWebSocketSessionUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayWebSocketSessionUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2GatewayWebSocketSessionUserIdSpriteSwitcher.Expression.In || original.expression == Gs2GatewayWebSocketSessionUserIdSpriteSwitcher.Expression.NotIn) {
