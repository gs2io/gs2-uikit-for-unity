...
{
    [CustomEditor(typeof(Gs2GatewayWebSocketSessionNamespaceNameSpriteSwitcher))]
    public class Gs2GatewayWebSocketSessionNamespaceNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayWebSocketSessionNamespaceNameSpriteSwitcher;
            ...
            if (original.expression == Gs2GatewayWebSocketSessionNamespaceNameSpriteSwitcher.Expression.In || original.expression == Gs2GatewayWebSocketSessionNamespaceNameSpriteSwitcher.Expression.NotIn) {
