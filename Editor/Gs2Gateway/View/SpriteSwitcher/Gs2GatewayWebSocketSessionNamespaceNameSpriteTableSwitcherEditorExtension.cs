...
{
    [CustomEditor(typeof(Gs2GatewayWebSocketSessionNamespaceNameSpriteTableSwitcher))]
    public class Gs2GatewayWebSocketSessionNamespaceNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayWebSocketSessionNamespaceNameSpriteTableSwitcher;
