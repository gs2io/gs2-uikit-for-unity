...
{
    [CustomEditor(typeof(Gs2GatewayWebSocketSessionConnectionIdSpriteTableSwitcher))]
    public class Gs2GatewayWebSocketSessionConnectionIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayWebSocketSessionConnectionIdSpriteTableSwitcher;
