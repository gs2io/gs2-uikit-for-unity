...
{
    [CustomEditor(typeof(Gs2GatewayWebSocketSessionUserIdSpriteTableSwitcher))]
    public class Gs2GatewayWebSocketSessionUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayWebSocketSessionUserIdSpriteTableSwitcher;
