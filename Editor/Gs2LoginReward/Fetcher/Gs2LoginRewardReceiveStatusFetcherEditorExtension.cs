...
{
    [CustomEditor(typeof(Gs2LoginRewardReceiveStatusFetcher))]
    public class Gs2LoginRewardReceiveStatusFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardReceiveStatusFetcher;
