...
{
    [CustomEditor(typeof(Gs2LoginRewardReceiveStatusBonusModelNameSpriteSwitcher))]
    public class Gs2LoginRewardReceiveStatusBonusModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardReceiveStatusBonusModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2LoginRewardReceiveStatusBonusModelNameSpriteSwitcher.Expression.In || original.expression == Gs2LoginRewardReceiveStatusBonusModelNameSpriteSwitcher.Expression.NotIn) {
