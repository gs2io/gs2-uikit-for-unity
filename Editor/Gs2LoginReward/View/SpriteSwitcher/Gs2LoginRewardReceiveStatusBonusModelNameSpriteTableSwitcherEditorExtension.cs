...
{
    [CustomEditor(typeof(Gs2LoginRewardReceiveStatusBonusModelNameSpriteTableSwitcher))]
    public class Gs2LoginRewardReceiveStatusBonusModelNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardReceiveStatusBonusModelNameSpriteTableSwitcher;
