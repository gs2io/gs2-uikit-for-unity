...
{
    [CustomEditor(typeof(Gs2LoginRewardReceiveStatusLastReceivedAtSpriteSwitcher))]
    public class Gs2LoginRewardReceiveStatusLastReceivedAtSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardReceiveStatusLastReceivedAtSpriteSwitcher;
            ...
            if (original.expression == Gs2LoginRewardReceiveStatusLastReceivedAtSpriteSwitcher.Expression.In || original.expression == Gs2LoginRewardReceiveStatusLastReceivedAtSpriteSwitcher.Expression.NotIn) {
