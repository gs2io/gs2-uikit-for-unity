...
{
    [CustomEditor(typeof(Gs2LoginRewardReceiveStatusBonusModelNameEnabler))]
    public class Gs2LoginRewardReceiveStatusBonusModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardReceiveStatusBonusModelNameEnabler;
            ...
            if (original.expression == Gs2LoginRewardReceiveStatusBonusModelNameEnabler.Expression.In || original.expression == Gs2LoginRewardReceiveStatusBonusModelNameEnabler.Expression.NotIn) {
