...
{
    [CustomEditor(typeof(Gs2LoginRewardReceiveStatusEnabler))]
    public class Gs2LoginRewardReceiveStatusEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardReceiveStatusEnabler;
