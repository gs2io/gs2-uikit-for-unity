...
{
    [CustomEditor(typeof(Gs2LoginRewardReceiveStatusLastReceivedAtEnabler))]
    public class Gs2LoginRewardReceiveStatusLastReceivedAtEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardReceiveStatusLastReceivedAtEnabler;
            ...
            if (original.expression == Gs2LoginRewardReceiveStatusLastReceivedAtEnabler.Expression.In || original.expression == Gs2LoginRewardReceiveStatusLastReceivedAtEnabler.Expression.NotIn) {
