...
{
    [CustomEditor(typeof(Gs2LoginRewardReceiveStatusLabel))]
    public class Gs2LoginRewardReceiveStatusLabelEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2LoginRewardReceiveStatusLabel;
