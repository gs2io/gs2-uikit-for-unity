...
{
    [CustomEditor(typeof(Gs2VersionAcceptVersionRejectAction))]
    public class Gs2VersionAcceptVersionRejectActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionAcceptVersionRejectAction;
