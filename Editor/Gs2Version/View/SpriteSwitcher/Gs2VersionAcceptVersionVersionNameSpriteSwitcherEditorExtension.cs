...
{
    [CustomEditor(typeof(Gs2VersionAcceptVersionVersionNameSpriteSwitcher))]
    public class Gs2VersionAcceptVersionVersionNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionAcceptVersionVersionNameSpriteSwitcher;
            ...
            if (original.expression == Gs2VersionAcceptVersionVersionNameSpriteSwitcher.Expression.In || original.expression == Gs2VersionAcceptVersionVersionNameSpriteSwitcher.Expression.NotIn) {
