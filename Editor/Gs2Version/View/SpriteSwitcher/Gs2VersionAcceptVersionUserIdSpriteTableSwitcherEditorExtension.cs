...
{
    [CustomEditor(typeof(Gs2VersionAcceptVersionUserIdSpriteTableSwitcher))]
    public class Gs2VersionAcceptVersionUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionAcceptVersionUserIdSpriteTableSwitcher;
