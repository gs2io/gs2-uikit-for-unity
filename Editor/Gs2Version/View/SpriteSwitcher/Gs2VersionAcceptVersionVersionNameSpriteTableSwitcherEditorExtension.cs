...
{
    [CustomEditor(typeof(Gs2VersionAcceptVersionVersionNameSpriteTableSwitcher))]
    public class Gs2VersionAcceptVersionVersionNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionAcceptVersionVersionNameSpriteTableSwitcher;
