...
{
    [CustomEditor(typeof(Gs2VersionAcceptVersionUserIdSpriteSwitcher))]
    public class Gs2VersionAcceptVersionUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionAcceptVersionUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2VersionAcceptVersionUserIdSpriteSwitcher.Expression.In || original.expression == Gs2VersionAcceptVersionUserIdSpriteSwitcher.Expression.NotIn) {
