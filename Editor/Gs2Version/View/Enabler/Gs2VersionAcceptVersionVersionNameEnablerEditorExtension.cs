...
namespace Gs2.Unity.UiKit.Gs2Version.Enabler.Editor
{
    ...
    public class Gs2VersionAcceptVersionVersionNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2VersionAcceptVersionVersionNameEnabler;
            ...
            if (original.expression == Gs2VersionAcceptVersionVersionNameEnabler.Expression.In || original.expression == Gs2VersionAcceptVersionVersionNameEnabler.Expression.NotIn) {
