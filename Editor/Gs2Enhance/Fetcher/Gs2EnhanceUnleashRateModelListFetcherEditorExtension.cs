...
{
    [CustomEditor(typeof(Gs2EnhanceUnleashRateModelListFetcher))]
    public class Gs2EnhanceUnleashRateModelListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceUnleashRateModelListFetcher;
