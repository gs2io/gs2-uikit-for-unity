...
{
    [CustomEditor(typeof(Gs2EnhanceProgressPropertyIdSpriteTableSwitcher))]
    public class Gs2EnhanceProgressPropertyIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressPropertyIdSpriteTableSwitcher;
