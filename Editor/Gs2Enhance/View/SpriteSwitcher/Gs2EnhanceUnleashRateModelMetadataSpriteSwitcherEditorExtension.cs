...
{
    [CustomEditor(typeof(Gs2EnhanceUnleashRateModelMetadataSpriteSwitcher))]
    public class Gs2EnhanceUnleashRateModelMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceUnleashRateModelMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2EnhanceUnleashRateModelMetadataSpriteSwitcher.Expression.In || original.expression == Gs2EnhanceUnleashRateModelMetadataSpriteSwitcher.Expression.NotIn) {
