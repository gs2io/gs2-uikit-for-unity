...
{
    [CustomEditor(typeof(Gs2EnhanceProgressRateSpriteSwitcher))]
    public class Gs2EnhanceProgressRateSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressRateSpriteSwitcher;
            ...
            if (original.expression == Gs2EnhanceProgressRateSpriteSwitcher.Expression.In || original.expression == Gs2EnhanceProgressRateSpriteSwitcher.Expression.NotIn) {
