...
{
    [CustomEditor(typeof(Gs2EnhanceUnleashRateModelNameSpriteSwitcher))]
    public class Gs2EnhanceUnleashRateModelNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceUnleashRateModelNameSpriteSwitcher;
            ...
            if (original.expression == Gs2EnhanceUnleashRateModelNameSpriteSwitcher.Expression.In || original.expression == Gs2EnhanceUnleashRateModelNameSpriteSwitcher.Expression.NotIn) {
