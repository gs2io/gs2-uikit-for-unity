...
{
    [CustomEditor(typeof(Gs2EnhanceProgressRateNameSpriteTableSwitcher))]
    public class Gs2EnhanceProgressRateNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressRateNameSpriteTableSwitcher;
