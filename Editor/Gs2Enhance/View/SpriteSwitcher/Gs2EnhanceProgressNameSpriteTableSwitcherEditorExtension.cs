...
{
    [CustomEditor(typeof(Gs2EnhanceProgressNameSpriteTableSwitcher))]
    public class Gs2EnhanceProgressNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressNameSpriteTableSwitcher;
