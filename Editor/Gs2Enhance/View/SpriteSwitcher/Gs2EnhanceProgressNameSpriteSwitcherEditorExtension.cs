...
{
    [CustomEditor(typeof(Gs2EnhanceProgressNameSpriteSwitcher))]
    public class Gs2EnhanceProgressNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressNameSpriteSwitcher;
            ...
            if (original.expression == Gs2EnhanceProgressNameSpriteSwitcher.Expression.In || original.expression == Gs2EnhanceProgressNameSpriteSwitcher.Expression.NotIn) {
