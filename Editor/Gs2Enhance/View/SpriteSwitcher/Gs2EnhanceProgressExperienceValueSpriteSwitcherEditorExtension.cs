...
{
    [CustomEditor(typeof(Gs2EnhanceProgressExperienceValueSpriteSwitcher))]
    public class Gs2EnhanceProgressExperienceValueSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressExperienceValueSpriteSwitcher;
            ...
            if (original.expression == Gs2EnhanceProgressExperienceValueSpriteSwitcher.Expression.In || original.expression == Gs2EnhanceProgressExperienceValueSpriteSwitcher.Expression.NotIn) {
