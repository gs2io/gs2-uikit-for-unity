...
{
    [CustomEditor(typeof(Gs2EnhanceProgressPropertyIdSpriteSwitcher))]
    public class Gs2EnhanceProgressPropertyIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressPropertyIdSpriteSwitcher;
            ...
            if (original.expression == Gs2EnhanceProgressPropertyIdSpriteSwitcher.Expression.In || original.expression == Gs2EnhanceProgressPropertyIdSpriteSwitcher.Expression.NotIn) {
