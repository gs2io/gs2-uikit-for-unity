...
{
    [CustomEditor(typeof(Gs2EnhanceProgressRateNameSpriteSwitcher))]
    public class Gs2EnhanceProgressRateNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressRateNameSpriteSwitcher;
            ...
            if (original.expression == Gs2EnhanceProgressRateNameSpriteSwitcher.Expression.In || original.expression == Gs2EnhanceProgressRateNameSpriteSwitcher.Expression.NotIn) {
