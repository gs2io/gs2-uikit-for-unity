...
{
    [CustomEditor(typeof(Gs2EnhanceUnleashRateModelNameSpriteTableSwitcher))]
    public class Gs2EnhanceUnleashRateModelNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceUnleashRateModelNameSpriteTableSwitcher;
