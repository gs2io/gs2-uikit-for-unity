...
{
    [CustomEditor(typeof(Gs2EnhanceUnleashRateModelMetadataSpriteTableSwitcher))]
    public class Gs2EnhanceUnleashRateModelMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceUnleashRateModelMetadataSpriteTableSwitcher;
