...
{
    [CustomEditor(typeof(Gs2EnhanceProgressNameEnabler))]
    public class Gs2EnhanceProgressNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressNameEnabler;
            ...
            if (original.expression == Gs2EnhanceProgressNameEnabler.Expression.In || original.expression == Gs2EnhanceProgressNameEnabler.Expression.NotIn) {
