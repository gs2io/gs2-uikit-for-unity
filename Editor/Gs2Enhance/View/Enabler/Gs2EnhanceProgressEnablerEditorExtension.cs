...
{
    [CustomEditor(typeof(Gs2EnhanceProgressEnabler))]
    public class Gs2EnhanceProgressEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressEnabler;
