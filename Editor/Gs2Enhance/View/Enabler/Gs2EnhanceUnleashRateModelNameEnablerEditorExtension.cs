...
{
    [CustomEditor(typeof(Gs2EnhanceUnleashRateModelNameEnabler))]
    public class Gs2EnhanceUnleashRateModelNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceUnleashRateModelNameEnabler;
            ...
            if (original.expression == Gs2EnhanceUnleashRateModelNameEnabler.Expression.In || original.expression == Gs2EnhanceUnleashRateModelNameEnabler.Expression.NotIn) {
