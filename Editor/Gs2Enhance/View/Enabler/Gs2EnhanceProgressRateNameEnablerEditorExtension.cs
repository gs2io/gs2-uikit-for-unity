...
namespace Gs2.Unity.UiKit.Gs2Enhance.Enabler.Editor
{
    ...
    public class Gs2EnhanceProgressRateNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressRateNameEnabler;
            ...
            if (original.expression == Gs2EnhanceProgressRateNameEnabler.Expression.In || original.expression == Gs2EnhanceProgressRateNameEnabler.Expression.NotIn) {
