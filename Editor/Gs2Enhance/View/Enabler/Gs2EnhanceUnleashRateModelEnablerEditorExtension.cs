...
{
    [CustomEditor(typeof(Gs2EnhanceUnleashRateModelEnabler))]
    public class Gs2EnhanceUnleashRateModelEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceUnleashRateModelEnabler;
            ...
            if (fetcher == null) {
                EditorGUILayout.HelpBox("UnleashRateModelFetcher not assigned.", MessageType.Error);
