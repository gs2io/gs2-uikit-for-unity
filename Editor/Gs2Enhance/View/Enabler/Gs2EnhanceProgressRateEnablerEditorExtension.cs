...
{
    [CustomEditor(typeof(Gs2EnhanceProgressRateEnabler))]
    public class Gs2EnhanceProgressRateEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressRateEnabler;
            ...
            if (original.expression == Gs2EnhanceProgressRateEnabler.Expression.In || original.expression == Gs2EnhanceProgressRateEnabler.Expression.NotIn) {
