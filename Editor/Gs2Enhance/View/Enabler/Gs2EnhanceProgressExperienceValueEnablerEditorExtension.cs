...
{
    [CustomEditor(typeof(Gs2EnhanceProgressExperienceValueEnabler))]
    public class Gs2EnhanceProgressExperienceValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceProgressExperienceValueEnabler;
            ...
            if (original.expression == Gs2EnhanceProgressExperienceValueEnabler.Expression.In || original.expression == Gs2EnhanceProgressExperienceValueEnabler.Expression.NotIn) {
