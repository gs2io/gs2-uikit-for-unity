...
{
    [CustomEditor(typeof(Gs2EnhanceUnleashRateModelMetadataEnabler))]
    public class Gs2EnhanceUnleashRateModelMetadataEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2EnhanceUnleashRateModelMetadataEnabler;
            ...
            if (original.expression == Gs2EnhanceUnleashRateModelMetadataEnabler.Expression.In || original.expression == Gs2EnhanceUnleashRateModelMetadataEnabler.Expression.NotIn) {
