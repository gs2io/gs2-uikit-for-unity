...
{
    [CustomEditor(typeof(Gs2RankingSubscribeUserUserIdSpriteTableSwitcher))]
    public class Gs2RankingSubscribeUserUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingSubscribeUserUserIdSpriteTableSwitcher;
