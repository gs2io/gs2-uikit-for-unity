...
{
    [CustomEditor(typeof(Gs2RankingSubscribeUserTargetUserIdSpriteTableSwitcher))]
    public class Gs2RankingSubscribeUserTargetUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingSubscribeUserTargetUserIdSpriteTableSwitcher;
