...
{
    [CustomEditor(typeof(Gs2RankingScoreScorerUserIdSpriteTableSwitcher))]
    public class Gs2RankingScoreScorerUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreScorerUserIdSpriteTableSwitcher;
