...
{
    [CustomEditor(typeof(Gs2RankingScoreCategoryNameSpriteSwitcher))]
    public class Gs2RankingScoreCategoryNameSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreCategoryNameSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingScoreCategoryNameSpriteSwitcher.Expression.In || original.expression == Gs2RankingScoreCategoryNameSpriteSwitcher.Expression.NotIn) {
