...
{
    [CustomEditor(typeof(Gs2RankingSubscribeUserUserIdSpriteSwitcher))]
    public class Gs2RankingSubscribeUserUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingSubscribeUserUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingSubscribeUserUserIdSpriteSwitcher.Expression.In || original.expression == Gs2RankingSubscribeUserUserIdSpriteSwitcher.Expression.NotIn) {
