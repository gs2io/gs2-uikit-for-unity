...
{
    [CustomEditor(typeof(Gs2RankingScoreUserIdSpriteSwitcher))]
    public class Gs2RankingScoreUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingScoreUserIdSpriteSwitcher.Expression.In || original.expression == Gs2RankingScoreUserIdSpriteSwitcher.Expression.NotIn) {
