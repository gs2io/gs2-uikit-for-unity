...
{
    [CustomEditor(typeof(Gs2RankingScoreUniqueIdSpriteTableSwitcher))]
    public class Gs2RankingScoreUniqueIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreUniqueIdSpriteTableSwitcher;
