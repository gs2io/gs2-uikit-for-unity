...
{
    [CustomEditor(typeof(Gs2RankingScoreUserIdSpriteTableSwitcher))]
    public class Gs2RankingScoreUserIdSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreUserIdSpriteTableSwitcher;
