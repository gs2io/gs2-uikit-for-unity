...
{
    [CustomEditor(typeof(Gs2RankingScoreScoreSpriteSwitcher))]
    public class Gs2RankingScoreScoreSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreScoreSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingScoreScoreSpriteSwitcher.Expression.In || original.expression == Gs2RankingScoreScoreSpriteSwitcher.Expression.NotIn) {
