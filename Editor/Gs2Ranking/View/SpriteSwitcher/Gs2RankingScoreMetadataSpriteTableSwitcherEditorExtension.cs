...
{
    [CustomEditor(typeof(Gs2RankingScoreMetadataSpriteTableSwitcher))]
    public class Gs2RankingScoreMetadataSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreMetadataSpriteTableSwitcher;
