...
{
    [CustomEditor(typeof(Gs2RankingScoreUniqueIdSpriteSwitcher))]
    public class Gs2RankingScoreUniqueIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreUniqueIdSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingScoreUniqueIdSpriteSwitcher.Expression.In || original.expression == Gs2RankingScoreUniqueIdSpriteSwitcher.Expression.NotIn) {
