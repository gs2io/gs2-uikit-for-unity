...
{
    [CustomEditor(typeof(Gs2RankingScoreCategoryNameSpriteTableSwitcher))]
    public class Gs2RankingScoreCategoryNameSpriteTableSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreCategoryNameSpriteTableSwitcher;
