...
{
    [CustomEditor(typeof(Gs2RankingScoreMetadataSpriteSwitcher))]
    public class Gs2RankingScoreMetadataSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreMetadataSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingScoreMetadataSpriteSwitcher.Expression.In || original.expression == Gs2RankingScoreMetadataSpriteSwitcher.Expression.NotIn) {
