...
{
    [CustomEditor(typeof(Gs2RankingScoreScorerUserIdSpriteSwitcher))]
    public class Gs2RankingScoreScorerUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreScorerUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingScoreScorerUserIdSpriteSwitcher.Expression.In || original.expression == Gs2RankingScoreScorerUserIdSpriteSwitcher.Expression.NotIn) {
