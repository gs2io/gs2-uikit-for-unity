...
{
    [CustomEditor(typeof(Gs2RankingSubscribeUserTargetUserIdSpriteSwitcher))]
    public class Gs2RankingSubscribeUserTargetUserIdSpriteSwitcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingSubscribeUserTargetUserIdSpriteSwitcher;
            ...
            if (original.expression == Gs2RankingSubscribeUserTargetUserIdSpriteSwitcher.Expression.In || original.expression == Gs2RankingSubscribeUserTargetUserIdSpriteSwitcher.Expression.NotIn) {
