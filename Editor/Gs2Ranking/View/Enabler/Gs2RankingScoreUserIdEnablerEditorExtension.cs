...
{
    [CustomEditor(typeof(Gs2RankingScoreUserIdEnabler))]
    public class Gs2RankingScoreUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreUserIdEnabler;
            ...
            if (original.expression == Gs2RankingScoreUserIdEnabler.Expression.In || original.expression == Gs2RankingScoreUserIdEnabler.Expression.NotIn) {
