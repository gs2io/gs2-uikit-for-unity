...
{
    [CustomEditor(typeof(Gs2RankingScoreUniqueIdEnabler))]
    public class Gs2RankingScoreUniqueIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreUniqueIdEnabler;
            ...
            if (original.expression == Gs2RankingScoreUniqueIdEnabler.Expression.In || original.expression == Gs2RankingScoreUniqueIdEnabler.Expression.NotIn) {
