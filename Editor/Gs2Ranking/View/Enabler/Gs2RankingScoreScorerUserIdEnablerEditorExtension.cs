...
{
    [CustomEditor(typeof(Gs2RankingScoreScorerUserIdEnabler))]
    public class Gs2RankingScoreScorerUserIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreScorerUserIdEnabler;
            ...
            if (original.expression == Gs2RankingScoreScorerUserIdEnabler.Expression.In || original.expression == Gs2RankingScoreScorerUserIdEnabler.Expression.NotIn) {
