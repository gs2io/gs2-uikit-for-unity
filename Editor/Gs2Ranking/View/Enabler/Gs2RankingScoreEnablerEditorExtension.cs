...
{
    [CustomEditor(typeof(Gs2RankingScoreEnabler))]
    public class Gs2RankingScoreEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreEnabler;
