...
{
    [CustomEditor(typeof(Gs2RankingSubscribeUserEnabler))]
    public class Gs2RankingSubscribeUserEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingSubscribeUserEnabler;
