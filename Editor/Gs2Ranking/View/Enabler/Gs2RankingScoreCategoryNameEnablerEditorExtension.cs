...
namespace Gs2.Unity.UiKit.Gs2Ranking.Enabler.Editor
{
    ...
    public class Gs2RankingScoreCategoryNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2RankingScoreCategoryNameEnabler;
            ...
            if (original.expression == Gs2RankingScoreCategoryNameEnabler.Expression.In || original.expression == Gs2RankingScoreCategoryNameEnabler.Expression.NotIn) {
