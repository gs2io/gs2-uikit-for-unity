...
{
    [CustomEditor(typeof(Gs2GatewayWebSocketSessionConnectionIdEnabler))]
    public class Gs2GatewayWebSocketSessionConnectionIdEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2GatewayWebSocketSessionConnectionIdEnabler;
            ...
            if (original.expression == Gs2GatewayWebSocketSessionConnectionIdEnabler.Expression.In || original.expression == Gs2GatewayWebSocketSessionConnectionIdEnabler.Expression.NotIn) {
