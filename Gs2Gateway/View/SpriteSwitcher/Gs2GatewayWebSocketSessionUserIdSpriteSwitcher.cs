...
namespace Gs2.Unity.UiKit.Gs2Gateway.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Gateway/WebSocketSession/View/SpriteSwitcher/Properties/UserId/Gs2GatewayWebSocketSessionUserIdSpriteSwitcher")]
    public partial class Gs2GatewayWebSocketSessionUserIdSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.WebSocketSession != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyUserIds.Contains(_fetcher.WebSocketSession.UserId)) {
    ...
    public partial class Gs2GatewayWebSocketSessionUserIdSpriteSwitcher
    {
