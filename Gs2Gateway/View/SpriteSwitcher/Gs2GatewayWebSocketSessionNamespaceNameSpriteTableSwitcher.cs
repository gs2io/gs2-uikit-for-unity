...
namespace Gs2.Unity.UiKit.Gs2Gateway.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Gateway/WebSocketSession/View/SpriteSwitcher/Properties/NamespaceName/Gs2GatewayWebSocketSessionNamespaceNameSpriteTableSwitcher")]
    public partial class Gs2GatewayWebSocketSessionNamespaceNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.WebSocketSession != null)
            {
                if (sprites.Count(v => v.value == _fetcher.WebSocketSession.NamespaceName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.WebSocketSession.NamespaceName).sprite);
                }
                else {
    ...
    public partial class Gs2GatewayWebSocketSessionNamespaceNameSpriteTableSwitcher
    {
