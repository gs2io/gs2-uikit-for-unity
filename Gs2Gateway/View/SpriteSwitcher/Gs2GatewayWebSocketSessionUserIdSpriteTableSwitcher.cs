...
namespace Gs2.Unity.UiKit.Gs2Gateway.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Gateway/WebSocketSession/View/SpriteSwitcher/Properties/UserId/Gs2GatewayWebSocketSessionUserIdSpriteTableSwitcher")]
    public partial class Gs2GatewayWebSocketSessionUserIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.WebSocketSession != null)
            {
                if (sprites.Count(v => v.value == _fetcher.WebSocketSession.UserId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.WebSocketSession.UserId).sprite);
                }
                else {
    ...
    public partial class Gs2GatewayWebSocketSessionUserIdSpriteTableSwitcher
    {
