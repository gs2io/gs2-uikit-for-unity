...
namespace Gs2.Unity.UiKit.Gs2Gateway.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Gateway/WebSocketSession/View/SpriteSwitcher/Properties/ConnectionId/Gs2GatewayWebSocketSessionConnectionIdSpriteTableSwitcher")]
    public partial class Gs2GatewayWebSocketSessionConnectionIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.WebSocketSession != null)
            {
                if (sprites.Count(v => v.value == _fetcher.WebSocketSession.ConnectionId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.WebSocketSession.ConnectionId).sprite);
                }
                else {
    ...
    public partial class Gs2GatewayWebSocketSessionConnectionIdSpriteTableSwitcher
    {
