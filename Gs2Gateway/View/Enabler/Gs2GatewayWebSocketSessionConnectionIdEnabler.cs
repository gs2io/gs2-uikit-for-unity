...
namespace Gs2.Unity.UiKit.Gs2Gateway.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Gateway/WebSocketSession/View/Enabler/Properties/ConnectionId/Gs2GatewayWebSocketSessionConnectionIdEnabler")]
            ...
            if (_fetcher.Fetched && _fetcher.WebSocketSession != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        target.SetActive(_fetcher.WebSocketSession.ConnectionId.StartsWith(enableConnectionId));
                        break;
                    case Expression.EndsWith:
                        target.SetActive(_fetcher.WebSocketSession.ConnectionId.EndsWith(enableConnectionId));
                        break;
                }
            }
            else
