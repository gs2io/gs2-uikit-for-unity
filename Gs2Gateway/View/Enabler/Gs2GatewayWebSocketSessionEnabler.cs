...
namespace Gs2.Unity.UiKit.Gs2Gateway
{
	...
	[AddComponentMenu("GS2 UIKit/Gateway/WebSocketSession/View/Enabler/Gs2GatewayWebSocketSessionEnabler")]
    public partial class Gs2GatewayWebSocketSessionEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
    ...
    public partial class Gs2GatewayWebSocketSessionEnabler
    {
