...
{
    [CustomEditor(typeof(Gs2InboxMessageNameEnabler))]
    public class Gs2InboxMessageNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageNameEnabler;
            ...
            if (original.expression == Gs2InboxMessageNameEnabler.Expression.In || original.expression == Gs2InboxMessageNameEnabler.Expression.NotIn) {
