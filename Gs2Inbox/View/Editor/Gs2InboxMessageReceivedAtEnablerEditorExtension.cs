...
{
    [CustomEditor(typeof(Gs2InboxMessageReceivedAtEnabler))]
    public class Gs2InboxMessageReceivedAtEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2InboxMessageReceivedAtEnabler;
            ...
            if (original.expression == Gs2InboxMessageReceivedAtEnabler.Expression.In || original.expression == Gs2InboxMessageReceivedAtEnabler.Expression.NotIn) {
