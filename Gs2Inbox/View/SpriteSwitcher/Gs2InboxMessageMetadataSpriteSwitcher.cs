...
namespace Gs2.Unity.UiKit.Gs2Inbox.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/SpriteSwitcher/Properties/Metadata/Gs2InboxMessageMetadataSpriteSwitcher")]
    public partial class Gs2InboxMessageMetadataSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Message != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyMetadatas.Contains(_fetcher.Message.Metadata)) {
    ...
    public partial class Gs2InboxMessageMetadataSpriteSwitcher
    {
