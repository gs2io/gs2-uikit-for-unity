...
namespace Gs2.Unity.UiKit.Gs2Inbox
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/SpriteSwitcher/Properties/ReceivedAt/Gs2InboxMessageReceivedAtSpriteSwitcher")]
    public partial class Gs2InboxMessageReceivedAtSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Message != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyReceivedAts.Contains(_fetcher.Message.ReceivedAt)) {
                    ...
                    case Expression.Less:
                        if (applyReceivedAt > _fetcher.Message.ReceivedAt) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
    ...
    public partial class Gs2InboxMessageReceivedAtSpriteSwitcher
    {
