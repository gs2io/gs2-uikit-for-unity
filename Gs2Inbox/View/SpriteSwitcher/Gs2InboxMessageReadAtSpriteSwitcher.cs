...
namespace Gs2.Unity.UiKit.Gs2Inbox
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/SpriteSwitcher/Properties/ReadAt/Gs2InboxMessageReadAtSpriteSwitcher")]
    public partial class Gs2InboxMessageReadAtSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Message != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyReadAts.Contains(_fetcher.Message.ReadAt)) {
                    ...
                    case Expression.Less:
                        if (applyReadAt > _fetcher.Message.ReadAt) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
    ...
    public partial class Gs2InboxMessageReadAtSpriteSwitcher
    {
