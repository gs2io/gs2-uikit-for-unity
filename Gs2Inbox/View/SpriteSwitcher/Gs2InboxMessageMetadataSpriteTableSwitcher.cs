...
namespace Gs2.Unity.UiKit.Gs2Inbox.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Inbox/Message/View/SpriteSwitcher/Properties/Metadata/Gs2InboxMessageMetadataSpriteTableSwitcher")]
    public partial class Gs2InboxMessageMetadataSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Message != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Message.Metadata) > 0) {
    ...
    public partial class Gs2InboxMessageMetadataSpriteTableSwitcher
    {
