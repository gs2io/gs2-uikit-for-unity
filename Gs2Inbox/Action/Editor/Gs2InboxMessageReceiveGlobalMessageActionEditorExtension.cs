        ...
        public override void OnInspectorGUI() {
            ...
            if (context == null) {
                ...
                if (context.transform.parent.GetComponent<Gs2InboxOwnMessageList>() != null) {
                    ...
                    EditorGUILayout.ObjectField("OwnMessage", context.Message, typeof(OwnMessage), false);
                    EditorGUI.indentLevel++;
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("onReceiveGlobalMessageComplete"), true);
