...
namespace Gs2.Unity.UiKit.Gs2Showcase.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/Showcase/View/SpriteSwitcher/Properties/Metadata/Gs2ShowcaseShowcaseMetadataSpriteSwitcher")]
    public partial class Gs2ShowcaseShowcaseMetadataSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Showcase != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyMetadatas.Contains(_fetcher.Showcase.Metadata)) {
                    ...
                    case Expression.StartsWith:
                        if (applyMetadata.StartsWith(_fetcher.Showcase.Metadata)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyMetadata.EndsWith(_fetcher.Showcase.Metadata)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2ShowcaseShowcaseMetadataSpriteSwitcher
    {
