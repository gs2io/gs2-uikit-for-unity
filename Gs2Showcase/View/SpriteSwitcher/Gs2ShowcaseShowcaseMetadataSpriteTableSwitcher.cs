...
namespace Gs2.Unity.UiKit.Gs2Showcase.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/Showcase/View/SpriteSwitcher/Properties/Metadata/Gs2ShowcaseShowcaseMetadataSpriteTableSwitcher")]
    public partial class Gs2ShowcaseShowcaseMetadataSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Showcase != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Showcase.Metadata) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Showcase.Metadata).sprite);
                }
                else {
    ...
    public partial class Gs2ShowcaseShowcaseMetadataSpriteTableSwitcher
    {
