...
namespace Gs2.Unity.UiKit.Gs2Showcase.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/DisplayItem/View/SpriteSwitcher/Properties/Type/Gs2ShowcaseDisplayItemTypeSpriteTableSwitcher")]
    public partial class Gs2ShowcaseDisplayItemTypeSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.DisplayItem != null)
            {
                if (sprites.Count(v => v.value == _fetcher.DisplayItem.Type) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.DisplayItem.Type).sprite);
                }
                else {
    ...
    public partial class Gs2ShowcaseDisplayItemTypeSpriteTableSwitcher
    {
