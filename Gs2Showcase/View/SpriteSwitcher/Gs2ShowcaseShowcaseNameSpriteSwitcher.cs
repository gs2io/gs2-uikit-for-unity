...
namespace Gs2.Unity.UiKit.Gs2Showcase.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/Showcase/View/SpriteSwitcher/Properties/Name/Gs2ShowcaseShowcaseNameSpriteSwitcher")]
    public partial class Gs2ShowcaseShowcaseNameSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Showcase != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        if (applyName.StartsWith(_fetcher.Showcase.Name)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyName.EndsWith(_fetcher.Showcase.Name)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2ShowcaseShowcaseNameSpriteSwitcher
    {
