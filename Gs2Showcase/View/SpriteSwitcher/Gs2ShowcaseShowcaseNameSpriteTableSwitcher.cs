...
namespace Gs2.Unity.UiKit.Gs2Showcase.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/Showcase/View/SpriteSwitcher/Properties/Name/Gs2ShowcaseShowcaseNameSpriteTableSwitcher")]
    public partial class Gs2ShowcaseShowcaseNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Showcase != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Showcase.Name) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Showcase.Name).sprite);
                }
                else {
    ...
    public partial class Gs2ShowcaseShowcaseNameSpriteTableSwitcher
    {
