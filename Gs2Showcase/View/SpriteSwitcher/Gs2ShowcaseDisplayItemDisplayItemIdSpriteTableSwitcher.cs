...
namespace Gs2.Unity.UiKit.Gs2Showcase.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/DisplayItem/View/SpriteSwitcher/Properties/DisplayItemId/Gs2ShowcaseDisplayItemDisplayItemIdSpriteTableSwitcher")]
    public partial class Gs2ShowcaseDisplayItemDisplayItemIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.DisplayItem != null)
            {
                if (sprites.Count(v => v.value == _fetcher.DisplayItem.DisplayItemId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.DisplayItem.DisplayItemId).sprite);
                }
                else {
    ...
    public partial class Gs2ShowcaseDisplayItemDisplayItemIdSpriteTableSwitcher
    {
