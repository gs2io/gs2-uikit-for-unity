...
namespace Gs2.Unity.UiKit.Gs2Showcase.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/DisplayItem/View/Enabler/Properties/Type/Gs2ShowcaseDisplayItemTypeEnabler")]
    public partial class Gs2ShowcaseDisplayItemTypeEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.DisplayItem != null)
            {
                ...
                {
                    case Expression.In:
                        target.SetActive(enableTypes.Contains(_fetcher.DisplayItem.Type));
                        break;
                    case Expression.NotIn:
                        target.SetActive(!enableTypes.Contains(_fetcher.DisplayItem.Type));
                        break;
                    case Expression.StartsWith:
                        target.SetActive(enableType.StartsWith(_fetcher.DisplayItem.Type));
                        break;
                    case Expression.EndsWith:
                        target.SetActive(enableType.EndsWith(_fetcher.DisplayItem.Type));
                        break;
                }
            }
            else
    ...
    public partial class Gs2ShowcaseDisplayItemTypeEnabler
    {
