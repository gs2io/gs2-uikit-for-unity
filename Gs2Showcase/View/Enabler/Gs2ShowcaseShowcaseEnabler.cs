...
namespace Gs2.Unity.UiKit.Gs2Showcase
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/Showcase/View/Enabler/Gs2ShowcaseShowcaseEnabler")]
    public partial class Gs2ShowcaseShowcaseEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
    ...
    public partial class Gs2ShowcaseShowcaseEnabler
    {
