...
namespace Gs2.Unity.UiKit.Gs2Showcase.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/Showcase/View/Enabler/Properties/Name/Gs2ShowcaseShowcaseNameEnabler")]
            ...
            if (_fetcher.Fetched && _fetcher.Showcase != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        target.SetActive(_fetcher.Showcase.Name.StartsWith(enableName));
                        break;
                    case Expression.EndsWith:
                        target.SetActive(_fetcher.Showcase.Name.EndsWith(enableName));
                        break;
                }
            }
            else
