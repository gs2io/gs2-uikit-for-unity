...
namespace Gs2.Unity.UiKit.Gs2Showcase.Editor
{
    ...
    public class Gs2ShowcaseSalesItemNameEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ShowcaseSalesItemNameEnabler;
            ...
            if (original.expression == Gs2ShowcaseSalesItemNameEnabler.Expression.In || original.expression == Gs2ShowcaseSalesItemNameEnabler.Expression.NotIn) {
