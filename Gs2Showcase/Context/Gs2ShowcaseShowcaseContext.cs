...
namespace Gs2.Unity.UiKit.Gs2Showcase.Context
{
	...
	[AddComponentMenu("GS2 UIKit/Showcase/Showcase/Context/Gs2ShowcaseShowcaseContext")]
    public partial class Gs2ShowcaseShowcaseContext : MonoBehaviour
    {
        public void Start() {
            if (Showcase == null) {
                Debug.LogError($"{gameObject.GetFullPath()}: Showcase is not set in Gs2ShowcaseShowcaseContext.");
            }
        }
