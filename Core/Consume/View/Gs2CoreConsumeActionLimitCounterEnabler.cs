...
namespace Gs2.Unity.UiKit.Gs2Core
{
    ...
    public partial class Gs2CoreConsumeActionLimitCounterEnabler : MonoBehaviour
    {
            ...
            while (true) {
                ...
                if (_context.ConsumeActions != null && _context.ConsumeActions.Count(v => v.Action == "Gs2Limit:CountUpByUserId") > 0) {
                    ...
                    if (ahead) {
                        ...
                        else if (counter.Count + request.CountUpValue >= request.MaxValue) {
    ...
    public partial class Gs2CoreConsumeActionLimitCounterEnabler
    {
