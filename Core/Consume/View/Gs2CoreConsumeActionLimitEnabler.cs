...
namespace Gs2.Unity.UiKit.Gs2Core
{
	...
	[AddComponentMenu("GS2 UIKit/Core/ConsumeAction/View/Gs2CoreConsumeActionLimitEnabler")]
    public partial class Gs2CoreConsumeActionLimitEnabler : MonoBehaviour
    {
        public IEnumerator Process() {
            while (true) {
                if (_context.ConsumeActions != null && _context.ConsumeActions.Count(v => v.Action == "Gs2Limit:CountUpByUserId") > 0) {
                    var request = CountUpByUserIdRequest.FromJson(JsonMapper.ToObject(_context.ConsumeActions.First(v => v.Action == "Gs2Limit:CountUpByUserId").Request));
                    ...
                    if (request.CountUpValue <= 1) {
                        target.SetActive(this.denyReachMin);
                    } else if (future.Result.Count + request.CountUpValue >= request.MaxValue) {
    ...
    public partial class Gs2CoreConsumeActionLimitEnabler
    {
