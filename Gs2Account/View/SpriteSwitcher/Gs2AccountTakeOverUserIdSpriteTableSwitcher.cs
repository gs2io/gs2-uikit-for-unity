...
namespace Gs2.Unity.UiKit.Gs2Account.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Account/TakeOver/View/SpriteSwitcher/Properties/UserId/Gs2AccountTakeOverUserIdSpriteTableSwitcher")]
    public partial class Gs2AccountTakeOverUserIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.TakeOver != null)
            {
                if (sprites.Count(v => v.value == _fetcher.TakeOver.UserId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.TakeOver.UserId).sprite);
                }
                else {
    ...
    public partial class Gs2AccountTakeOverUserIdSpriteTableSwitcher
    {
