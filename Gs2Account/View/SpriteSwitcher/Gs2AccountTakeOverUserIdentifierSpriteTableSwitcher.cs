...
namespace Gs2.Unity.UiKit.Gs2Account.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Account/TakeOver/View/SpriteSwitcher/Properties/UserIdentifier/Gs2AccountTakeOverUserIdentifierSpriteTableSwitcher")]
    public partial class Gs2AccountTakeOverUserIdentifierSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.TakeOver != null)
            {
                if (sprites.Count(v => v.value == _fetcher.TakeOver.UserIdentifier) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.TakeOver.UserIdentifier).sprite);
                }
                else {
    ...
    public partial class Gs2AccountTakeOverUserIdentifierSpriteTableSwitcher
    {
