...
namespace Gs2.Unity.UiKit.Gs2Account.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Account/Account/View/SpriteSwitcher/Properties/UserId/Gs2AccountAccountUserIdSpriteSwitcher")]
    public partial class Gs2AccountAccountUserIdSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Account != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyUserIds.Contains(_fetcher.Account.UserId)) {
                    ...
                    case Expression.StartsWith:
                        if (_fetcher.Account.UserId.StartsWith(applyUserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (_fetcher.Account.UserId.EndsWith(applyUserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2AccountAccountUserIdSpriteSwitcher
    {
