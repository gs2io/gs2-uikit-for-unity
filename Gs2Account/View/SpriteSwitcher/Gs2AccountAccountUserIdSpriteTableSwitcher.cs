...
namespace Gs2.Unity.UiKit.Gs2Account.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Account/Account/View/SpriteSwitcher/Properties/UserId/Gs2AccountAccountUserIdSpriteTableSwitcher")]
    public partial class Gs2AccountAccountUserIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Account != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Account.UserId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Account.UserId).sprite);
                }
                else {
    ...
    public partial class Gs2AccountAccountUserIdSpriteTableSwitcher
    {
