...
namespace Gs2.Unity.UiKit.Gs2Account.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Account/TakeOver/View/SpriteSwitcher/Properties/UserId/Gs2AccountTakeOverUserIdSpriteSwitcher")]
    public partial class Gs2AccountTakeOverUserIdSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.TakeOver != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyUserIds.Contains(_fetcher.TakeOver.UserId)) {
                    ...
                    case Expression.StartsWith:
                        if (applyUserId.StartsWith(_fetcher.TakeOver.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyUserId.EndsWith(_fetcher.TakeOver.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2AccountTakeOverUserIdSpriteSwitcher
    {
