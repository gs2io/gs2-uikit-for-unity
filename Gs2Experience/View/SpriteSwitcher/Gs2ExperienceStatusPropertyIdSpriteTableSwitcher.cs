...
namespace Gs2.Unity.UiKit.Gs2Experience.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/Status/View/SpriteSwitcher/Properties/PropertyId/Gs2ExperienceStatusPropertyIdSpriteTableSwitcher")]
    public partial class Gs2ExperienceStatusPropertyIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Status != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Status.PropertyId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Status.PropertyId).sprite);
                }
                else {
    ...
    public partial class Gs2ExperienceStatusPropertyIdSpriteTableSwitcher
    {
