...
namespace Gs2.Unity.UiKit.Gs2Experience
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/Status/View/SpriteSwitcher/Properties/ExperienceValue/Gs2ExperienceStatusExperienceValueSpriteSwitcher")]
    public partial class Gs2ExperienceStatusExperienceValueSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Status != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyExperienceValues.Contains(_fetcher.Status.ExperienceValue)) {
                    ...
                    case Expression.Less:
                        if (applyExperienceValue > _fetcher.Status.ExperienceValue) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
    ...
    public partial class Gs2ExperienceStatusExperienceValueSpriteSwitcher
    {
