...
namespace Gs2.Unity.UiKit.Gs2Experience.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Experience/Status/View/SpriteSwitcher/Properties/ExperienceName/Gs2ExperienceStatusExperienceNameSpriteTableSwitcher")]
    public partial class Gs2ExperienceStatusExperienceNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Status != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Status.ExperienceName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Status.ExperienceName).sprite);
                }
                else {
    ...
    public partial class Gs2ExperienceStatusExperienceNameSpriteTableSwitcher
    {
