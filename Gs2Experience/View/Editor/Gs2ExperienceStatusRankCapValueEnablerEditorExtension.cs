...
{
    [CustomEditor(typeof(Gs2ExperienceStatusRankCapValueEnabler))]
    public class Gs2ExperienceStatusRankCapValueEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2ExperienceStatusRankCapValueEnabler;
            ...
            if (original.expression == Gs2ExperienceStatusRankCapValueEnabler.Expression.In || original.expression == Gs2ExperienceStatusRankCapValueEnabler.Expression.NotIn) {
