...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Mold/View/SpriteSwitcher/Properties/UserId/Gs2FormationMoldUserIdSpriteTableSwitcher")]
    public partial class Gs2FormationMoldUserIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Mold != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Mold.UserId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Mold.UserId).sprite);
                }
                else {
    ...
    public partial class Gs2FormationMoldUserIdSpriteTableSwitcher
    {
