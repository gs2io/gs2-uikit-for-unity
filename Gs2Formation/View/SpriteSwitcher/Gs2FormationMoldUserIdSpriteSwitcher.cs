...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Mold/View/SpriteSwitcher/Properties/UserId/Gs2FormationMoldUserIdSpriteSwitcher")]
    public partial class Gs2FormationMoldUserIdSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Mold != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        if (applyUserId.StartsWith(_fetcher.Mold.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyUserId.EndsWith(_fetcher.Mold.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2FormationMoldUserIdSpriteSwitcher
    {
