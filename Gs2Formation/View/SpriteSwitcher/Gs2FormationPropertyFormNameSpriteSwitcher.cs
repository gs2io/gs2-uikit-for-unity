...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
    ...
    public partial class Gs2FormationPropertyFormNameSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.PropertyForm != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        if (applyName.StartsWith(_fetcher.PropertyForm.Name)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyName.EndsWith(_fetcher.PropertyForm.Name)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2FormationPropertyFormNameSpriteSwitcher
    {
