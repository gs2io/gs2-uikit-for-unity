...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
    ...
    public partial class Gs2FormationPropertyFormNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.PropertyForm != null)
            {
                if (sprites.Count(v => v.value == _fetcher.PropertyForm.Name) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.PropertyForm.Name).sprite);
                }
                else {
    ...
    public partial class Gs2FormationPropertyFormNameSpriteTableSwitcher
    {
