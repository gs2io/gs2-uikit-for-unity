...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/PropertyForm/View/SpriteSwitcher/Properties/PropertyId/Gs2FormationPropertyFormPropertyIdSpriteSwitcher")]
    public partial class Gs2FormationPropertyFormPropertyIdSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.PropertyForm != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyPropertyIds.Contains(_fetcher.PropertyForm.PropertyId)) {
    ...
    public partial class Gs2FormationPropertyFormPropertyIdSpriteSwitcher
    {
