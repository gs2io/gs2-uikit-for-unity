...
namespace Gs2.Unity.UiKit.Gs2Formation
{
    ...
    public partial class Gs2FormationFormIndexSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Form != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyIndexes.Contains(_fetcher.Form.Index)) {
                    ...
                    case Expression.Less:
                        if (applyIndex > _fetcher.Form.Index) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
    ...
    public partial class Gs2FormationFormIndexSpriteSwitcher
    {
