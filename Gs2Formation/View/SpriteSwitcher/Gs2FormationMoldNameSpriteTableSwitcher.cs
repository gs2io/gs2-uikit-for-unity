...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/Mold/View/SpriteSwitcher/Properties/Name/Gs2FormationMoldNameSpriteTableSwitcher")]
    public partial class Gs2FormationMoldNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Mold != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Mold.Name) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Mold.Name).sprite);
                }
                else {
    ...
    public partial class Gs2FormationMoldNameSpriteTableSwitcher
    {
