...
namespace Gs2.Unity.UiKit.Gs2Formation.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Formation/PropertyForm/View/SpriteSwitcher/Properties/PropertyId/Gs2FormationPropertyFormPropertyIdSpriteTableSwitcher")]
    public partial class Gs2FormationPropertyFormPropertyIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.PropertyForm != null)
            {
                if (sprites.Count(v => v.value == _fetcher.PropertyForm.PropertyId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.PropertyForm.PropertyId).sprite);
                }
                else {
    ...
    public partial class Gs2FormationPropertyFormPropertyIdSpriteTableSwitcher
    {
