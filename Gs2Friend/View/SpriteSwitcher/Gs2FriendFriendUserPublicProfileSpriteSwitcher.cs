...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FriendUser/View/SpriteSwitcher/Properties/PublicProfile/Gs2FriendFriendUserPublicProfileSpriteSwitcher")]
    public partial class Gs2FriendFriendUserPublicProfileSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.FriendUser != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyPublicProfiles.Contains(_fetcher.FriendUser.PublicProfile)) {
    ...
    public partial class Gs2FriendFriendUserPublicProfileSpriteSwitcher
    {
