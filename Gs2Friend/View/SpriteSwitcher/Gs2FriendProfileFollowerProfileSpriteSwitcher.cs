...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/View/SpriteSwitcher/Properties/FollowerProfile/Gs2FriendProfileFollowerProfileSpriteSwitcher")]
    public partial class Gs2FriendProfileFollowerProfileSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Profile != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyFollowerProfiles.Contains(_fetcher.Profile.FollowerProfile)) {
                    ...
                    case Expression.StartsWith:
                        if (applyFollowerProfile.StartsWith(_fetcher.Profile.FollowerProfile)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyFollowerProfile.EndsWith(_fetcher.Profile.FollowerProfile)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2FriendProfileFollowerProfileSpriteSwitcher
    {
