...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FriendUser/View/SpriteSwitcher/Properties/UserId/Gs2FriendFriendUserUserIdSpriteTableSwitcher")]
    public partial class Gs2FriendFriendUserUserIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.FriendUser != null)
            {
                if (sprites.Count(v => v.value == _fetcher.FriendUser.UserId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.FriendUser.UserId).sprite);
                }
                else {
    ...
    public partial class Gs2FriendFriendUserUserIdSpriteTableSwitcher
    {
