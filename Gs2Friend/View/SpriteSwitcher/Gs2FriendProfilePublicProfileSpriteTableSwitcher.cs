...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/View/SpriteSwitcher/Properties/PublicProfile/Gs2FriendProfilePublicProfileSpriteTableSwitcher")]
    public partial class Gs2FriendProfilePublicProfileSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Profile != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Profile.PublicProfile) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Profile.PublicProfile).sprite);
                }
                else {
    ...
    public partial class Gs2FriendProfilePublicProfileSpriteTableSwitcher
    {
