...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FriendUser/View/SpriteSwitcher/Properties/PublicProfile/Gs2FriendFriendUserPublicProfileSpriteTableSwitcher")]
    public partial class Gs2FriendFriendUserPublicProfileSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.FriendUser != null)
            {
                if (sprites.Count(v => v.value == _fetcher.FriendUser.PublicProfile) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.FriendUser.PublicProfile).sprite);
                }
                else {
    ...
    public partial class Gs2FriendFriendUserPublicProfileSpriteTableSwitcher
    {
