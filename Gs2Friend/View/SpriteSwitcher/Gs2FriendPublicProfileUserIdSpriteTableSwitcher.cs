...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/PublicProfile/View/SpriteSwitcher/Properties/UserId/Gs2FriendPublicProfileUserIdSpriteTableSwitcher")]
    public partial class Gs2FriendPublicProfileUserIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.PublicProfile != null)
            {
                if (sprites.Count(v => v.value == _fetcher.PublicProfile.UserId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.PublicProfile.UserId).sprite);
                }
                else {
    ...
    public partial class Gs2FriendPublicProfileUserIdSpriteTableSwitcher
    {
