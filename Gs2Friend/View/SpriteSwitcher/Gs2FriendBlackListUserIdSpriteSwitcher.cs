...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/BlackList/View/SpriteSwitcher/Properties/UserId/Gs2FriendBlackListUserIdSpriteSwitcher")]
    public partial class Gs2FriendBlackListUserIdSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.BlackList != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        if (applyUserId.StartsWith(_fetcher.BlackList.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyUserId.EndsWith(_fetcher.BlackList.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2FriendBlackListUserIdSpriteSwitcher
    {
