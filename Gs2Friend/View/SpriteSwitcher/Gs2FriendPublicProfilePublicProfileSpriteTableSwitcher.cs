...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/PublicProfile/View/SpriteSwitcher/Properties/PublicProfile/Gs2FriendPublicProfilePublicProfileSpriteTableSwitcher")]
    public partial class Gs2FriendPublicProfilePublicProfileSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.PublicProfile != null)
            {
                if (sprites.Count(v => v.value == _fetcher.PublicProfile.PublicProfile) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.PublicProfile.PublicProfile).sprite);
                }
                else {
    ...
    public partial class Gs2FriendPublicProfilePublicProfileSpriteTableSwitcher
    {
