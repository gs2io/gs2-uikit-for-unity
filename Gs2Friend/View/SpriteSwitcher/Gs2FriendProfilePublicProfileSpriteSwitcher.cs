...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/View/SpriteSwitcher/Properties/PublicProfile/Gs2FriendProfilePublicProfileSpriteSwitcher")]
    public partial class Gs2FriendProfilePublicProfileSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Profile != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        if (applyPublicProfile.StartsWith(_fetcher.Profile.PublicProfile)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyPublicProfile.EndsWith(_fetcher.Profile.PublicProfile)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2FriendProfilePublicProfileSpriteSwitcher
    {
