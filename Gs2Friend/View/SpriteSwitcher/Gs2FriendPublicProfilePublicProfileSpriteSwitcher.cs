...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/PublicProfile/View/SpriteSwitcher/Properties/PublicProfile/Gs2FriendPublicProfilePublicProfileSpriteSwitcher")]
    public partial class Gs2FriendPublicProfilePublicProfileSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.PublicProfile != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyPublicProfiles.Contains(_fetcher.PublicProfile.PublicProfile)) {
                    ...
                    case Expression.StartsWith:
                        if (applyPublicProfile.StartsWith(_fetcher.PublicProfile.PublicProfile)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyPublicProfile.EndsWith(_fetcher.PublicProfile.PublicProfile)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2FriendPublicProfilePublicProfileSpriteSwitcher
    {
