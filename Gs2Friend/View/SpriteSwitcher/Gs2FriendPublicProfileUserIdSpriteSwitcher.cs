...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/PublicProfile/View/SpriteSwitcher/Properties/UserId/Gs2FriendPublicProfileUserIdSpriteSwitcher")]
    public partial class Gs2FriendPublicProfileUserIdSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.PublicProfile != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyUserIds.Contains(_fetcher.PublicProfile.UserId)) {
                    ...
                    case Expression.StartsWith:
                        if (_fetcher.PublicProfile.UserId.StartsWith(applyUserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (_fetcher.PublicProfile.UserId.EndsWith(applyUserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2FriendPublicProfileUserIdSpriteSwitcher
    {
