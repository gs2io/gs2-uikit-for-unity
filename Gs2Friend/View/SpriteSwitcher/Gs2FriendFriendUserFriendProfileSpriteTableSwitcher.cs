...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FriendUser/View/SpriteSwitcher/Properties/FriendProfile/Gs2FriendFriendUserFriendProfileSpriteTableSwitcher")]
    public partial class Gs2FriendFriendUserFriendProfileSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.FriendUser != null)
            {
                if (sprites.Count(v => v.value == _fetcher.FriendUser.FriendProfile) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.FriendUser.FriendProfile).sprite);
                }
                else {
    ...
    public partial class Gs2FriendFriendUserFriendProfileSpriteTableSwitcher
    {
