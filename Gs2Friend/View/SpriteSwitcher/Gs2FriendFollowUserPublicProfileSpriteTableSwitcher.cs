...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FollowUser/View/SpriteSwitcher/Properties/PublicProfile/Gs2FriendFollowUserPublicProfileSpriteTableSwitcher")]
    public partial class Gs2FriendFollowUserPublicProfileSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.FollowUser != null)
            {
                if (sprites.Count(v => v.value == _fetcher.FollowUser.PublicProfile) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.FollowUser.PublicProfile).sprite);
                }
                else {
    ...
    public partial class Gs2FriendFollowUserPublicProfileSpriteTableSwitcher
    {
