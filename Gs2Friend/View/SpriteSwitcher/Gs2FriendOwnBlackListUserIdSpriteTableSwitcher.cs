...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/BlackList/View/SpriteSwitcher/Properties/UserId/Gs2FriendOwnBlackListUserIdSpriteTableSwitcher")]
    public partial class Gs2FriendOwnBlackListUserIdSpriteTableSwitcher : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this.sprites.Count(v => v.value == _fetcher.BlackList.UserId) > 0) {
                this.onUpdate.Invoke(this.sprites.Find(v => v.value == _fetcher.BlackList.UserId).sprite);
            }
            else {
    ...
    public partial class Gs2FriendOwnBlackListUserIdSpriteTableSwitcher
    {
