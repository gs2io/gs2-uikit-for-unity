...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/View/SpriteSwitcher/Properties/FollowerProfile/Gs2FriendProfileFollowerProfileSpriteTableSwitcher")]
    public partial class Gs2FriendProfileFollowerProfileSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Profile != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Profile.FollowerProfile) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Profile.FollowerProfile).sprite);
                }
                else {
    ...
    public partial class Gs2FriendProfileFollowerProfileSpriteTableSwitcher
    {
