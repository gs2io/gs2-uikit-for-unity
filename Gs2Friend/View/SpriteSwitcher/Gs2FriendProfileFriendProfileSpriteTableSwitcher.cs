...
namespace Gs2.Unity.UiKit.Gs2Friend.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/Profile/View/SpriteSwitcher/Properties/FriendProfile/Gs2FriendProfileFriendProfileSpriteTableSwitcher")]
    public partial class Gs2FriendProfileFriendProfileSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Profile != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Profile.FriendProfile) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Profile.FriendProfile).sprite);
                }
                else {
    ...
    public partial class Gs2FriendProfileFriendProfileSpriteTableSwitcher
    {
