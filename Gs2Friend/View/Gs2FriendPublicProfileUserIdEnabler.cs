...
namespace Gs2.Unity.UiKit.Gs2Friend
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/PublicProfile/View/Properties/UserId/Gs2FriendPublicProfileUserIdEnabler")]
            ...
            if (_fetcher.Fetched && _fetcher.PublicProfile != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        target.SetActive(enableUserId.StartsWith(_fetcher.PublicProfile.UserId));
                        break;
                    case Expression.EndsWith:
                        target.SetActive(enableUserId.EndsWith(_fetcher.PublicProfile.UserId));
                        break;
                }
            }
            else
