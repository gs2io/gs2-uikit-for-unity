...
namespace Gs2.Unity.UiKit.Gs2Friend.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FriendUser/View/Enabler/Properties/FriendProfile/Gs2FriendFriendUserFriendProfileEnabler")]
            ...
            if (_fetcher.Fetched && _fetcher.FriendUser != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        target.SetActive(_fetcher.FriendUser.FriendProfile.StartsWith(enableFriendProfile));
                        break;
                    case Expression.EndsWith:
                        target.SetActive(_fetcher.FriendUser.FriendProfile.EndsWith(enableFriendProfile));
                        break;
                }
            }
            else
