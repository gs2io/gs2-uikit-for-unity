...
namespace Gs2.Unity.UiKit.Gs2Friend.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/BlackList/View/Enabler/Properties/UserId/Gs2FriendBlackListUserIdEnabler")]
    public partial class Gs2FriendBlackListUserIdEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.BlackList != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        target.SetActive(enableUserId.StartsWith(_fetcher.BlackList.UserId));
                        break;
                    case Expression.EndsWith:
                        target.SetActive(enableUserId.EndsWith(_fetcher.BlackList.UserId));
                        break;
                }
            }
            else
    ...
    public partial class Gs2FriendBlackListUserIdEnabler
    {
