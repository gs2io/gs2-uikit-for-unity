...
namespace Gs2.Unity.UiKit.Gs2Friend
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/FollowUser/View/Enabler/Gs2FriendFollowUserEnabler")]
    public partial class Gs2FriendFollowUserEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
