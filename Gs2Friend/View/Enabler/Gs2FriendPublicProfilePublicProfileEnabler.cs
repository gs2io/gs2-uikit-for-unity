...
namespace Gs2.Unity.UiKit.Gs2Friend.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/PublicProfile/View/Enabler/Properties/PublicProfile/Gs2FriendPublicProfilePublicProfileEnabler")]
            ...
            if (_fetcher.Fetched && _fetcher.PublicProfile != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        target.SetActive(_fetcher.PublicProfile.PublicProfile.StartsWith(enablePublicProfile));
                        break;
                    case Expression.EndsWith:
                        target.SetActive(_fetcher.PublicProfile.PublicProfile.EndsWith(enablePublicProfile));
                        break;
                }
            }
            else
