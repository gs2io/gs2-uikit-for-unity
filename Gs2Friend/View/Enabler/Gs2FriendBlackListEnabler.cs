...
namespace Gs2.Unity.UiKit.Gs2Friend
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/BlackList/View/Enabler/Gs2FriendBlackListEnabler")]
    public partial class Gs2FriendBlackListEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
    ...
    public partial class Gs2FriendBlackListEnabler
    {
