...
namespace Gs2.Unity.UiKit.Gs2Friend.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/Friend/BlackList/Fetcher/Gs2FriendOwnBlackListFetcher")]
    public partial class Gs2FriendOwnBlackListFetcher : MonoBehaviour
    {
        private IEnumerator Fetch()
        {
            ...
            while (true)
            {
                if (_gameSessionHolder != null && _gameSessionHolder.Initialized &&
                    ...
                    Context != null && this.Context.BlackList != null)
                {
    ...
    public partial class Gs2FriendOwnBlackListFetcher
    {
