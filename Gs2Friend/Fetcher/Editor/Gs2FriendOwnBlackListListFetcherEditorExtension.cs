...
{
    [CustomEditor(typeof(Gs2FriendOwnBlackListListFetcher))]
    public class Gs2FriendOwnBlackListListFetcherEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendOwnBlackListListFetcher;
