    ...
    public class Gs2FriendFriendUserDeleteFriendActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            ...
            if (context == null) {
                ...
                EditorGUILayout.ObjectField("OwnFriendUser", context.FriendUser, typeof(OwnFriendUser), false);
                EditorGUI.indentLevel++;
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("onDeleteFriendComplete"), true);
