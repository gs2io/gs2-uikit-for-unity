...
{
    [CustomEditor(typeof(Gs2FriendBlackListUnregisterBlackListAction))]
    public class Gs2FriendBlackListUnregisterBlackListActionEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2FriendBlackListUnregisterBlackListAction;
            ...
            if (context == null) {
                ...
                if (context.transform.parent.GetComponent<Gs2FriendOwnBlackListList>() != null) {
                    ...
                    EditorGUILayout.ObjectField("OwnBlackList", context.BlackList, typeof(OwnBlackList), false);
                    EditorGUI.indentLevel++;
