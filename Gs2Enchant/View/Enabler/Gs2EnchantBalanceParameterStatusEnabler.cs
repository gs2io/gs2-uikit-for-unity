...
namespace Gs2.Unity.UiKit.Gs2Enchant
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterStatus/View/Enabler/Gs2EnchantBalanceParameterStatusEnabler")]
    public partial class Gs2EnchantBalanceParameterStatusEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
            ...
            {
                if (_fetcher.BalanceParameterStatus == null)
                {
    ...
    public partial class Gs2EnchantBalanceParameterStatusEnabler
    {
