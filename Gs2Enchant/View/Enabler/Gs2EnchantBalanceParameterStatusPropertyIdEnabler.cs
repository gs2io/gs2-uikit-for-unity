...
namespace Gs2.Unity.UiKit.Gs2Enchant.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterStatus/View/Enabler/Properties/PropertyId/Gs2EnchantBalanceParameterStatusPropertyIdEnabler")]
    public partial class Gs2EnchantBalanceParameterStatusPropertyIdEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.BalanceParameterStatus != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        target.SetActive(enablePropertyId.StartsWith(_fetcher.BalanceParameterStatus.PropertyId));
                        break;
                    case Expression.EndsWith:
                        target.SetActive(enablePropertyId.EndsWith(_fetcher.BalanceParameterStatus.PropertyId));
                        break;
                }
            }
            else
    ...
    public partial class Gs2EnchantBalanceParameterStatusPropertyIdEnabler
    {
