...
namespace Gs2.Unity.UiKit.Gs2Enchant
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/RarityParameterStatus/View/Enabler/Gs2EnchantRarityParameterStatusEnabler")]
    public partial class Gs2EnchantRarityParameterStatusEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
            ...
            {
                if (_fetcher.RarityParameterStatus == null)
                {
    ...
    public partial class Gs2EnchantRarityParameterStatusEnabler
    {
