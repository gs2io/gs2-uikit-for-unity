...
namespace Gs2.Unity.UiKit.Gs2Enchant.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterStatus/View/Enabler/Properties/ParameterName/Gs2EnchantBalanceParameterStatusParameterNameEnabler")]
    public partial class Gs2EnchantBalanceParameterStatusParameterNameEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.BalanceParameterStatus != null)
            {
                ...
                {
                    case Expression.In:
                        target.SetActive(enableParameterNames.Contains(_fetcher.BalanceParameterStatus.ParameterName));
                        break;
                    case Expression.NotIn:
                        target.SetActive(!enableParameterNames.Contains(_fetcher.BalanceParameterStatus.ParameterName));
                        break;
                    case Expression.StartsWith:
                        target.SetActive(enableParameterName.StartsWith(_fetcher.BalanceParameterStatus.ParameterName));
                        break;
                    case Expression.EndsWith:
                        target.SetActive(enableParameterName.EndsWith(_fetcher.BalanceParameterStatus.ParameterName));
                        break;
                }
            }
            else
    ...
    public partial class Gs2EnchantBalanceParameterStatusParameterNameEnabler
    {
