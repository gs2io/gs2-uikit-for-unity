...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterStatus/View/SpriteSwitcher/Properties/PropertyId/Gs2EnchantBalanceParameterStatusPropertyIdSpriteTableSwitcher")]
    public partial class Gs2EnchantBalanceParameterStatusPropertyIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.BalanceParameterStatus != null)
            {
                if (sprites.Count(v => v.value == _fetcher.BalanceParameterStatus.PropertyId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.BalanceParameterStatus.PropertyId).sprite);
                }
                else {
    ...
    public partial class Gs2EnchantBalanceParameterStatusPropertyIdSpriteTableSwitcher
    {
