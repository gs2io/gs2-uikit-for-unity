...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/RarityParameterStatus/View/SpriteSwitcher/Properties/ParameterName/Gs2EnchantRarityParameterStatusParameterNameSpriteTableSwitcher")]
    public partial class Gs2EnchantRarityParameterStatusParameterNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.RarityParameterStatus != null)
            {
                if (sprites.Count(v => v.value == _fetcher.RarityParameterStatus.ParameterName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.RarityParameterStatus.ParameterName).sprite);
                }
                else {
    ...
    public partial class Gs2EnchantRarityParameterStatusParameterNameSpriteTableSwitcher
    {
