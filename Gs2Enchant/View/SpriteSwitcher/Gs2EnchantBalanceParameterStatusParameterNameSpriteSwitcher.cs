            ...
            if (_fetcher.Fetched && _fetcher.BalanceParameterStatus != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        if (_fetcher.BalanceParameterStatus.ParameterName.StartsWith(applyParameterName)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (_fetcher.BalanceParameterStatus.ParameterName.EndsWith(applyParameterName)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
