...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterStatus/View/SpriteSwitcher/Properties/ParameterName/Gs2EnchantBalanceParameterStatusParameterNameSpriteTableSwitcher")]
    public partial class Gs2EnchantBalanceParameterStatusParameterNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.BalanceParameterStatus != null)
            {
                if (sprites.Count(v => v.value == _fetcher.BalanceParameterStatus.ParameterName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.BalanceParameterStatus.ParameterName).sprite);
                }
                else {
    ...
    public partial class Gs2EnchantBalanceParameterStatusParameterNameSpriteTableSwitcher
    {
