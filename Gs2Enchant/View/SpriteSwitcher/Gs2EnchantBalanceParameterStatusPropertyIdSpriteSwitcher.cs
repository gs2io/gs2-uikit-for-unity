...
namespace Gs2.Unity.UiKit.Gs2Enchant.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Enchant/BalanceParameterStatus/View/SpriteSwitcher/Properties/PropertyId/Gs2EnchantBalanceParameterStatusPropertyIdSpriteSwitcher")]
    public partial class Gs2EnchantBalanceParameterStatusPropertyIdSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.BalanceParameterStatus != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyPropertyIds.Contains(_fetcher.BalanceParameterStatus.PropertyId)) {
                    ...
                    case Expression.StartsWith:
                        if (applyPropertyId.StartsWith(_fetcher.BalanceParameterStatus.PropertyId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyPropertyId.EndsWith(_fetcher.BalanceParameterStatus.PropertyId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2EnchantBalanceParameterStatusPropertyIdSpriteSwitcher
    {
