...
namespace Gs2.Unity.UiKit.Gs2Enchant.Label
{
    ...
    public partial class Gs2EnchantReDrawRarityParameterStatusByUserIdLabel
    {
        ...
        public void Awake()
        {
            _fetcher = GetComponent<Gs2EnchantReDrawRarityParameterStatusByUserIdFetcher>() ?? GetComponentInParent<Gs2EnchantReDrawRarityParameterStatusByUserIdFetcher>();
        ...
        {
            _fetcher = GetComponent<Gs2EnchantReDrawRarityParameterStatusByUserIdFetcher>() ?? GetComponentInParent<Gs2EnchantReDrawRarityParameterStatusByUserIdFetcher>(true);
