...
namespace Gs2.Unity.UiKit.Gs2Mission
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Counter/View/Enabler/Transaction/Gs2MissionResetCounterByUserIdEnabler")]
    public partial class Gs2MissionResetCounterByUserIdEnabler : MonoBehaviour
    {
        private void OnFetched()
        {
            if (this._fetcher.ConsumeActions().Count(v => v.Action == "Gs2Mission:ResetCounterByUserId") == 0) {
    ...
    public partial class Gs2MissionResetCounterByUserIdEnabler
    {
