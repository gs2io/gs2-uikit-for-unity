...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Complete/View/SpriteSwitcher/Properties/MissionGroupName/Gs2MissionCompleteMissionGroupNameSpriteSwitcher")]
    public partial class Gs2MissionCompleteMissionGroupNameSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Complete != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyMissionGroupNames.Contains(_fetcher.Complete.MissionGroupName)) {
                    ...
                    case Expression.StartsWith:
                        if (applyMissionGroupName.StartsWith(_fetcher.Complete.MissionGroupName)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyMissionGroupName.EndsWith(_fetcher.Complete.MissionGroupName)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2MissionCompleteMissionGroupNameSpriteSwitcher
    {
