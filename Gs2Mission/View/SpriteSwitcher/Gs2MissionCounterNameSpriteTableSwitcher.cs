...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Counter/View/SpriteSwitcher/Properties/Name/Gs2MissionCounterNameSpriteTableSwitcher")]
    public partial class Gs2MissionCounterNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Counter != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Counter.Name) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Counter.Name).sprite);
                }
                else {
    ...
    public partial class Gs2MissionCounterNameSpriteTableSwitcher
    {
