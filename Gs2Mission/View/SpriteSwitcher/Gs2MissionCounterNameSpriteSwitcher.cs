...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Counter/View/SpriteSwitcher/Properties/Name/Gs2MissionCounterNameSpriteSwitcher")]
    public partial class Gs2MissionCounterNameSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Counter != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyNames.Contains(_fetcher.Counter.Name)) {
                    ...
                    case Expression.StartsWith:
                        if (applyName.StartsWith(_fetcher.Counter.Name)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyName.EndsWith(_fetcher.Counter.Name)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2MissionCounterNameSpriteSwitcher
    {
