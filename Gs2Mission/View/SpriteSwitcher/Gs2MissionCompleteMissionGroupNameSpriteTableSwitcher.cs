...
namespace Gs2.Unity.UiKit.Gs2Mission.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Mission/Complete/View/SpriteSwitcher/Properties/MissionGroupName/Gs2MissionCompleteMissionGroupNameSpriteTableSwitcher")]
    public partial class Gs2MissionCompleteMissionGroupNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Complete != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Complete.MissionGroupName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Complete.MissionGroupName).sprite);
                }
                else {
    ...
    public partial class Gs2MissionCompleteMissionGroupNameSpriteTableSwitcher
    {
