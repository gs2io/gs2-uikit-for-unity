...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/SubscribeUser/View/SpriteSwitcher/Properties/UserId/Gs2RankingSubscribeUserUserIdSpriteTableSwitcher")]
    public partial class Gs2RankingSubscribeUserUserIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.SubscribeUser != null)
            {
                if (sprites.Count(v => v.value == _fetcher.SubscribeUser.UserId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.SubscribeUser.UserId).sprite);
                }
                else {
    ...
    public partial class Gs2RankingSubscribeUserUserIdSpriteTableSwitcher
    {
