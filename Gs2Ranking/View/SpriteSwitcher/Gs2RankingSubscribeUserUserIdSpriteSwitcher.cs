...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/SubscribeUser/View/SpriteSwitcher/Properties/UserId/Gs2RankingSubscribeUserUserIdSpriteSwitcher")]
    public partial class Gs2RankingSubscribeUserUserIdSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.SubscribeUser != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyUserIds.Contains(_fetcher.SubscribeUser.UserId)) {
                    ...
                    case Expression.StartsWith:
                        if (applyUserId.StartsWith(_fetcher.SubscribeUser.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyUserId.EndsWith(_fetcher.SubscribeUser.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2RankingSubscribeUserUserIdSpriteSwitcher
    {
