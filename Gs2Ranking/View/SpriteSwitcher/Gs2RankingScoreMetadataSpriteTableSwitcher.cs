...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/Score/View/SpriteSwitcher/Properties/Metadata/Gs2RankingScoreMetadataSpriteTableSwitcher")]
    public partial class Gs2RankingScoreMetadataSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Score != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Score.Metadata) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Score.Metadata).sprite);
                }
                else {
    ...
    public partial class Gs2RankingScoreMetadataSpriteTableSwitcher
    {
