...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/Score/View/SpriteSwitcher/Properties/UserId/Gs2RankingScoreUserIdSpriteTableSwitcher")]
    public partial class Gs2RankingScoreUserIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Score != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Score.UserId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Score.UserId).sprite);
                }
                else {
    ...
    public partial class Gs2RankingScoreUserIdSpriteTableSwitcher
    {
