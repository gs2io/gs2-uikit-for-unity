...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/Score/View/SpriteSwitcher/Properties/CategoryName/Gs2RankingScoreCategoryNameSpriteTableSwitcher")]
    public partial class Gs2RankingScoreCategoryNameSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Score != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Score.CategoryName) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Score.CategoryName).sprite);
                }
                else {
    ...
    public partial class Gs2RankingScoreCategoryNameSpriteTableSwitcher
    {
