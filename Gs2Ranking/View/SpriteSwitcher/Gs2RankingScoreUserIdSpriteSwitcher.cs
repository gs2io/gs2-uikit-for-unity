...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/Score/View/SpriteSwitcher/Properties/UserId/Gs2RankingScoreUserIdSpriteSwitcher")]
    public partial class Gs2RankingScoreUserIdSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Score != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyUserIds.Contains(_fetcher.Score.UserId)) {
                    ...
                    case Expression.StartsWith:
                        if (applyUserId.StartsWith(_fetcher.Score.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                    case Expression.EndsWith:
                        if (applyUserId.EndsWith(_fetcher.Score.UserId)) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
                }
    ...
    public partial class Gs2RankingScoreUserIdSpriteSwitcher
    {
