...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/Score/View/SpriteSwitcher/Properties/CategoryName/Gs2RankingScoreCategoryNameSpriteSwitcher")]
    public partial class Gs2RankingScoreCategoryNameSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Score != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyCategoryNames.Contains(_fetcher.Score.CategoryName)) {
    ...
    public partial class Gs2RankingScoreCategoryNameSpriteSwitcher
    {
