...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/SubscribeUser/View/SpriteSwitcher/Properties/TargetUserId/Gs2RankingSubscribeUserTargetUserIdSpriteTableSwitcher")]
    public partial class Gs2RankingSubscribeUserTargetUserIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.SubscribeUser != null)
            {
                if (sprites.Count(v => v.value == _fetcher.SubscribeUser.TargetUserId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.SubscribeUser.TargetUserId).sprite);
                }
                else {
    ...
    public partial class Gs2RankingSubscribeUserTargetUserIdSpriteTableSwitcher
    {
