...
namespace Gs2.Unity.UiKit.Gs2Ranking.SpriteSwitcher
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/Score/View/SpriteSwitcher/Properties/ScorerUserId/Gs2RankingScoreScorerUserIdSpriteTableSwitcher")]
    public partial class Gs2RankingScoreScorerUserIdSpriteTableSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Score != null)
            {
                if (sprites.Count(v => v.value == _fetcher.Score.ScorerUserId) > 0) {
                    this.onUpdate.Invoke(sprites.Find(v => v.value == _fetcher.Score.ScorerUserId).sprite);
                }
                else {
    ...
    public partial class Gs2RankingScoreScorerUserIdSpriteTableSwitcher
    {
