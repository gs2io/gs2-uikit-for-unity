...
namespace Gs2.Unity.UiKit.Gs2Ranking.Enabler
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/Score/View/Enabler/Properties/CategoryName/Gs2RankingScoreCategoryNameEnabler")]
    public partial class Gs2RankingScoreCategoryNameEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Score != null)
            {
                switch(expression)
                {
                    ...
                    case Expression.StartsWith:
                        target.SetActive(enableCategoryName.StartsWith(_fetcher.Score.CategoryName));
                        break;
                    case Expression.EndsWith:
                        target.SetActive(enableCategoryName.EndsWith(_fetcher.Score.CategoryName));
                        break;
                }
            }
            else
    ...
    public partial class Gs2RankingScoreCategoryNameEnabler
    {
