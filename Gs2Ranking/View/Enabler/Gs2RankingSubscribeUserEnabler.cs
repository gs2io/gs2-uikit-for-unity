...
namespace Gs2.Unity.UiKit.Gs2Ranking
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/SubscribeUser/View/Enabler/Gs2RankingSubscribeUserEnabler")]
    public partial class Gs2RankingSubscribeUserEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
            ...
            {
                if (_fetcher.SubscribeUser == null)
                {
