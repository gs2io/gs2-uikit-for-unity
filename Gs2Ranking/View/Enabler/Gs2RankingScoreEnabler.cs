...
namespace Gs2.Unity.UiKit.Gs2Ranking
{
	...
	[AddComponentMenu("GS2 UIKit/Ranking/Score/View/Enabler/Gs2RankingScoreEnabler")]
    public partial class Gs2RankingScoreEnabler : MonoBehaviour
    {
        public void Update()
        {
            if (!_fetcher.Fetched)
    ...
    public partial class Gs2RankingScoreEnabler
    {
