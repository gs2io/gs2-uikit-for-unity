...
namespace Gs2.Unity.UiKit.Gs2JobQueue.Fetcher
{
	...
	[AddComponentMenu("GS2 UIKit/JobQueue/Job/Fetcher/Gs2JobQueueJobFetcher")]
    public partial class Gs2JobQueueJobFetcher : MonoBehaviour
    {
    ...
    public partial class Gs2JobQueueJobFetcher
    {
        ...
        public void Awake()
        {
            ...
            _context = GetComponentInParent<Gs2JobQueueJobContext>();
        }
    }
    ...
    public partial class Gs2JobQueueJobFetcher
    {
        public EzJob Job { get; private set; }
