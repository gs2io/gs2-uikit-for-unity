...
namespace Gs2.Unity.UiKit.Gs2JobQueue.Editor
{
    ...
    public class Gs2JobQueueJobResultResultEnablerEditorExtension : UnityEditor.Editor
    {
        public override void OnInspectorGUI() {
            var original = target as Gs2JobQueueJobResultResultEnabler;
            ...
            if (original.expression == Gs2JobQueueJobResultResultEnabler.Expression.In || original.expression == Gs2JobQueueJobResultResultEnabler.Expression.NotIn) {
