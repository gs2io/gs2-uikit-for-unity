...
namespace Gs2.Unity.UiKit.Gs2JobQueue
{
	...
	[AddComponentMenu("GS2 UIKit/JobQueue/Job/View/SpriteSwitcher/Properties/MaxTryCount/Gs2JobQueueJobMaxTryCountSpriteSwitcher")]
    public partial class Gs2JobQueueJobMaxTryCountSpriteSwitcher : MonoBehaviour
    {
        public void Update()
        {
            if (_fetcher.Fetched && _fetcher.Job != null)
            {
                ...
                {
                    case Expression.In:
                        if (applyMaxTryCounts.Contains(_fetcher.Job.MaxTryCount)) {
                    ...
                    case Expression.Less:
                        if (applyMaxTryCount > _fetcher.Job.MaxTryCount) {
                            this.onUpdate.Invoke(this.sprite);
                        }
                        break;
    ...
    public partial class Gs2JobQueueJobMaxTryCountSpriteSwitcher
    {
